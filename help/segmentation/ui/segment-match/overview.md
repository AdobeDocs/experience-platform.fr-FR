...
>[!IMPORTANT]
>
>La correspondance de segment est actuellement en version bêta. La documentation et les fonctionnalités peuvent changer.
...
![enable-connection.png](./images/establish-connection.png)
...
![audience-share.png](./images/audience-sharing.png)
...
![liste de flux](./images/feed-list.png)

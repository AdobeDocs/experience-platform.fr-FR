...
- [Créer une audience](#create-audience)
   ...
   - [Utilisez la composition d’audience fédérée pour créer une audience à l’aide des données de votre entrepôt de données existant](#fac) (disponibilité limitée)
...
| [!UICONTROL Désactiver] | Chargement personnalisé, service de segmentation | Désactive l’audience sélectionnée. Pour plus d’informations sur la gestion de l’état du cycle de vie, consultez la section [état du cycle de vie) du FAQ sur la segmentation](../faq.md#lifecycle-states). |
...
![Les audiences pour lesquelles vous souhaitez utiliser l’évaluation d’audience flexible sont sélectionnées.](../images/ui/audience-portal/evaluate-audiences.png)
...
![Les audiences qui peuvent être évaluées à l’aide de l’évaluation d’audience flexible s’affichent.](../images/ui/audience-portal/evaluate-audiences-modal.png)

...
Cela prolonge l’expiration des données de 30 jours et utilise les mêmes métadonnées d’audience. Une fois le bouton enfoncé, vous ne pouvez plus le sélectionner pendant 20 minutes.
...
- L’audience ne contient aucune donnée.

...
Après avoir mis à jour les détails de votre composition, sélectionnez **[!UICONTROL Enregistrer]** pour confirmer ces mises à jour. La zone de travail de composition d’audiences réapparaît.

Le canevas de composition d’audience se compose de quatre types de blocs différents : **[[!UICONTROL Audience]](#audience-block)**, **[[!UICONTROL Exclure]](#exclude-block)**, **[[!UICONTROL Classement]](#rank-block)** et **[[!UICONTROL Fractionner]](#split-block)**.
...
Le type de bloc **[!UICONTROL Audience]** permet d’ajouter les sous-audiences que vous souhaitez utiliser pour composer votre nouvelle audience plus grande. Par défaut, un bloc **[!UICONTROL Audience]** est inclus dans la partie supérieure du canevas de composition.

Lorsque vous sélectionnez le bloc **[!UICONTROL Audience]**, le rail de droite affiche des commandes pour libeller l’audience, ajouter des audiences au bloc et créer des règles personnalisées pour le bloc d’audience.
...
Vous pouvez également ajouter des payloads d’audience à votre composition. Après avoir sélectionné **[!UICONTROL Créer une règle]**, la zone de travail du créateur de règles s’affiche.

Vous pouvez maintenant créer un critère de filtre pour la payload de votre audience. Ce critère de filtre **doit** inclut un attribut qui se trouve dans un tableau. L’attribut étant un tableau dépend de la structure de schéma de votre organisation. Après avoir créé vos critères de filtre, sélectionnez **[!UICONTROL Sélectionner des payloads]** dans le panneau de droite.
...
Dans le panneau de gauche, choisissez le tableau d’objets, ainsi que les champs que vous souhaitez utiliser dans la payload. S’il n’existe qu’un seul tableau dans le profil, le tableau est automatiquement sélectionné pour vous. Sélectionnez **[!UICONTROL Enregistrer]** pour revenir à la composition de l’audience.
...
Le type de bloc **[!UICONTROL Enrichir]** permet d’enrichir votre audience avec des attributs supplémentaires à partir d’un jeu de données. Vous pouvez utiliser ces attributs dans des cas d’utilisation de personnalisation.

Pour ajouter un bloc **[!UICONTROL Enrichir]**, sélectionnez l’icône **+**, puis **[!UICONTROL Enrichir]**.

![L’option [!UICONTROL Enrichir] est sélectionnée.](../images/ui/audience-composition/add-enrich-block.png)
...
Pour sélectionner la **[!UICONTROL clé de jointure du jeu de données d’enrichissement]**, sélectionnez l’icône ![filtre](/help/images/icons/project-edit.png).

La fenêtre contextuelle **[!UICONTROL Attributs d’enrichissement]** s’affiche. Sélectionnez l’attribut que vous souhaitez utiliser comme clé de jointure du jeu de données d’enrichissement, puis **[!UICONTROL Sélectionner]** pour choisir cet attribut comme clé de jointure du jeu de données d’enrichissement.
...
La fenêtre contextuelle **[!UICONTROL Attributs d’enrichissement]** s’affiche. Vous pouvez sélectionner les attributs du jeu de données avec lesquels enrichir votre audience, puis **[!UICONTROL Sélectionner]** pour ajouter les attributs à votre audience.
...
Le type de bloc **[!UICONTROL Classement]** vous permet de classer et de trier les profils en fonction d’un attribut spécifié et d’inclure ces profils classés dans votre composition.
...
Le type de bloc **[!UICONTROL Fractionner]** permet de fractionner votre nouvelle audience en différentes sous-audiences. Vous pouvez fractionner cette audience en fonction d’un pourcentage ou d’un attribut.
...
Lors du fractionnement par pourcentage, vous pouvez définir la **[!UICONTROL Répartition du profil]** sur **[!UICONTROL Répartition aléatoire]** ou **[!UICONTROL Répartition persistante]**.

![La section Distribution des profils est mise en surbrillance, ce qui indique que vous pouvez choisir entre les divisions aléatoires ou persistantes.](/help/segmentation/images/ui/audience-composition/profile-distribution.png)

Si vous sélectionnez **[!UICONTROL Partage aléatoire]**, les audiences sont partagées de manière aléatoire en fonction du nombre de chemins et des pourcentages fournis.

![La section et les options de partage aléatoire sont mises en surbrillance.](../images/ui/audience-composition/random-split.png)

Si vous sélectionnez **[!UICONTROL Partage persistant]**, les audiences restent dans le même compartiment. Par exemple, vous pouvez utiliser le fractionnement persistant lorsque vous souhaitez avoir une population témoin qui reste constante.

Lorsque vous sélectionnez la division persistante, vous devez fournir une identité. Les types d’identité disponibles incluent tous les espaces de noms d’identité disponibles dans votre organisation.

![La section Partage persistant et les options sont mises en surbrillance.](/help/segmentation/images/ui/audience-composition/persistent-split.png)

### Fractionner par attribut {#split-attribute}

Lors du fractionnement par attribut, les audiences sont fractionnées en fonction des attributs fournis. Pour sélectionner l’attribut du fractionnement, sélectionnez le bloc **[!UICONTROL Fractionner]**, puis l’icône ![filtrer](/help/images/icons/project-edit.png).
...
En outre, vous pouvez activer le bouton (bascule) **[!UICONTROL Autres profils]** pour créer une sous-audience composée de tous les profils non sélectionnés.

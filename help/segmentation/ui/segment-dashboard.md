...
Pour obtenir des instructions détaillées sur l’accès et l’interaction avec le tableau de bord des segments dans l’interface utilisateur, ainsi que pour en savoir plus sur les mesures disponibles affichées dans le tableau de bord, consultez le [guide du tableau de bord des segments](../../dashboards/guides/segments.md).

Pour un aperçu de toutes les fonctionnalités du tableau de bord dans l’interface utilisateur de l’Experience Platform, commencez par lire la [présentation des tableaux de bord](../../dashboards/home.md).

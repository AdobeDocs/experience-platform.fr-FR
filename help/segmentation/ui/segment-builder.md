...
Vous pouvez voir ces blocs de création dans la section **[!UICONTROL Champs]** sur le côté gauche de l’espace de travail [!DNL Segment Builder]. **** Les champs contiennent un onglet pour chacun des blocs de création principaux : &quot;[!UICONTROL Attributs]&quot;, &quot;[!UICONTROL Événements]&quot; et &quot;[!UICONTROL Audiences]&quot;.
...
Par défaut, seuls les champs de schéma renseignés de votre banque de données s’affichent. Cela inclut &quot;[!UICONTROL Types d’événement]&quot;. Si la liste &quot;[!UICONTROL Types d’événement]&quot; n’est pas visible ou si vous ne pouvez sélectionner que &quot;[!UICONTROL Any]&quot; comme &quot;[!UICONTROL Type d’événement]&quot;, sélectionnez l’**icône d’engrenage** en regard de **[!UICONTROL Champs]**, puis sélectionnez **[!UICONTROL Afficher tout Schéma DM]** sous **[!UICONTROL Champs disponibles]**. Sélectionnez à nouveau l’icône **engrenage** pour revenir à l’onglet **[!UICONTROL Champs]** et vous devriez maintenant pouvoir afficher plusieurs &quot;[!UICONTROL Types d’événements]&quot; et champs de schéma, qu’ils contiennent des données ou non.
...
Pour les [!DNL Platform] audiences créées à l’aide de [!DNL Segment Builder], vous avez la possibilité de convertir l’audience en un ensemble de règles utilisées dans la définition de segment pour cette audience. Cette conversion effectue une copie de la logique de règle, qui peut ensuite être modifiée sans affecter la définition de segment d’origine. Assurez-vous d’avoir enregistré les modifications récentes apportées à votre définition de segment avant de la convertir en logique de règle.
...
Vous pouvez également afficher une version basée sur le code d’une règle créée dans la balise [!DNL Segment Builder]. Une fois que vous avez créé votre règle dans le canevas du créateur de règles, vous pouvez sélectionner **[!UICONTROL Affichage du code]** pour afficher votre segment comme étant PQL.
...
Après avoir placé l’événement dans le conteneur Événements, sélectionnez l’icône représentant des points de suspension (..), suivie de **[!UICONTROL Agrégat]**.
...
Après avoir placé l’événement dans le conteneur Événements, cliquez sur le bouton [!UICONTROL Au moins 1] .
...
Une fois que vous avez sélectionné **[!UICONTROL Extraire le conteneur]**, le conteneur enfant est supprimé et les critères apparaissent en ligne.
...
Pour sélectionner une stratégie de fusion pour votre définition de segment, sélectionnez l’icône en forme d’engrenage dans l’onglet **[!UICONTROL Champs]**, puis utilisez le menu déroulant **[!UICONTROL Stratégie de fusion]** pour sélectionner la stratégie de fusion que vous souhaitez utiliser.
...
La section **[!UICONTROL Propriétés du segment]** vous permet également de spécifier des informations importantes sur votre définition de segment, notamment son nom et sa description. Les noms des définitions de segment sont utilisés pour identifier votre segment parmi ceux définis par votre organisation et doivent donc être descriptifs, concis et uniques.
...
Le créateur de segments fournit un processus riche qui vous permet d’isoler les audiences commercialisables des données [!DNL Real-time Customer Profile]. Après avoir lu ce guide, vous devriez maintenant pouvoir :
...
Pour en savoir plus sur [!DNL Segmentation Service], veuillez continuer à lire la documentation et compléter votre apprentissage en regardant les vidéos connexes. Pour en savoir plus sur les autres parties de l’interface utilisateur de [!DNL Segmentation Service], consultez le [[!DNL Segmentation Service] guide d’utilisation](./overview.md)

...
description: Cette vidéo fournit une compréhension de base de la création d’un segment à l’aide de l’interface utilisateur de Platform.
...
# Création d’un segment dans l’interface utilisateur de l’Experience Platform

La vidéo suivante est destinée à vous aider à comprendre la création de segments. Il présente un exemple d’expérience client suivi d’un aperçu rapide des fonctionnalités clés de l’interface [!DNL Platform]. Pour en savoir plus sur la segmentation et sur la création de segments dans l’interface utilisateur, consultez le [guide du créateur de segments](../ui/segment-builder.md).

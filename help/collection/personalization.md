---
title: Récupération du contenu de personnalisation à partir d’autres solutions Adobe
...
# Récupération du contenu de personnalisation à partir des solutions Adobe
...
| --- | --- | --- |
| `schemas` | `String[]` | *Facultatif*. Liste des schémas utilisés dans la décision, pour sélectionner le type d&#39;offres renvoyé. |
...
| `payload.scopeDetails.decisionProvider` | Chaîne | Cela sera : `TGT` si vous utilisez Adobe Target ou `ODE` si vous utilisez [!DNL Offer Decisioning]. |

...
![Image montrant les autorisations ajoutées sous la colonne incluse](assets/permissions/added-permissions.png)
...
![Image montrant les autorisations ajoutées pour le profil de produit.](assets/permissions/permissions-added.png)

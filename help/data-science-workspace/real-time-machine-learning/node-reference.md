...
# Guide de référence des noeuds d’apprentissage automatique en temps réel
...
L’étape suivante consiste à créer un noeud à utiliser pour marquer un modèle d’apprentissage automatique en temps réel. Pour plus d&#39;informations, consultez le tutoriel sur la [notation d&#39;un modèle](./node-reference.md) d&#39;apprentissage automatique en temps réel.

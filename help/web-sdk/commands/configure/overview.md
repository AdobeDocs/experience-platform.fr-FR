...
Les propriétés [`edgeConfigId`](edgeconfigid.md) et [`orgId`](orgid.md) sont requises. Toutes les autres propriétés sont facultatives, selon les exigences de mise en oeuvre de votre entreprise.

...
* Applications basées sur Platform {#ecosystem}
...
* Gouvernance, confidentialité et sécurité {#governance-privacy-security}
   ...
   * Clés gérées par le client ou la cliente {#customer-managed-keys}
      ...
      * [Configurer un coffre de clés Azure](./governance-privacy-security/customer-managed-keys/azure-key-vault-config.md)
      * [Utilisation de l’API pour configurer la fonction CMK](./governance-privacy-security/customer-managed-keys/api-set-up.md)
   ...
   * {#key-management-service} du service de gestion des clés
      * [Service de gestion des clés](./governance-privacy-security/key-management-service/overview.md)

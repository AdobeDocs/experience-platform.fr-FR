...
# (Alpha) [!UICONTROL tableau de bord d’utilisation] de la licence {#license-usage-dashboard}
...
Pour un aperçu général de l’interface utilisateur de la plate-forme, consultez le guide [de l’interface utilisateur](ui-guide.md)Experience Platform.
...
Pour accéder au tableau de bord d’utilisation des licences dans l’interface utilisateur de la plate-forme, sélectionnez Utilisation **[!UICONTROL des]** licences dans le rail de gauche. L&#39;onglet **[!UICONTROL Aperçu]** s&#39;affiche alors et affiche le tableau de bord.
...
>[!NOTE]
>
>Le rapports de consommation des sandbox est cumulé pour tous les sandbox du même type. En d’autres termes, la sélection de [!UICONTROL Production] ou [!UICONTROL Développement] portera sur tous les sandbox de production ou de développement, respectivement.

![](images/license-usage-dashboard/select-sandbox.png)

### Sélectionner une plage de dates

Après avoir sélectionné un sandbox, vous pouvez utiliser la liste déroulante de plage de dates pour sélectionner la période à afficher dans le tableau de bord. Trois options sont disponibles : [!UICONTROL 30 derniers jours], 90 [!UICONTROL derniers jours]et 12 derniers mois . Les 30 derniers jours sont sélectionnés par défaut.
...
Le widget audiences **** adressables mesure le nombre total d’audiences qui existent dans le magasin de Profils, après avoir appliqué une stratégie de fusion générée par le système pour combiner tous les jeux de données existants à l’aide d’un algorithme de graphique déterministe (privé). La stratégie de fusion utilisée pour calculer cette mesure est générée par Plateforme et ne peut pas être modifiée, pas plus qu’une autre stratégie de fusion ne peut être sélectionnée.

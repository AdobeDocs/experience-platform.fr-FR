...
## [!UICONTROL Consent and Preference Details] la structure du groupe de champs {#structure}

Le groupe de champs [!UICONTROL Consent and Preference Details] fournit des champs de consentement normalisés à un schéma. Actuellement, ce groupe de champs n’est compatible qu’avec les schémas basés sur la classe [!DNL XDM Individual Profile].
...
La [!DNL Schema Editor] s’affiche et indique la structure du schéma dans la zone de travail. Sur le côté gauche de la zone de travail, sélectionnez **[!UICONTROL Add]** sous la section **[!UICONTROL Field groups]** .

![](../../../images/governance-privacy-security/consent/adobe/dataset-prep/add-field-group.png)

La boîte de dialogue **[!UICONTROL Add field group]** s’affiche. À partir de là, sélectionnez **[!UICONTROL Consent and Preference Details]** dans la liste. Vous pouvez éventuellement utiliser la barre de recherche pour affiner les résultats afin de localiser plus facilement le groupe de champs.
...
Dans le rail de droite, sélectionnez le bouton (bascule) **[!UICONTROL Profile]** .

![](../../../images/governance-privacy-security/consent/adobe/dataset-prep/profile-toggle.png)

Enfin, sélectionnez **[!UICONTROL Enable]** dans la fenêtre contextuelle de confirmation pour activer le schéma à [!DNL Profile].

![](../../../images/governance-privacy-security/consent/adobe/dataset-prep/enable-dataset.png)

Le jeu de données est maintenant enregistré et activé pour une utilisation dans [!DNL Profile]. Si vous prévoyez d’utiliser Experience Platform Web SDK pour envoyer des données de consentement à Profile, vous devez sélectionner ce jeu de données comme [!UICONTROL Profile Dataset] lors de la configuration de votre [flux de données](../../../../datastreams/overview.md).
...
Il est vivement recommandé d’utiliser le groupe de champs [!UICONTROL Consent and Preference Details] comme base de référence pour la structure de vos données de consentement et d’ajouter des champs supplémentaires si nécessaire, plutôt que d’essayer de créer l’ensemble de la structure à partir de zéro.

Pour ajouter des champs personnalisés à la structure d’un groupe de champs standard, vous devez d’abord créer un groupe de champs personnalisé. Après avoir ajouté le groupe de champs [!UICONTROL Consent and Preference Details] au schéma, sélectionnez l’icône **plus (+)** dans la section **[!UICONTROL Field groups]**, puis sélectionnez **[!UICONTROL Create new field group]**. Attribuez un nom et une description facultative au groupe de champs, puis sélectionnez **[!UICONTROL Add field group]**.
...
Dans le rail de droite sous **[!UICONTROL Field properties]**, indiquez un nom et une description pour le champ. Lors de la sélection de la **[!UICONTROL Type]** du champ, vous devez utiliser le type de données standard approprié pour un champ de préférence ou de consentement personnalisé :
...
Le champ de consentement ou de préférence est ajouté à la structure du schéma. Notez que la [!UICONTROL Path] affichée dans le rail de droite contient l’espace de noms `_tenantId`. Cet espace de noms doit être inclus chaque fois que vous référencez le chemin d’accès à ce champ dans vos opérations de données.

![](../../../images/governance-privacy-security/consent/adobe/dataset-prep/field-added.png)

Suivez les étapes ci-dessus pour continuer à ajouter les champs de consentement et de préférence dont vous avez besoin. Lorsque vous avez terminé, sélectionnez **[!UICONTROL Save]** pour confirmer vos modifications.

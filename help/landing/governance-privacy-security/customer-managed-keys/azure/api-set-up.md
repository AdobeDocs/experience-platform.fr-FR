---
title: Installation et configuration des clés gérées par la clientèle pour Azure à l’aide de l’API
...
# Installation et configuration des clés gérées par la clientèle pour Azure à l’aide de l’API

Ce document contient les instructions spécifiques à Azure pour activer les clés gérées par le client (CMK) dans Adobe Experience Platform à l’aide de l’API . Pour plus d’informations sur la manière d’effectuer ce processus à l’aide de l’interface utilisateur pour les instances d’Experience Platform hébergées par Azure, reportez-vous au document [Configuration de la CMK de l’interface utilisateur](./ui-set-up.md).
...
![Tableau de bord Microsoft Azure avec [!DNL Add] et [!DNL Add role assignment] en surbrillance.](../../../images/governance-privacy-security/customer-managed-keys/add-role-assignment.png)
...
![Tableau de bord Microsoft Azure avec le [!DNL Key Vault Crypto Service Encryption User] en surbrillance.](../../../images/governance-privacy-security/customer-managed-keys/select-role.png)
...
En suivant les étapes ci-dessus, vous avez activé le CMK pour votre entreprise. Pour les instances Experience Platform hébergées par Azure, les données ingérées dans les entrepôts de données principaux seront désormais chiffrées et déchiffrées à l’aide des clés de votre coffre de clés [!DNL Azure].

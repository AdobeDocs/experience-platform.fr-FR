...
* **Guide de développement** : chaque guide de développement fournit des informations détaillées sur l’utilisation de tous les points d’entrée d’API disponibles pour un service spécifique. Le guide comprend les paramètres de requête disponibles, des exemples de requêtes et des exemples de réponses, ainsi que la description des &quot;pièges&quot; à éviter lors d’appels à [!DNL Platform] API.

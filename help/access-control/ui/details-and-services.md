...
Vous pouvez configurer les détails d’un profil et accéder aux services supplémentaires à partir du menu **[!UICONTROL Paramètres du profil]**. Pour accéder au menu, sélectionnez **[!UICONTROL Paramètres]** dans la page **[!UICONTROL Profil de produit]**.

![paramètres](../images/settings.png)

Le menu **[!UICONTROL Modifier le profil du produit]** s’affiche et démarre sur l’onglet **[!UICONTROL Modifier les détails du produit]**. Cet onglet vous permet de saisir et de modifier le nom du profil et sa description. Vous pouvez également modifier le nom d’affichage ainsi que les paramètres de notification par e-mail de votre compte.

![edit-product-profile](../images/edit-product-profile.png)

Sélectionnez **[!UICONTROL Suivant]** pour accéder à la page **[!UICONTROL Activer les services]**.

Le menu **[!UICONTROL Activer les services]** vous permet de modifier l’accès d’un profil aux services [!DNL Experience Platform] supplémentaires qui ont été initialement configurés lors de la création du profil. En fonction de votre abonnement [!DNL Experience Platform], ces services peuvent inclure :

...
Pour attribuer ou supprimer des utilisateurs d’un profil de produits, ouvrez la page des détails du profil et accédez à l’onglet **[!UICONTROL Utilisateurs]**. À partir de là, sélectionnez **[!UICONTROL Ajouter un utilisateur]**.
...
Une fois que vous avez sélectionné un utilisateur, sélectionnez **[!UICONTROL Enregistrer]** pour l’ajouter au profil de produit.

![save-user](../images/save-user.png)

## Étapes suivantes

Maintenant que vous avez appris à contrôler l’accès aux fonctionnalités de Platform par le biais de [!DNL Admin Console], consultez la section de l’annexe de la [présentation du contrôle d’accès](../home.md) pour en savoir plus sur chaque autorisation individuelle et les fonctionnalités de Platform auxquelles elles donnent accès.

...
Immédiatement après la [création d’un nouveau rôle](#create-a-new-role), vous revenez à l’onglet **[!UICONTROL Rôles]**. Si vous modifiez les autorisations d’un rôle existant, sélectionnez le rôle dans l’onglet **[!UICONTROL Rôles]**. Vous pouvez également utiliser l’option de filtrage pour filtrer les résultats afin de trouver un rôle.
...
Vous revenez sur l’onglet **[!UICONTROL Informations d’identification de l’API]**.
...
Vous revenez alors à l’onglet **[!UICONTROL Groupes d’utilisateurs]**.
...
La boîte de dialogue **[!UICONTROL Sélectionner des profils de produit]** s’affiche. Sélectionnez **[!UICONTROL AEP-Default-All-Users]** puis **[!UICONTROL Enregistrer]**.

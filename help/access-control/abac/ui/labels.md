...
Pour afficher tous les libellés disponibles, accédez à **[!UICONTROL Autorisations]** dans [Adobe Experience Cloud](https://experience.adobe.com/){target="_blank"}. Sélectionnez **[!UICONTROL Libellés]** dans le panneau de gauche.
...
| Engagement responsable | Cette catégorie contient une étiquette unique, **[!UICONTROL potentiel de biais]**, qui reflète les données qui ont le potentiel d&#39;introduire des biais. |
...
>[!NOTE]
>
>Pour créer un libellé personnalisé, vous avez besoin d’un rôle contenant les autorisations **[!UICONTROL Gérer les libellés d’utilisation]** et le sandbox `Prod`.

Pour créer un libellé, sélectionnez **[!UICONTROL Libellés]** dans le panneau de gauche de l’espace de travail **[!UICONTROL Autorisations]**, puis sélectionnez **[!UICONTROL Créer un libellé]**.
...
La boîte de dialogue **[!UICONTROL Créer un libellé]** s’affiche et vous invite à saisir un **[!UICONTROL Nom]**, un **[!UICONTROL Nom convivial]** et un **[!UICONTROL Description]**.

>[!IMPORTANT]
>
> Le [!UICONTROL nom] du libellé ne peut pas être modifié une fois le libellé créé et la suppression du libellé n’est actuellement pas prise en charge.

Sélectionnez **[!UICONTROL Confirmer]** pour terminer la création de votre étiquette.
...
Bien que vous ne puissiez pas modifier le **[!UICONTROL Nom]** d’une étiquette personnalisée, vous pouvez modifier le **[!UICONTROL Nom convivial]** et le **[!UICONTROL Description]**. Pour modifier un libellé personnalisé, sélectionnez-le dans la liste de l’espace de travail **[!UICONTROL Libellés]**.

![Espace de travail Libellés avec le libellé en surbrillance.](../../images/ui/labels/select-label.png){zoomable="yes"}

Modifiez l’un des champs, puis cliquez n’importe où en dehors de la zone de texte pour enregistrer vos modifications. Un message de confirmation s’affiche à l’écran et le nom **[!UICONTROL Modifié par]** et la date **[!UICONTROL Modifié]** changent.

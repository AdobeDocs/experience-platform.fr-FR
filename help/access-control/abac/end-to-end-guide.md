...
La zone [!UICONTROL Autorisations] d’Experience Cloud permet aux administrateurs de définir des rôles d’utilisateur et des politiques afin de gérer les autorisations des fonctionnalités et des objets dans une application de produit.

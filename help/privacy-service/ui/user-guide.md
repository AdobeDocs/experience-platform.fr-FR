...
* [!DNL General Data Protection Regulation] de l’Union européenne ([!UICONTROL RGPD])
...
Les tâches pour chaque type de réglementation sont suivies séparément. Pour passer d’un type de réglementation à l’autre, sélectionnez le menu déroulant **[!UICONTROL Type de réglementation]** et sélectionnez la réglementation souhaitée dans la liste.
...
>[!NOTE]
>
>Lorsqu’un filtre a été appliqué au widget Requêtes de tâche, vous pouvez le supprimer en sélectionnant **X** dans la pilule de filtre. Les requêtes de tâche reviennent alors à la liste de suivi par défaut.
...
Pour télécharger l’ensemble des données de tâche sous forme de fichier CSV, sélectionnez **[!UICONTROL Exporter au format CSV]** en haut à droite de la boîte de dialogue.
...
Sélectionnez le **[!UICONTROL Type de tâche]** de la requête (&quot;Supprimer&quot; ou &quot;Accès&quot;) et un ou plusieurs produits disponibles dans la liste.
...
En lisant ce document, vous avez appris à utiliser l’interface utilisateur [!DNL Privacy Service] pour créer une tâche de confidentialité, afficher les détails d’une tâche et surveiller son état de traitement, et télécharger les résultats une fois qu’elle est terminée.

Pour savoir comment effectuer ces opérations par programmation à l’aide de l’API [!DNL Privacy Service], consultez le [guide de développement](../api/getting-started.md).

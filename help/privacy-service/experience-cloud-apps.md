...
| Adobe Campaign Classic | ✓ | ✓ | Les données stockées du titulaire de données sont supprimées du système. | <ul><li>[Gestion de la confidentialité](https://experienceleague.adobe.com/en/docs/campaign-classic/using/getting-started/privacy/privacy-management)</li></ul> |
...
| Attributs du client Adobe (CRS) | ✓ | S.O. | Les attributs du titulaire de données sont supprimés du système. | <ul><li>[Accéder/supprimer la documentation pour le RGPD](https://experienceleague.adobe.com/en/docs/core-services/interface/services/customer-attributes/gdpr)</li><li>[Accéder à la documentation relative au CCPA/la supprimer](https://experienceleague.adobe.com/en/docs/core-services/interface/services/customer-attributes/ccpa)</li><li>Les attributs du client ne sont pas en mesure de transférer des données. Par conséquent, les requêtes d’opposition à la vente ne sont pas applicables.</li></ul> |
...
| Adobe Journey Optimizer | ✓ | S.O. | Les données stockées du titulaire de données sont supprimées du système. | <ul><li>[Documentation sur l’accès et la suppression](https://experienceleague.adobe.com/en/docs/journey-optimizer/using/privacy/requests)</li></ul> |

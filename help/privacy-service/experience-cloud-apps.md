...
| Adobe Campaign Standard | ✓ | ✓ | Les données stockées du titulaire de données sont supprimées du système. | <ul><li>[Documentation sur l’accès et la suppression](https://docs.campaign.adobe.com/doc/standard/getting_started/fr/ACS_GDPR.html)</li><li>[Documentation sur l’opposition](../segmentation/tutorials/consents.md)</li></ul> |

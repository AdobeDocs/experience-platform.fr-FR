...
Vous pouvez accéder à la copie express à partir de la page d&#39;inventaire des objets. Par exemple, pour afficher la liste des schémas disponibles, sélectionnez **[!UICONTROL Schémas]** dans le volet de navigation de gauche, puis sélectionnez l’onglet **[!UICONTROL Parcourir]**. Sélectionnez ensuite les points de suspension (`...`) à côté du schéma sélectionné pour afficher les options de contrôle dans un menu déroulant. Sélectionnez **[!UICONTROL Ajouter au package]** dans la liste déroulante.

![Liste des schémas affichant le menu déroulant mettant en surbrillance le contrôle [!UICONTROL Ajouter au package].](../images/ui/sandbox-tooling/add-to-package-express.png)

La boîte de dialogue **[!UICONTROL Ajouter au package]** s’affiche. Sélectionnez l’option **[!UICONTROL Copie express]**, puis sélectionnez le **[!UICONTROL Sandbox cible]** dans la liste déroulante. Enfin, sélectionnez **[!UICONTROL Ajouter]** pour confirmer vos choix.

Boîte de dialogue ![[!UICONTROL Ajouter au package] affichant un package sélectionné dans la liste déroulante.](../images/ui/sandbox-tooling/express-copy.png)
...
Pour vérifier le statut de votre demande de copie express, sélectionnez **[!UICONTROL Sandbox]** dans le volet de navigation de gauche, puis sélectionnez l’onglet **[!UICONTROL Tâches]**. Une liste de toutes les tâches et le statut actuel du traitement s’affiche.

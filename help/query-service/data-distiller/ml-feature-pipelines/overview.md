...
>[!IMPORTANT]
>
>Ce workflow nécessite une licence Data Distiller et Adobe Experience Platform Intelligence. Si vous ne disposez d’aucun de ces produits, contactez votre représentant Adobe Service.
...
- Sandbox : [autorisations de contrôle d’accès basé sur les attributs](../../../access-control/abac/overview.md) et comment créer et gérer des rôles, ainsi qu’attribuer les autorisations de ressources souhaitées pour ces rôles.
- Gouvernance des données : comment [appliquer des libellés d’utilisation des données aux jeux de données et aux champs](../../../data-governance/labels/overview.md) en les classant en fonction des politiques de gouvernance des données et des politiques de contrôle d’accès associées.
...
Les documents inclus dans cette série de guides décrivent les étapes de base de la création de pipelines de fonctionnalités à partir d’Experience Platform pour alimenter des modèles personnalisés dans votre environnement de machine learning. Vous êtes maintenant prêt à établir une connexion entre Data Distiller et votre [!DNL Jupyter Notebook].

- **Configurer** : [Connexion à Data Distiller à partir d’un  [!DNL Python] notebook](./establish-connection.md)

La documentation ci-dessous correspond aux étapes indiquées dans l&#39;infographie ci-dessus.

- **Étape 1** : [Explorer et analyser les jeux de données](./exploratory-analysis.md)
- **Étape 2** : [Ingénieur des fonctionnalités pour le machine learning](./feature-engineering.md)
- **Étape 3** : [Exporter des jeux de données de fonctionnalités](./export-data.md)

## Ressources supplémentaires

- [aepp](https://github.com/adobe/aepp) : bibliothèque [!DNL Python] open source gérée par Adobe pour envoyer des requêtes à Data Distiller et à d’autres services Experience Platform à partir de code [!DNL Python].

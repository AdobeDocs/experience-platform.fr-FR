...
title: Présentation du service de requête
...
Avec Adobe Experience Platform, vous pouvez ingérer, stocker, structurer et extraire tous les jeux de données stockés, y compris les données comportementales, CRM et de point de vente. Grâce à Query Service, vous pouvez interroger ces jeux de données et répondre à des questions commerciales spécifiques, générant ainsi des informations pertinentes. Découvrez comment créer et gérer des tableaux de bord personnalisés dans lesquels vous pouvez créer, ajouter et modifier des widgets personnalisés pour visualiser les mesures clés à l’aide de [tableaux de bord définis par l’utilisateur](../dashboards/standard-dashboards.md). Vous pouvez également [personnaliser vos propres rapports Real-Time CDP](../dashboards/data-models/cdp-insights-data-model-b2c.md) pour vos cas d’utilisation de marketing et d’indicateurs clés de performance à l’aide de requêtes SQL avec les modèles de données d’informations Real-Time Customer Data Platform.

## Étapes suivantes et ressources supplémentaires

Ce document vous a initié au service de requête et à son fonctionnement dans le cadre plus vaste d’Experience Platform. Pour continuer à en savoir plus sur les fonctionnalités de Query Service, nous vous recommandons de lire les documents suivants :

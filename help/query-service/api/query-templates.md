---
keywords: Experience Platform;accueil;rubriques les plus consultées;query service;modèles de requête;guide d’api;modèles;Query service;
solution: Experience Platform
title: Point d’entrée de l’API des modèles de requête
...
>[!NOTE]
>
>Vous pouvez utiliser la valeur de `_links.delete` pour [supprimer le modèle de requête](#delete-a-specified-query-template).

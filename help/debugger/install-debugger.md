...
Une fois que vous avez installé l’extension Chrome ou le module complémentaire Firefox, une icône (![](images/start-icon.jpg)) est ajouté à la barre d’extension. Sélectionnez cette icône pour ouvrir l’extension.

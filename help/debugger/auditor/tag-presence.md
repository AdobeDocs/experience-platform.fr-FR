...
| --- | --- | --- | --- |
| Adobe Advertising - Présence du code | 5 | La balise Adobe Advertising n’est pas disponible dans le DOM. | Implémentez la balise Adobe Advertising à l’aide de l’extension de balise [Adobe Advertising](../../destinations/catalog/advertising/adobe-advertising-cloud.md). |
| Adobe Advertising - Pixel de segment implémenté | 5 | Mettez à niveau vos pixels de segment Adobe Advertising vers les nouvelles balises d’image seule Adobe Advertising. L’utilisation de balises de segment AMO obsolètes peut entraîner une perte de données. | Implémentez le pixel de segment Adobe Advertising à l’aide de l’extension de balise [Adobe Advertising](../../destinations/catalog/advertising/adobe-advertising-cloud.md). |

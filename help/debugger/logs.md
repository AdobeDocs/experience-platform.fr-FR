...
**[!UICONTROL survenue à]:** Indique le moment où le problème journalisé s’est produit au cours de la session.
...
Certains messages du journal disposent d’une option Afficher le code. Sélectionner **[!UICONTROL Afficher le code]** pour afficher le code conditionnel qui détermine si une règle doit se déclencher.

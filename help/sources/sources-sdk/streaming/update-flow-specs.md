...
Les sources créées avec la variable `generic-streaming` tous les modèles utilisent la variable `GenericStreamingAEP` spécification de flux. Cette spécification de flux peut être récupérée en adressant une requête GET à la fonction `/flowSpecs/` et en fournissant la variable `flowSpec.id` de `e77fde5a-22a8-11ed-861d-0242ac120002`.
...
La requête suivante récupère le `e77fde5a-22a8-11ed-861d-0242ac120002` spécification de flux.

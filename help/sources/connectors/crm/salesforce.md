---
keywords: Experience Platform;accueil;rubriques populaires;schéma crm;crm;CRM;salesforce;Salesforce
...
[!DNL Experience Platform] prend en charge l’assimilation de données à partir d’un système de gestion de la relation client tiers. Les fournisseurs de gestion de la relation client prennent en charge [!DNL Salesforce].
...
La documentation ci-dessous fournit des informations sur la façon de se connecter [!DNL Salesforce] à [!DNL Platform] à l&#39;aide d&#39;API ou de l&#39;interface utilisateur :

## Connectez [!DNL Salesforce] à [!DNL Platform] à l’aide d’API.

- [Création d’une connexion source Salesforce à l’aide de l’API de service de flux](../../tutorials/api/create/crm/salesforce.md)
...
## Connectez [!DNL Salesforce] à [!DNL Platform] à l’aide de l’interface utilisateur.

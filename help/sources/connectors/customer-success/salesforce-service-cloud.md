...
[!DNL Experience Platform] prend en charge l’ingestion de données provenant d’un système de succès client tiers. [!DNL Salesforce Service Cloud] est la prise en charge des fournisseurs de succès client.

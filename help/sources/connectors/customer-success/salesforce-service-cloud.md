...
La documentation ci-dessous fournit des informations sur la connexion d’[!DNL Salesforce Service Cloud] à à l’aide d’API ou de l’interface utilisateur :[!DNL Platform]

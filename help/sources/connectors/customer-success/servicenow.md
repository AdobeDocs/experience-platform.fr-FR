...
La documentation ci-dessous fournit des informations sur la façon de se connecter [!DNL ServiceNow] à [!DNL Platform] l’aide des API ou de l’interface utilisateur :

## Se connecter [!DNL ServiceNow] à [!DNL Platform] l’aide des API
...
## Se connecter [!DNL ServiceNow] à [!DNL Platform] l’aide de l’interface utilisateur

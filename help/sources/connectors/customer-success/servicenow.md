...
La documentation ci-dessous fournit des informations sur la connexion d’[!DNL ServiceNow] à à l’aide d’API ou de l’interface utilisateur :[!DNL Platform]

## Connecter [!DNL ServiceNow] à [!DNL Platform] à lʼaide dʼAPI
...
## Connecter [!DNL ServiceNow] à [!DNL Platform] à lʼaide de l’interface utilisateur

---
title: Présentation du connecteur Oracle Eloqua
description: Découvrez comment connecter Oracle Eloqua à Adobe Experience Platform à l’aide d’API ou de l’interface utilisateur.
...
>[!WARNING]
>
>La source [!DNL Oracle Eloqua] est désormais obsolète et n’est plus disponible. Utilisez la nouvelle source [[!DNL Oracle Eloqua] (V2)](eloqua.md) comme nouveau connecteur pour vos données [!DNL Eloqua].
...
La documentation ci-dessous fournit des informations sur la connexion de [!DNL Oracle Eloqua] à Experience Platform à l’aide d’API ou de l’interface utilisateur :

## Connexion de [!DNL Oracle Eloqua] à Experience Platform à l’aide d’API

* [Créer une connexion de base Oracle Eloqua à l’aide de l’API Flow Service](../../tutorials/api/create/marketing-automation/oracle-eloqua.md)
...
## Connexion d’[!DNL Oracle Eloqua] à Experience Platform à l’aide de l’interface utilisateur

* [Créer une connexion source Oracle Eloqua dans l’interface utilisateur](../../tutorials/ui/create/marketing-automation/oracle-eloqua.md)

...
La documentation ci-dessous fournit des informations sur la connexion de [!DNL Oracle Eloqua] à Platform à l’aide d’API ou de l’interface utilisateur :

## Connexion [!DNL Oracle Eloqua] vers Platform à l’aide d’API
...
## Connexion [!DNL Oracle Eloqua] vers Platform à l’aide de l’interface utilisateur

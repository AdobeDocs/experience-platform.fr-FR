---
keywords: Experience Platform;accueil;rubriques populaires;hubspot;Hubspot;HubSpot
...
[!DNL Experience Platform] prend en charge l’ingestion de données provenant d’un système d’automatisation marketing tiers. La prise en charge des fournisseurs d’automatisation marketing inclut [!DNL HubSpot].
...
## Connecter [!DNL HubSpot] à [!DNL Experience Platform] à lʼaide dʼAPI

- [Créer une connexion de base HubSpot à l’aide de l’API Flow Service](../../tutorials/api/create/marketing-automation/hubspot.md)
...
## Connecter [!DNL HubSpot] à [!DNL Experience Platform] à lʼaide de l’interface utilisateur

- [Créer une connexion source HubSpot dans l’interface utilisateur](../../tutorials/ui/create/marketing-automation/hubspot.md)

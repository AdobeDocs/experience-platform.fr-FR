...
| Campagne B2B | [Campagne commerciale XDM](../../../../xdm/classes/b2b/business-campaign.md) | Détails des campagnes commerciales XDM | Activé | `campaignKey.sourceKey` dans la classe de base | Campagne B2B | `extSourceSystemAudit.externalKey.sourceKey` dans la classe de base | Campagne B2B |

...
| Nouvelles données dans Customer Journey Analytics sans [assemblage](https://experienceleague.adobe.com/docs/analytics-platform/using/stitching/overview.html?lang=fr) | &lt; 3,75 heures |

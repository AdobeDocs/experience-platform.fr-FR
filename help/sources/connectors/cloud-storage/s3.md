...
Pour importer un seul répertoire avec S3, vous devez créer un utilisateur [!DNL Identity and Access Management] (IAM) pour Platform dans la console S3 et attribuer des autorisations pour les actions suivantes :

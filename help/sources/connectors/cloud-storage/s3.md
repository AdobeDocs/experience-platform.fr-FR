...
- Copiez le **Rôle IAM** répertorié sous [!UICONTROL Ajouter un rôle IAM à &#x200B;]. Vous utiliserez ultérieurement ce rôle IAM pour configurer des autorisations pour votre compartiment [!DNL Amazon S3].

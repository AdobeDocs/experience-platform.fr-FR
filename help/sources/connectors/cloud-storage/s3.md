...
- Sélectionnez [!DNL Amazon S3], puis sélectionnez **[!UICONTROL New account]**.
- Copiez le **Rôle IAM** répertorié sous [!UICONTROL Add IAM Role to allowlist]. Vous utiliserez ultérieurement ce rôle IAM pour configurer des autorisations pour votre compartiment [!DNL Amazon S3].

...
Adobe Experience Platform fournit une connectivité native aux fournisseurs de cloud tels qu’AWS, [!DNL Google Cloud Platform] et [!DNL Azure]. Vous pouvez importer vos données de ces systèmes dans l’Experience Platform.
...
Cette section décrit les étapes préalables à suivre avant de connecter votre compte [!DNL Amazon S3] à Experience Platform.
...
## Configurer votre source [!DNL Amazon S3] pour Experience Platform sur Amazon Web Services {#aws}
...
- [Créer une connexion de base S3 à l’aide de l’API Flow Service](../../tutorials/api/create/cloud-storage/s3.md)
...
### Connexion de [!DNL Amazon S3] à Experience Platform à l’aide de l’interface utilisateur

...
>[!IMPORTANT]
>
>La variable [!DNL Azure Data Lake Storage Gen2] source ne prend pas en charge la connectivité de la même région à Experience Platform. Si votre instance Azure utilise la même région de réseau qu’Experience Platform, une connexion aux sources Experience Platform ne peut pas être établie. N’utilisez pas les régions Azure East US 2, Azure West Europe et Azure Australia East lors de la configuration de votre [!DNL Azure Data Lake Storage Gen2] source. Actuellement, seule la connectivité inter-régions est prise en charge.
...
## Connexion [!DNL Azure Data Lake Storage Gen2] à Experience Platform

>[!NOTE]
>
>Entité de sécurité de service utilisée pour créer une [!DNL Azure Data Lake Storage Gen2] doit avoir au moins la variable **Reader de données Blob de stockage** rôle attribué à partir du contrôle d’accès (IAM)

La documentation ci-dessous fournit des informations sur la connexion. [!DNL Azure Data Lake Storage Gen2] pour les Experience Platform à l’aide d’API ou de l’interface utilisateur :

### Utiliser les API

- [Créez un [!DNL Azure Data Lake Storage Gen2] connexion de base à l’aide de l’API Flow Service](../../tutorials/api/create/cloud-storage/adls-gen2.md)
...
- [Créez un [!DNL Azure Data Lake Storage Gen2] connexion source dans l’interface utilisateur](../../tutorials/ui/create/cloud-storage/adls-gen2.md)

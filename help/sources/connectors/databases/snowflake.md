...
# (Version bêta) [!DNL Snowflake] source

>[!NOTE]
>
>La source [!DNL Snowflake] est en version bêta. Pour plus d’informations sur l’utilisation de connecteurs bêta, consultez la [Présentation des sources](../../home.md#terms-and-conditions) .
...
La documentation ci-dessous fournit des informations sur la connexion de [!DNL Snowflake] à Platform à l’aide d’API ou de l’interface utilisateur :
...
## Connexion de [!DNL Snowflake] à Platform à l’aide de l’interface utilisateur

...
# (Version bêta) [!DNL Teradata Vantage] source
...
La documentation ci-dessous fournit des informations sur la connexion de [!DNL Teradata Vantage] à Platform à l’aide d’API ou de l’interface utilisateur :

## Connexion [!DNL Teradata Vantage] vers Platform à l’aide d’API
...
## Connexion [!DNL Teradata Vantage] vers Platform à l’aide de l’interface utilisateur

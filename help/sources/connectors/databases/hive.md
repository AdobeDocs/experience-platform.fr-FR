---
keywords: Experience Platform;accueil;rubriques populaires;Apache Hive;Hive;hive;hive;Azure HDInsights;azure hdinsights;
solution: Experience Platform
title: Présentation d’Apache Hive sur le connecteur Source HDInsights d’Azure
...
# (Beta) [!DNL Apache Hive] sur le connecteur [!DNL Azure HDInsights]
...
[!DNL Experience Platform] prend en charge l’ingestion de données provenant d’une base de données tierce. [!DNL Experience Platform] pouvez vous connecter à différents types de bases de données, telles que Relational, NoSQL ou Data Warehouse. La prise en charge des fournisseurs de base de données inclut des [!DNL Apache Hive] sur [!DNL Azure HDInsights].
...
## Connexion de [!DNL Apache Hive] sur [!DNL Azure HDInsights] à [!DNL Experience Platform] à l’aide d’API

- [Créer une connexion de base Apache Hive sur Azure HDInsights à l’aide de l’API Flow Service](../../tutorials/api/create/databases/hive.md)
...
## Connectez [!DNL Apache Hive] sur [!DNL Azure HDInsights] à [!DNL Experience Platform] à l’aide de l’interface utilisateur

- [Créer une ruche Apache sur la connexion source Azure HDInsights dans l’interface utilisateur](../../tutorials/ui/create/databases/hive.md)

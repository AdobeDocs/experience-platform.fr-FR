---
keywords: Experience Platform ; accueil ; sujets populaires ; Apache Hive ; Hive ; ruche ; Vie HDI Azure ; Vues HDInsights ; Vignettes azures ;
...
# (Bêta) [!DNL Apache Hive] sur le connecteur [!DNL Azure HDInsights]

>[!NOTE]
>
>Le connecteur Apache Hive sur Azure HDInsights est en version bêta. Pour plus d&#39;informations sur l&#39;utilisation de connecteurs bêta, consultez l&#39;[Présentation des sources](../../home.md#terms-and-conditions).
...
La documentation ci-dessous fournit des informations sur la façon de se connecter à [!DNL Apache Hive] sur [!DNL Azure HDInsights] à [!DNL Platform] à l&#39;aide d&#39;API ou de l&#39;interface utilisateur :

## Connectez [!DNL Apache Hive] sur [!DNL Azure HDInsights] à [!DNL Platform] à l&#39;aide d&#39;API.

- [Création d&#39;une Apache Hive sur la connexion source Azure HDInsights à l&#39;aide de l&#39;API Flow Service](../../tutorials/api/create/databases/hive.md)
...
## Connectez [!DNL Apache Hive] sur [!DNL Azure HDInsights] à [!DNL Platform] à l&#39;aide de l&#39;interface utilisateur.

- [Création d&#39;une Apache Hive sur la connexion source Azure HDInsights dans l&#39;interface utilisateur](../../tutorials/ui/create/databases/hive.md)

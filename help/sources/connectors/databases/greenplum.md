...
title: Connecteur GreenPlum
topic: overview
description: La documentation ci-dessous fournit des informations sur la connexion de GreenPlum à Platform à l’aide d’API ou de l’interface utilisateur.
...
Différents types de bases de données tierces sont pris en charge, y compris les entrepôts de données relationnels, NoSQL ou Data Warehouse. La prise en charge des fournisseurs de base de données comprend [!DNL GreenPlum].
...
La documentation ci-dessous fournit des informations sur la façon de se connecter [!DNL GreenPlum] à [!DNL Platform] l’aide des API ou de l’interface utilisateur :

## Se connecter [!DNL GreenPlum] à [!DNL Platform] l’aide des API

- [Création d’un connecteur GreenPlum à l’aide de l’API du service de flux](../../tutorials/api/create/databases/greenplum.md)
...
## Se connecter [!DNL GreenPlum] à [!DNL Platform] l’aide de l’interface utilisateur

- [Création d’un connecteur source GreenPlum dans l’interface utilisateur](../../tutorials/ui/create/databases/greenplum.md)

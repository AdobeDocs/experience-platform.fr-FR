...
title: Présentation de Phoenix Source Connector
topic: overview
...
[!DNL Experience Platform] prend en charge l’ingestion de données provenant d’une base de données tierce. [!DNL Platform] peut se connecter à différents types de bases de données, telles que relationnelles, NoSQL ou des entrepôts de données. Les fournisseurs de base de données prennent en charge [!DNL Phoenix].
...
La documentation ci-dessous fournit des informations sur la façon de se connecter [!DNL Phoenix] à [!DNL Platform] à l&#39;aide d&#39;API ou de l&#39;interface utilisateur :

## Connectez [!DNL Phoenix] à [!DNL Platform] à l’aide d’API.

- [Création d’une connexion source Phoenix à l’aide de l’API Flow Service](../../tutorials/api/create/databases/phoenix.md)
...
## Connectez [!DNL Phoenix] à [!DNL Platform] à l’aide de l’interface utilisateur.

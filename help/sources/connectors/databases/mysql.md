...
La documentation ci-dessous fournit des informations sur la connexion de MySQL à [!DNL Platform] l’aide d’API ou de l’interface utilisateur :

## Connexion de MySQL à [!DNL Platform] l’aide des API
...
## Connexion de MySQL à [!DNL Platform] l’aide de l’interface utilisateur

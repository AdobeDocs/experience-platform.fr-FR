...
Experience Platform prend en charge l’assimilation de données à partir d’une base de données tierce. La plate-forme peut se connecter à différents types de bases de données, telles que relationnelles, NoSQL ou les entrepôts de données. Les fournisseurs de base de données prennent en charge MySQL.

La documentation ci-dessous fournit des informations sur la connexion de MySQL à la plate-forme à l’aide d’API ou de l’interface utilisateur :
...
## Connexion de MySQL à la plate-forme à l’aide de l’interface utilisateur

...
[!DNL Experience Platform] prend en charge l’importation de données à partir d’une base de données tierce. [!DNL Platform] peut se connecter à différents types de bases de données, tels que relational, NoSQL ou datas warehouse. Les fournisseurs de base de données sont pris en charge [!DNL Amazon Redshift].

La documentation ci-dessous fournit des informations sur la façon de se connecter [!DNL Amazon Redshift] à [!DNL Platform] l’aide des API ou de l’interface utilisateur :
...
## Se connecter [!DNL Amazon Redshift] à [!DNL Platform] l’aide de l’interface utilisateur

- [Création d’un connecteur source Amazon Redshift dans l’interface utilisateur](../../tutorials/ui/create/databases/redshift.md)

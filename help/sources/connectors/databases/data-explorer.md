...
Différents types de bases de données tierces sont pris en charge, y compris relationnelles, NoSQL ou les datas warehouse. La prise en charge des fournisseurs de base de données comprend [!DNL Azure Data Explorer].

...
title: Connecteur de Data Explorer Azure
topic: overview
description: La documentation ci-dessous fournit des informations sur la façon de connecter Azure Data Explorer à la plate-forme à l'aide d'API ou de l'interface utilisateur.
...
Différents types de bases de données tierces sont pris en charge, y compris les entrepôts de données relationnels, NoSQL ou Data Warehouse. La prise en charge des fournisseurs de base de données comprend [!DNL Azure Data Explorer].
...
La documentation ci-dessous fournit des informations sur la façon de se connecter [!DNL Azure Data Explorer] à [!DNL Platform] l’aide des API ou de l’interface utilisateur :

## Se connecter [!DNL Azure Data Explorer] à [!DNL Platform] l’aide des API

- [Création d&#39;un connecteur de Data Explorer Azure à l&#39;aide de l&#39;API Flow Service](../../tutorials/api/create/databases/data-explorer.md)
...
## Se connecter [!DNL Azure Data Explorer] à [!DNL Platform] l’aide de l’interface utilisateur

- [Création d&#39;un connecteur source de Data Explorer Azure dans l&#39;interface utilisateur](../../tutorials/ui/create/databases/data-explorer.md)

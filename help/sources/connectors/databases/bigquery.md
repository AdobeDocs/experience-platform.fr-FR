...
Experience Platform prend en charge l’assimilation de données à partir d’une base de données tierce. Platform peut se connecter à différents types de bases de données, tels que relational, NoSQL ou Data Warehouse. Les fournisseurs de base de données prennent en charge Google BigQuery.

La documentation ci-dessous fournit des informations sur la connexion de Google BigQuery à une plateforme à l’aide d’API ou de l’interface utilisateur :
...
## Connexion de Google BigQuery à la plateforme à l’aide de l’interface utilisateur

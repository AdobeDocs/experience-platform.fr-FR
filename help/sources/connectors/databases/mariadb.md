...
L’Experience Platform prend en charge l’assimilation de données à partir d’une base de données tierce. Platform peut se connecter à différents types de bases de données comme relationnelles, NoSQL ou datas warehouse. Les fournisseurs de bases de données prennent en charge MariaDB.

La documentation ci-dessous fournit des informations sur la connexion de MariaDB à Platform à l’aide d’API ou de l’interface utilisateur :

## Connexion de MariaDB à Platform à l’aide d’API
...
## Connexion de MariaDB à Platform à l’aide de l’interface utilisateur

...
# Exploration d’un système de publicité à l’aide de l’API du service de flux

Le service de flux permet de collecter et de centraliser les données client à partir de diverses sources disparates dans Adobe Experience Platform. Le service fournit une interface utilisateur et une API RESTful à partir de laquelle toutes les sources prises en charge sont connectables.

Ce didacticiel utilise l’API du service de flux pour explorer les systèmes publicitaires.
...
Ce didacticiel nécessite que vous ayez une connexion valide avec l’application publicitaire tierce à partir de laquelle vous souhaitez importer des données. Une connexion valide implique l’ID de spécification de connexion et l’ID de connexion de votre application. Pour plus d&#39;informations sur la création d&#39;une connexion publicitaire et la récupération de ces valeurs, consultez le didacticiel [Connexion d&#39;une source publicitaire à la plateforme](../../api/create/advertising/ads.md) .
...
En utilisant la connexion de base pour votre système publicitaire, vous pouvez explorer vos tableaux de données en exécutant des requêtes GET. Utilisez l&#39;appel suivant pour trouver le chemin du tableau que vous souhaitez inspecter ou assimiler dans Platform.
...
| --- | --- |
| `{BASE_CONNECTION_ID}` | ID de la connexion de base pour votre système publicitaire. |
...
Une réponse positive est un tableau de votre système publicitaire. Trouvez la table que vous souhaitez amener dans Plateforme et prenez note de sa `path` propriété, comme vous devez le fournir dans l&#39;étape suivante pour inspecter sa structure.
...
Pour inspecter la structure d’un tableau à partir de votre système publicitaire, exécutez une requête GET tout en spécifiant le chemin d’un tableau en tant que paramètre de .
...
| `{TABLE_PATH}` | Chemin d’accès d’une table dans votre système publicitaire. |

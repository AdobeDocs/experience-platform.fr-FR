...
Ce didacticiel utilise l&#39;API [!DNL Flow Service] pour explorer les applications de protocoles.
...
Pour explorer votre système de protocole à l&#39;aide des API [!DNL Platform], vous devez posséder un ID de connexion de base valide. Si vous n&#39;avez pas encore de connexion de base pour le système de protocole que vous souhaitez utiliser, vous pouvez en créer une à l&#39;aide du didacticiel suivant :
...
En utilisant l&#39;ID de connexion pour votre application de protocoles, vous pouvez explorer vos tableaux de données en exécutant des requêtes de GET. Utilisez l&#39;appel suivant pour trouver le chemin de la table que vous souhaitez inspecter ou assimiler dans [!DNL Platform].
...
Une réponse réussie renvoie un tableau de tables de votre application de protocoles. Recherchez la table que vous souhaitez importer dans [!DNL Platform] et notez sa propriété `path`, car vous devez la fournir à l&#39;étape suivante pour inspecter sa structure.
...
| `{TABLE_PATH}` | Chemin d&#39;accès d&#39;une table dans l&#39;application de protocoles. |
...
En suivant ce tutoriel, vous avez exploré votre application de protocoles, trouvé le chemin du tableau que vous souhaitez insérer dans [!DNL Platform] et obtenu des informations sur sa structure. Vous pouvez utiliser ces informations dans le didacticiel suivant pour [collecter les données de votre application de protocoles et les importer dans Platform](../collect/protocols.md).

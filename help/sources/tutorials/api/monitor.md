...
Ce didacticiel nécessite que vous disposiez de la valeur ID d’un flux de données valide. Si vous ne disposez pas d’un ID de flux de données valide, sélectionnez le connecteur de votre choix dans [source overview](../../home.md) et suivez les étapes décrites avant de tenter ce didacticiel.

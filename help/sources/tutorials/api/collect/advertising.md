...
>[!NOTE]
>
>* Pour créer un flux de données, vous devez déjà disposer d’un identifiant de connexion de base valide avec une source publicitaire. Si vous ne disposez pas de cet identifiant, consultez la [présentation des sources](../../../home.md#advertising) pour obtenir la liste des sources publicitaires avec lesquelles vous pouvez créer une connexion de base.

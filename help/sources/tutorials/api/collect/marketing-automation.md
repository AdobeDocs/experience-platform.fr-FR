...
>[!NOTE]
>
>* Pour créer un flux de données, vous devez déjà disposer d’un identifiant de connexion de base valide avec une source d’automatisation marketing. Si vous ne disposez pas de cet identifiant, consultez la [présentation des sources](../../../home.md#marketing-automation) pour obtenir la liste des sources d’automatisation du marketing avec lesquelles vous pouvez créer une connexion de base.

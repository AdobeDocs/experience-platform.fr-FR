...
>[!NOTE]
>
>* Pour créer un flux de données, vous devez déjà disposer d’un identifiant de connexion de base valide avec une source de commerce électronique. Si vous ne disposez pas de cet ID, consultez la [présentation des sources](../../../home.md#ecommerce) pour obtenir la liste des sources d’e-commerce avec lesquelles vous pouvez créer une connexion de base.

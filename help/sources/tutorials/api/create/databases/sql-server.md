...
Ce didacticiel utilise l’API Flow Service pour vous guider dans les étapes de connexion de l’Experience Platform à un serveur Microsoft SQL Server (ci-après appelé &quot;SQL Server&quot;).

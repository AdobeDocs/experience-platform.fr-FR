...
Ce tutoriel utilise l’API [!DNL Flow Service] pour vous guider tout au long des étapes nécessaires pour connecter [!DNL Apache Cassandra] (ci-après appelé &quot;Cassandra&quot;) à [!DNL Experience Platform].
...
| `connectionSpec.id` | Identifiant unique nécessaire pour créer une connexion. L’ID de spécification de connexion pour [!DNL Cassandra] est `a8f4d393-1a6b-43f3-931f-91a16ed857f4`. |
...
Toutes les ressources de [!DNL Experience Platform], y compris celles appartenant à [!DNL Flow Service], sont isolées dans des environnements de test virtuels spécifiques. Toutes les requêtes envoyées aux API [!DNL Platform] nécessitent un en-tête spécifiant le nom du sandbox dans lequel l’opération sera effectuée :
...
Pour créer une connexion [!DNL Cassandra], son identifiant de spécification de connexion unique doit être fourni dans le cadre de la demande du POST. L’ID de spécification de connexion pour [!DNL Cassandra] est `a8f4d393-1a6b-43f3-931f-91a16ed857f4`.

...
Les sections suivantes contiennent des informations supplémentaires dont vous aurez besoin pour vous connecter à [!DNL GreenPlum] l’aide de l’ [!DNL Flow Service] API.
...
Pour créer une [!DNL GreenPlum] connexion, son identifiant de spécification de connexion unique doit être fourni dans le cadre de la demande POST. L&#39;ID de spécification de connexion pour [!DNL GreenPlum] est `37b6bf40-d318-4655-90be-5cd6f65d334b`.

...
Ce tutoriel vous guide tout au long des étapes pour créer une connexion de base pour [!DNL HP Vertica] à l’aide de l’[[!DNL Flow Service] API](https://www.adobe.io/experience-platform-apis/references/flow-service/).

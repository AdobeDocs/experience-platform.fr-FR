...
title: Création d’une connexion à la source Oracle à l’aide de l’API du service de flux
topic: overview
type: Tutorial
description: Découvrez comment connecter Oracle à l’Experience Platform à l’aide de l’API de service de flux.

---
keywords: Experience Platform ; accueil ; sujets populaires ; ruche Apache ; ruche ; ruche
solution: Experience Platform
title: Création d'une Apache Hive sur le connecteur Azure HDInsights à l'aide de l'API Flow Service
topic: overview
type: Tutorial
description: Ce didacticiel utilise l'API Flow Service pour vous guider à travers les étapes permettant de connecter Apache Hive sur Azure HDInsights à l'Experience Platform.
...
# Créez un connecteur [!DNL Apache Hive] sur [!DNL Azure HDInsights] à l’aide de l’API [!DNL Flow Service].
...
Ce didacticiel utilise l&#39;API [!DNL Flow Service] pour vous guider dans les étapes de connexion de [!DNL Apache Hive] à [!DNL Azure HDInsights] à [!DNL Experience Platform].
...
Les sections suivantes fournissent des informations supplémentaires dont vous aurez besoin pour vous connecter à [!DNL Hive] à l&#39;aide de l&#39;API [!DNL Flow Service].

### Collecte des informations d’identification requises

Pour que [!DNL Flow Service] puisse se connecter à [!DNL Hive], vous devez fournir des valeurs pour les propriétés de connexion suivantes :
...
Pour plus d&#39;informations sur la prise en main, consultez [ce document de la ruche](https://cwiki.apache.org/confluence/display/Hive/Tutorial#Tutorial-GettingStarted).
...
Pour créer une connexion [!DNL Hive], l&#39;identifiant de spécification de connexion unique doit être fourni dans le cadre de la demande du POST. L&#39;ID de spécification de connexion pour [!DNL Hive] est `aac9bbd4-6c01-46ce-b47e-51c6f0f6db3f`.

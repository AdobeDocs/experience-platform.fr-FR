...
Les sections suivantes contiennent des informations supplémentaires dont vous aurez besoin pour vous connecter à PSQL à l’aide de l’ [!DNL Flow Service] API.

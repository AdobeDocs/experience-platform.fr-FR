---
keywords: Experience Platform;accueil;rubriques populaires;Apache Spark;apache spark;Azure HDInsights
solution: Experience Platform
title: Créer une connexion de base Apache Spark on Azure HDInsights à l’aide de l’API Flow Service
type: Tutorial
description: Découvrez comment connecter Apache Spark on Azure HDInsights à Adobe Experience Platform à l’aide de l’API Flow Service.
...
Ce tutoriel vous guide tout au long des étapes nécessaires à la création d’une connexion de base pour [!DNL Apache Spark] sur [!DNL Azure HDInsights] (ci-après dénommée « [!DNL Spark] ») à l’aide de l’[[!DNL Flow Service] API](https://developer.adobe.com/experience-platform-apis/references/flow-service).
...
Les sections suivantes contiennent des informations supplémentaires que vous devez connaître pour réussir à vous connecter à [!DNL Spark] à l’aide de l’API [!DNL Flow Service].
...
| `connectionSpec.id` | Identifiant de spécification de connexion [!DNL Spark] : `6a8d82bc-1caf-45d1-908d-cadabc9d63a6`. |

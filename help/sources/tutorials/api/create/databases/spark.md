...
Les sections suivantes contiennent des informations supplémentaires dont vous aurez besoin pour vous connecter à [!DNL Spark] l’aide de l’ [!DNL Flow Service] API.
...
Pour créer une [!DNL Spark] connexion, son identifiant de spécification de connexion unique doit être fourni dans le cadre de la demande POST. L&#39;ID de spécification de connexion pour [!DNL Spark] est `6a8d82bc-1caf-45d1-908d-cadabc9d63a6`.

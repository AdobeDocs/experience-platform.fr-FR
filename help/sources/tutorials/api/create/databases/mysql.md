...
Les sections suivantes contiennent des informations supplémentaires que vous devez connaître pour pouvoir vous connecter à MySQL à l’aide de l’ [!DNL Flow Service] API.

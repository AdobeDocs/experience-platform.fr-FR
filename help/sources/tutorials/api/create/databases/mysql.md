...
Une réponse réussie renvoie les spécifications de connexion pour MySQL, y compris son identifiant unique (`id`). Cet identifiant est requis à l’étape suivante pour créer une connexion de base.

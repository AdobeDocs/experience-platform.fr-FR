...
title: Création d’une connexion source Analytics d’Azure synapse à l’aide de l’API Flow Service
...
| `connectionSpec.id` | Identifiant unique nécessaire pour créer une connexion. L’identifiant de spécification de connexion pour [!DNL Synapse] est : `a49bcc7d-8038-43af-b1e4-5a7a089a7d79` |
...
Une connexion spécifie une source et contient vos informations d’identification pour cette source. Une seule connexion est requise par compte [!DNL Synapse], car elle peut être utilisée pour créer plusieurs connecteurs source afin d’importer différentes données.
...
Pour créer une connexion [!DNL Synapse], son identifiant de spécification de connexion unique doit être fourni dans le cadre de la demande du POST. L’identifiant de spécification de connexion pour [!DNL Synapse] est `a49bcc7d-8038-43af-b1e4-5a7a089a7d79`.

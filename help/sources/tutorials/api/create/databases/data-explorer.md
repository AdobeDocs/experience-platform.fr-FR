...
title: Création d'une connexion à la source du Data Explorer Azure à l'aide de l'API du service de flux
...
# Créez une connexion source [!DNL Azure Data Explorer] à l’aide de l’API [!DNL Flow Service].

...
# Créez un connecteur [!DNL Google BigQuery] à l’aide de l’API [!DNL Flow Service].
...
Pour que [!DNL Flow Service] puisse se connecter à BigQuery, vous devez fournir les propriétés de connexion suivantes :

...
# Création d’une connexion source en continu et d’un flux de données pour [!DNL Shopify] données à l’aide de l’API Flow Service
...
## Diffusion [!DNL Shopify] données vers Platform à l’aide de l’API Flow Service

Les étapes suivantes décrivent les étapes à suivre pour créer une connexion source et un flux de données pour diffuser vos [!DNL Shopify] données vers Platform.

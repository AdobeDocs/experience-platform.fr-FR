...
Ce didacticiel utilise l’API du service de flux pour vous guider tout au long des étapes nécessaires pour connecter PayPal à la plateforme d’expérience.
...
Les sections suivantes fournissent des informations supplémentaires dont vous aurez besoin pour vous connecter à PayPal à l&#39;aide de l&#39;API du service de flux.
...
Pour plus d&#39;informations sur la prise en main, reportez-vous à [cette](https://developer.paypal.com/docs/api/overview/#get-credentials)PayPal.
...
Pour créer une connexion PayPal, son ID de spécification de connexion unique doit être fourni dans le cadre de la demande POST. L&#39;ID de spécification de connexion pour PayPal est `221c7626-58f6-4eec-8ee2-042b0226f03b`.

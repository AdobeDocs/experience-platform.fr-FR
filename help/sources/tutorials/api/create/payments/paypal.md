...
Les sections suivantes contiennent des informations supplémentaires dont vous aurez besoin pour vous connecter à [!DNL PayPal] l’aide de l’ [!DNL Flow Service] API.
...
| ---------- | ----------- |
| Hôte | URL de l’ [!DNL PayPal] instance. (par défaut : api.sandbox.paypal.com). |
| ID client | ID client associé à votre [!DNL PayPal] application. |
| Secret client | Le secret client associé à votre [!DNL PayPal] application. |
...
Pour créer une [!DNL PayPal] connexion, son identifiant de spécification de connexion unique doit être fourni dans le cadre de la demande POST. L&#39;ID de spécification de connexion pour [!DNL PayPal] est `221c7626-58f6-4eec-8ee2-042b0226f03b`.
...
| --------- | ----------- |
| `auth.params.host` | URL de l’ [!DNL PayPal] instance. |

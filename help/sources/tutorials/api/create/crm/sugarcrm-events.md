...
# (Version bêta) Créez une connexion source et un flux de données pour [!DNL SugarCRM Events] utilisation de l’API Flow Service
...
## Connexion [!DNL SugarCRM Events] vers Platform à l’aide de la méthode [!DNL Flow Service] API
...
La dernière étape pour obtenir des données de [!DNL SugarCRM Events] vers Platform consiste à créer un flux de données. Vous disposez à présent des valeurs requises suivantes :

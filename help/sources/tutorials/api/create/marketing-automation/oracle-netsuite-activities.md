---
title: Création d’une connexion source et d’un flux de données pour les activités Oracle NetSuite à l’aide de l’API Flow Service
description: Découvrez comment créer une connexion source et un flux de données pour importer des données d’événements NetSuite Oracle à Experience Platform à l’aide de l’API Flow Service.
hide: true
hidefromtoc: true
badge: Version Beta
...
# Créer une connexion source et un flux de données pour [!DNL Oracle NetSuite Activities] utilisation de l’API Flow Service
...
Lisez le tutoriel suivant pour savoir comment importer des données d’événement de votre [!DNL Oracle NetSuite Activities] à Adobe Experience Platform à l’aide de la variable [[!DNL Flow Service] API](https://www.adobe.io/experience-platform-apis/references/flow-service/).
...
Les sections suivantes apportent des informations supplémentaires dont vous aurez besoin pour vous connecter. [!DNL Oracle NetSuite Activities] en utilisant la variable [!DNL Flow Service] API.
...
## Connexion [!DNL Oracle NetSuite Activities] vers Platform à l’aide de la méthode [!DNL Flow Service] API

Suivez le guide ci-dessous pour savoir comment authentifier votre [!DNL Oracle NetSuite Activities] source, créez une connexion source et créez un flux de données pour importer vos données d’événement dans Experience Platform.

### Créer une connexion de base {#base-connection}

Une connexion de base conserve les informations entre votre source et votre Experience Platform, y compris les informations d’authentification de votre source, l’état actuel de la connexion et votre identifiant de connexion de base unique. L’identifiant de connexion de base vous permet d’explorer et de parcourir des fichiers à partir de votre source et d’identifier les éléments spécifiques que vous souhaitez ingérer, y compris des informations concernant leurs types et formats de données.

Pour créer un identifiant de connexion de base, envoyez une requête de POST au `/connections` point de terminaison lors de la fourniture de [!DNL Oracle NetSuite Activities] informations d’identification d’authentification dans le corps de la requête.
...
| `{SOURCE_PARAMS}` | Définit les paramètres du fichier source que vous souhaitez importer dans Platform. Pour récupérer le type de format accepté pour `{SOURCE_PARAMS}`, vous devez coder la chaîne entière en base64. <br> La valeur est vide pour [!DNL Oracle NetSuite Activities].</li></ul> |
...
La dernière étape pour obtenir des données de [!DNL Oracle NetSuite Activities] vers Platform consiste à créer un flux de données. Vous disposez à présent des valeurs requises suivantes :

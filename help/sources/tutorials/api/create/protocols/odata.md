...
Les sections suivantes contiennent des informations supplémentaires dont vous aurez besoin pour vous connecter à OData à l’aide de l’ [!DNL Flow Service] API.
...
Pour créer une [!DNL OData] connexion, son identifiant de spécification de connexion unique doit être fourni dans le cadre de la demande POST. L&#39;ID de spécification de connexion pour [!DNL OData] est `8e6b41a8-d998-4545-ad7d-c6a9fff406c3`.

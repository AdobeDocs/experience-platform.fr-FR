...
Ce didacticiel utilise l’API du service de flux pour vous guider tout au long des étapes nécessaires pour connecter Generic OData à la plateforme d’expérience.
...
Les sections suivantes fournissent des informations supplémentaires dont vous aurez besoin pour vous connecter à OData à l’aide de l’API du service de flux.

### Collecte des informations d’identification requises

Pour que le service Flow puisse se connecter à OData, vous devez fournir des valeurs pour les propriétés de connexion suivantes :
...
En suivant ce didacticiel, vous avez créé une connexion OData à l’aide de l’API du service de flux et obtenu la valeur d’ID unique de la connexion. Vous pouvez utiliser cet identifiant dans le didacticiel suivant lorsque vous apprendrez à [explorer les applications de protocoles à l’aide de l’API](../../explore/protocols.md)de service de flux.
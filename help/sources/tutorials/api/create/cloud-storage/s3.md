...
Ce tutoriel vous guide tout au long des étapes pour créer une connexion de base pour [!DNL Amazon S3] (ci-après appelée &quot;[!DNL S3]&quot;) à l’aide de l’[[!DNL Flow Service] API](https://www.adobe.io/apis/experienceplatform/home/api-reference.html#!acpdr/swagger-specs/flow-service.yaml).
...
| ---------- | ----------- |
| `s3AccessKey` | Identifiant de la clé d’accès pour votre stockage [!DNL S3]. |
| `s3SecretKey` | ID de clé secrète pour votre stockage [!DNL S3]. |
...
| -------- | ----------- |
| `auth.params.s3AccessKey` | Clé d’accès associée à votre stockage [!DNL S3]. |
| `auth.params.s3SecretKey` | Votre clé secrète associée à votre stockage [!DNL S3]. |
| `connectionSpec.id` | ID de spécification de connexion de stockage [!DNL S3] : `ecadc60c-7455-4d87-84dc-2a0e293d997b` |

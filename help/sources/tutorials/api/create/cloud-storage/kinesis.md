...
| `region` | Région de votre compte [!DNL Kinesis]. Placer sur la liste autorisée Pour plus d’informations sur les régions[&#x200B; consultez le guide sur l’](../../../../ip-address-allow-list.md)ajout d’adresses IP à votre. |

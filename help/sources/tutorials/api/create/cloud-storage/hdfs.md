...
topic: overview
description: Ce didacticiel utilise l’API Flow Service pour vous guider à travers les étapes permettant de connecter un système de fichiers distribué Apache Hadoop (ci-après appelé "HDFS") à un Experience Platform.

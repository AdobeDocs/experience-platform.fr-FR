...
Les sections suivantes contiennent des informations supplémentaires dont vous aurez besoin pour vous connecter à la publicité à l’aide de l’ [!DNL Flow Service] API.
...
| Secret client | Le secret client de l’ [!DNL Google] application utilisée pour acquérir le jeton d’actualisation. |

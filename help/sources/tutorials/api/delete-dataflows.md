...
Vous pouvez supprimer les flux de données par lots et par flux qui contiennent des erreurs ou qui sont devenus obsolètes à l’aide de l’[[!DNL Flow Service] API](https://www.adobe.io/experience-platform-apis/references/flow-service/).
...
En suivant ce tutoriel, vous avez utilisé l’API [!DNL Flow Service] pour supprimer un flux de données existant.

Pour savoir comment effectuer ces opérations à l’aide de l’interface utilisateur, reportez-vous au tutoriel sur la [suppression des flux de données dans l’interface utilisateur](../../tutorials/ui/delete.md)

...
Une fois votre compte source d’e-commerce créé, l’étape **[!UICONTROL Add data]** s’affiche, vous permettant d’explorer la hiérarchie des tableaux de votre compte source d’e-commerce.

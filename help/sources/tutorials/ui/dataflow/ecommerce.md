---
keywords: Experience Platform;accueil;rubriques les plus consultées;connecteur eCommerce;eCommerce
solution: Experience Platform
title: Créer un flux de données à l’aide d’un Source E-Commerce dans l’interface utilisateur
type: Tutorial
description: Un flux de données est une tâche planifiée qui récupère et ingère des données d’une source vers un jeu de données Experience Platform. Ce tutoriel décrit les étapes à suivre pour créer un flux de données pour une source d’e-commerce à l’aide de l’interface utilisateur d’Experience Platform.
...
# Créer un flux de données à l’aide d’une source d’e-commerce dans l’interface utilisateur

Un flux de données est une tâche planifiée qui récupère et ingère des données d’une source vers un jeu de données dans Adobe Experience Platform. Ce tutoriel décrit les étapes à suivre pour créer un flux de données pour une source d’e-commerce à l’aide de l’interface utilisateur d’Experience Platform.

>[!NOTE]
>
>* Pour créer un flux de données, vous devez déjà disposer d’un compte authentifié avec une source d’e-commerce. Vous trouverez une liste de tutoriels sur la création de différents comptes sources d’e-commerce dans l’interface utilisateur dans la [présentation des sources](../../../home.md#ecommerce).
...
Une fois votre compte source d’e-commerce créé, l’étape **[!UICONTROL Ajouter des données]** s’affiche, vous permettant d’explorer la hiérarchie des tableaux de votre compte source d’e-commerce.

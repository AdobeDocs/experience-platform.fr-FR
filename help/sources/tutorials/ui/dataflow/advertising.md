...
Une fois votre compte de source publicitaire créé, l’étape **[!UICONTROL Add data]** s’affiche, vous permettant d’explorer la hiérarchie des tableaux de votre compte de source publicitaire.

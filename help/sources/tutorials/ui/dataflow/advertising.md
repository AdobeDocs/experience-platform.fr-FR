...
Un flux de données est un planifié qui récupère et ingère des données d’une source dans un jeu de données Adobe Experience Platform. Ce didacticiel décrit les étapes à suivre pour configurer un nouveau flux de données à l’aide de votre compte publicitaire.
...
De plus, ce didacticiel nécessite que vous ayez déjà créé un compte publicitaire. Un de didacticiels pour la création de différents connecteurs de paiement dans l’interface utilisateur se trouve dans la présentation [des connecteurs](../../../home.md)source.

## Sélectionner des données

Après avoir créé votre compte publicitaire, l’étape *Sélectionner les données* s’affiche, ce qui vous permet d’explorer la hiérarchie des fichiers dans une interface interactive.
...
![select-](../../../images/tutorials/dataflow/advertising/select-existing-schema.png)
...
![révision](../../../images/tutorials/dataflow/advertising/review.png)

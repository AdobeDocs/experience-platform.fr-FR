---
keywords: Experience Platform;accueil;rubriques les plus consultées;configurer le flux de données;connecteur advertising
solution: Experience Platform
title: Créer un flux de données à l’aide d’un Source Advertising dans l’interface utilisateur
type: Tutorial
description: Un flux de données est une tâche planifiée qui récupère et ingère des données d’une source vers un jeu de données Experience Platform. Ce tutoriel décrit les étapes à suivre pour créer un flux de données pour une source publicitaire à l’aide de l’interface utilisateur d’Experience Platform.
...
topic_v2: id: bce87dde-a4ab-44c9-8a18-ad66e4ddb377id: df401a2a-327d-468c-a5e4-b7b7ccd071a0id: fd2e3797-f2ea-4b36-a9af-52acf5e90513
...
# Créer un flux de données à l’aide d’une source publicitaire dans l’interface utilisateur

Un flux de données est une tâche planifiée qui récupère et ingère des données d’une source vers un jeu de données dans Adobe Experience Platform. Ce tutoriel décrit les étapes à suivre pour créer un flux de données pour une source publicitaire à l’aide de l’interface utilisateur d’Experience Platform.

>[!NOTE]
>
>* Pour créer un flux de données, vous devez déjà disposer d’un compte authentifié avec une source publicitaire. Vous trouverez une liste de tutoriels sur la création de différents comptes de sources publicitaires dans l’interface utilisateur dans la [présentation des sources](../../../home.md#advertising).
...
Une fois votre compte de source publicitaire créé, l’étape **[!UICONTROL Ajouter des données]** s’affiche, vous permettant d’explorer la hiérarchie des tableaux de votre compte de source publicitaire.
...
Ce tutoriel vous a permis de créer un flux de données pour importer les données de votre source publicitaire dans Experience Platform. Les données entrantes peuvent désormais être utilisées par les services [!DNL Experience Platform] en aval tels que [!DNL Real-Time Customer Profile] et [!DNL Data Science Workspace]. Consultez les documents suivants pour plus d’informations :

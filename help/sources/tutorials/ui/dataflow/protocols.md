...
En outre, ce tutoriel nécessite que vous ayez déjà créé un compte de protocoles. Vous trouverez une liste des tutoriels pour la création de différents connecteurs de protocole dans l’interface utilisateur dans la [présentation des connecteurs source](../../../home.md).

## Sélectionner des données

Après avoir créé votre compte de protocoles, l’étape **[!UICONTROL Sélectionner les données]** s’affiche, vous fournissant ainsi une interface interactive pour explorer votre hiérarchie de fichiers.

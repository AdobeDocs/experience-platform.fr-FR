...
Une fois votre compte source de protocoles créé, l’étape **[!UICONTROL Add data]** s’affiche, vous permettant d’explorer la hiérarchie des tables de votre compte source de protocoles.

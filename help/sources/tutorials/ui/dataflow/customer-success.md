...
Une fois votre compte source de succès client créé, l’étape **[!UICONTROL Add data]** s’affiche, vous permettant d’explorer la hiérarchie des tableaux de votre compte source de succès client.

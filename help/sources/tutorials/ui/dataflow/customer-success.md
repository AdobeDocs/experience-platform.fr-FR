...
Dans l’espace de travail *[!UICONTROL Sources]* , sélectionnez la source de succès client que vous souhaitez vue sous la catégorie de succès ** client. Sélectionnez *[!UICONTROL Connect Source]* pour lancer l’interface d’authentification. Pour vue d’un flux de données existant, sélectionnez Compte ** existant et sélectionnez le compte auquel vous souhaitez accéder.

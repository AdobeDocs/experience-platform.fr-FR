...
Un flux de données est un planifié qui récupère et ingère des données d’une source dans un jeu de données de la plateforme. Ce didacticiel décrit les étapes à suivre pour configurer un nouveau flux de données à l’aide de votre compte de réussite client.
...
En outre, ce didacticiel nécessite que vous ayez déjà créé un compte de réussite client. Un de didacticiels pour la création de différents connecteurs de succès client dans l’interface utilisateur se trouve dans la présentation [des connecteurs](../../../home.md)source.
...
Cliquez ensuite sur l’icône  du.
...
![select-](../../../images/tutorials/dataflow/customer-success/select-schema.png)
...
![révision](../../../images/tutorials/dataflow/customer-success/review.png)
...
Dans l’espace de travail *Sources* , sélectionnez la source de succès du client que vous souhaitez sous le  de réussite *du* client. Sélectionnez *Connect Source* pour lancer l’interface d’authentification. Pour  un flux de données existant, sélectionnez Compte ** existant et sélectionnez le compte auquel vous souhaitez accéder.
...
![dataset--](../../../images/tutorials/dataflow/customer-success/dataset-activity.png)
...
En suivant ce didacticiel, vous avez créé un flux de données afin d’importer des données d’une source de succès client et d’obtenir des informations sur la surveillance des jeux de données. Les données entrantes peuvent désormais être utilisées par les services Plateforme en aval, tels que les  de clients en temps réel et l’espace de travail des sciences de données. Pour plus d’informations, reportez-vous au  suivant :

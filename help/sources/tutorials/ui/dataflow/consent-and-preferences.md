...
title: Création d’un flux de données à l’aide d’un Source de consentement et de préférences dans l’interface utilisateur
type: Tutorial
...
Après avoir créé votre compte source de consentement et de préférences, l’étape **[!UICONTROL Ajouter des données]** s’affiche, vous permettant d’explorer la hiérarchie des tables de votre compte de consentement et de préférences.

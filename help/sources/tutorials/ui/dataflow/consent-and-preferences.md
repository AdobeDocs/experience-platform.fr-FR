...
Une fois votre compte source de consentement et de préférences créé, l’étape **[!UICONTROL Add data]** s’affiche, vous permettant d’explorer la hiérarchie des tableaux de votre compte de consentement et de préférences.

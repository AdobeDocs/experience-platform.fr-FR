...
En outre, ce didacticiel nécessite que vous ayez déjà créé un compte de paiement. Vous trouverez une liste de didacticiels pour la création de différents connecteurs de paiement dans l&#39;interface utilisateur dans [présentation des connecteurs source](../../../home.md).

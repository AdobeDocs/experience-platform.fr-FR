...
En outre, ce tutoriel nécessite que vous ayez déjà créé un compte de paiement. Vous trouverez une liste des tutoriels de création de différents connecteurs de paiement dans l’interface utilisateur dans la [présentation des connecteurs source](../../../home.md).

## Sélectionner des données

Après avoir créé votre compte de paiements, l’étape **[!UICONTROL Sélectionner les données]** s’affiche, vous fournissant ainsi une interface interactive pour explorer votre hiérarchie de fichiers.

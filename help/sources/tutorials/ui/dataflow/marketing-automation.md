...
En outre, ce didacticiel nécessite que vous ayez déjà créé un compte d’automatisation marketing. Vous trouverez une liste de didacticiels pour la création de différents connecteurs d’automatisation marketing dans l’interface utilisateur dans la section [présentation des connecteurs source](../../../home.md).

...
Une fois vos données chargées, vous pouvez utiliser le côté droit de l’interface pour prévisualiser votre hiérarchie de fichiers. Sélectionnez **[!UICONTROL Suivant]** pour continuer.

...
Les connecteurs source d’Adobe Experience Platform permettent d’importer des données provenant de l’extérieur sur une base planifiée. Ce didacticiel décrit les étapes à suivre pour créer un connecteur source Salesforce Service Cloud (ci-après dénommé &quot;SSC&quot;) à l’aide de l’interface utilisateur de la plate-forme.
...
Pour accéder à votre compte SSC sur la plate-forme, vous devez fournir les valeurs suivantes :
...
Une fois que vous avez rassemblé les informations d’identification requises, vous pouvez suivre les étapes ci-dessous pour créer un nouveau compte SSC pour vous connecter à la plate-forme.
...
En suivant ce didacticiel, vous avez établi une connexion à votre compte SSC. Vous pouvez maintenant passer au didacticiel suivant et [configurer un flux de données pour importer les données de succès client dans la plate-forme](../../dataflow/customer-success.md).
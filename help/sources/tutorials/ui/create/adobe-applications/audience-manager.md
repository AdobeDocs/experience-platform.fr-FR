...
Sous [!UICONTROL Adobe Application], sélectionnez **[!UICONTROL Adobe Audience Manager]** puis **[!UICONTROL Set up]**.
...
L’étape [!UICONTROL Select traits and segments] s’affiche, vous fournissant une interface interactive pour explorer et sélectionner vos caractéristiques, segments et données.

* Le panneau de gauche de l’interface contient les options [!UICONTROL Select traits and segments], ainsi qu’un répertoire hiérarchique de tous les segments disponibles.
...
Pour parcourir les segments disponibles, sélectionnez le dossier auquel vous souhaitez accéder dans le panneau [!UICONTROL All Segments]. La sélection d’un dossier vous permet de parcourir la hiérarchie d’un dossier et vous fournit une liste de segments à filtrer.
...
L’étape [!UICONTROL Review] s’affiche, vous permettant de passer en revue les caractéristiques et les segments sélectionnés avant qu’ils ne soient connectés à Experience Platform. Les détails sont regroupés dans les catégories suivantes :

* **[!UICONTROL Connection]** : affiche la plateforme source et le statut de la connexion.
* **[!UICONTROL Selected data]** : affiche le nombre de segments sélectionnés et de caractéristiques activées.

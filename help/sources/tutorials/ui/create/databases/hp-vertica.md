...
Les connecteurs source dans Adobe Experience Platform permettent d’importer des données provenant de l’extérieur sur une base planifiée. Ce didacticiel décrit les étapes à suivre pour créer un connecteur source HP Vertica à l&#39;aide de l&#39;interface utilisateur de la plate-forme.
...
Une fois que vous avez rassemblé les informations d&#39;identification requises, vous pouvez suivre les étapes ci-dessous pour créer un nouveau compte HP Vertica afin de vous connecter à la plate-forme.
...
En suivant ce didacticiel, vous avez établi une connexion à votre compte HP Vertica. Vous pouvez maintenant passer au didacticiel suivant et [configurer un flux de données pour importer des données dans la plate-forme](../../dataflow/databases.md).
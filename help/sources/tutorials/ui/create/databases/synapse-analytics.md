...
En suivant ce didacticiel, vous avez établi une connexion de base à votre [!DNL Synapse] compte. Vous pouvez maintenant passer au didacticiel suivant et [configurer un flux de données pour importer des données dans la plate-forme](../../dataflow/databases.md).
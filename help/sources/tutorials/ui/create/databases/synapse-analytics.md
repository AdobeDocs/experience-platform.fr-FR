...
Ce tutoriel décrit les étapes à suivre pour créer une [!DNL Azure Synapse Analytics] (ci-après dénommés &quot;[!DNL Synapse]&quot;) le connecteur source à l’aide de [!DNL Platform] de l’interface utilisateur.
...
| ---------- | ----------- |
| `connectionString` | La chaîne de connexion associée à votre [!DNL Synapse] authentification. La variable [!DNL Synapse] le modèle de chaîne de connexion est `Server=tcp:{SERVER_NAME}.database.windows.net,1433;Database={DATABASE};User ID={USERNAME}@{SERVER_NAME};Password={PASSWORD};Trusted_Connection=False;Encrypt=True;Connection Timeout=30`. |
...
La variable **[!UICONTROL Connexion à Azure synapse Analytics]** s’affiche. Sur cette page, vous pouvez utiliser de nouvelles informations d’identification ou des informations d’identification existantes.

### Nouveau compte

Si vous utilisez de nouvelles informations d’identification, sélectionnez **[!UICONTROL Nouveau compte]**.  Dans le formulaire de saisie qui s’affiche, indiquez un nom, une description facultative et votre [!DNL Synapse] informations d’identification. Lorsque vous avez terminé, sélectionnez **[!UICONTROL Connexion]** puis accorder un certain temps pour établir la nouvelle connexion.

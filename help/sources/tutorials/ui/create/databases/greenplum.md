...
Sous la catégorie *[!UICONTROL Bases de données]* , sélectionnez **[!UICONTROL GreenPlum]** suivi de données **** Ajoutées pour créer un nouveau [!DNL GreenPlum] connecteur.
...
En suivant ce didacticiel, vous avez établi une connexion à votre [!DNL GreenPlum] compte. Vous pouvez maintenant passer au didacticiel suivant et [configurer un flux de données pour importer des données dans la plate-forme](../../dataflow/databases.md).
...
Pour accéder à votre compte Data Explorer sur Platform, vous devez fournir les valeurs suivantes :
...
Une fois que vous avez rassemblé les informations d’identification requises, vous pouvez suivre les étapes ci-dessous pour créer un nouveau compte Data Explorer pour vous connecter à Platform.
...
En suivant ce didacticiel, vous avez établi une connexion à votre compte Data Explorer. Vous pouvez maintenant passer au didacticiel suivant et [configurer un flux de données pour importer des données dans Platform](../../dataflow/databases.md).
...
Sous la catégorie *[!UICONTROL Bases de données]* , sélectionnez Data Explorer **** Azure suivi de données **[!UICONTROL d&#39;]** Ajoute pour créer un nouveau connecteur de Data Explorer.
...
En suivant ce didacticiel, vous avez établi une connexion à votre [!DNL Data Explorer] compte. Vous pouvez maintenant passer au didacticiel suivant et [configurer un flux de données pour importer des données dans la plate-forme](../../dataflow/databases.md).
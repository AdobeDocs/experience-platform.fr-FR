...
topic: overview
type: Tutorial
description: Ce didacticiel décrit les étapes à suivre pour créer un connecteur source Microsoft SQL Server (ci-après appelé "SQL Server") à l’aide de l’interface utilisateur de la plate-forme.
...
# Créer un connecteur source [!DNL Microsoft SQL Server] dans l’interface utilisateur

...
# Création d’un connecteur [!DNL Generic OData] source dans l’interface utilisateur
...
En suivant ce didacticiel, vous avez établi une connexion à votre [!DNL OData] compte. Vous pouvez maintenant passer au didacticiel suivant et [configurer un flux de jeux de données pour importer des données de protocoles dans Platform](../../dataflow/protocols.md).
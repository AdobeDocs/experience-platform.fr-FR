...
# Créez un [!DNL Merkury Enterprise Identity Resolution] connexion source et flux de données dans l’interface utilisateur
...
Ce tutoriel décrit les étapes à suivre pour créer une [!DNL Merkury Enterprise Identity Resolution] connexion source et flux de données à l’aide de l’interface utilisateur de Adobe Experience Platform.
...
| --- | --- |
| Clé d’accès | Identifiant de la clé d’accès pour votre compartiment. Vous pouvez récupérer cette valeur dans votre [!DNL Merkury] l&#39;équipe. |
| Clé secrète | Identifiant de clé secrète pour votre compartiment. Vous pouvez récupérer cette valeur dans votre [!DNL Merkury] l&#39;équipe. |
| Nom du compartiment | Il s’agit de votre compartiment Merkury où les fichiers seront partagés. Vous pouvez récupérer cette valeur dans votre [!DNL Merkury] l&#39;équipe. |

Pour plus d’informations sur la configuration de [!DNL Merkury] et d’autres conditions préalables, lisez la [[!DNL Merkury] présentation de la source](../../../../connectors/data-partners/merkury.md).
...
Sous , **[!UICONTROL Partenaires de données]** catégorie, sélectionnez **[!UICONTROL Merkury]** puis sélectionnez **[!UICONTROL Configuration]**.
...
La variable **[!UICONTROL Se connecter à Merkury]** s’affiche. Sur cette page, vous pouvez utiliser de nouvelles informations d’identification ou des informations d’identification existantes.

### Création d’un compte

Si vous utilisez de nouvelles informations d’identification, sélectionnez **[!UICONTROL Nouveau compte]**. Dans le formulaire de saisie qui s’affiche, indiquez un nom, une description facultative et votre [!DNL Merkury] informations d’identification. Lorsque vous avez terminé, sélectionnez **[!UICONTROL Connexion à la source]** puis accorder un certain temps pour établir la nouvelle connexion.
...
Pour utiliser un compte existant, sélectionnez **[!UICONTROL Compte existant]** puis sélectionnez l’option [!DNL Merkury] que vous souhaitez utiliser. Cliquez sur **[!UICONTROL Suivant]** pour continuer.
...
Vous pouvez ingérer les formats de fichier suivants avec le [!DNL Merkury] source :
...
Après avoir créé votre [!DNL Merkury] , le **[!UICONTROL Ajouter des données]** s’affiche, fournissant une interface pour explorer votre [!DNL Merkury] hiérarchie de fichiers et sélectionnez le dossier ou le fichier spécifique à importer dans Experience Platform.

* La partie gauche de l’interface est un navigateur d’annuaire qui affiche votre [!DNL Merkury] hiérarchie de fichiers.
...
Au cours de cette étape, vous pouvez effectuer plusieurs configurations sur vos données avant de continuer. Sélectionnez d’abord **[!UICONTROL Format des données]** puis sélectionnez le format de données approprié pour votre fichier dans le panneau déroulant qui s’affiche.
...
Après avoir configuré le format des données, vous pouvez définir un délimiteur de colonne lors de l’ingestion de fichiers délimités. Sélectionnez la variable **[!UICONTROL Délimiteur]** puis sélectionnez un délimiteur dans le menu déroulant. Le menu affiche les options de délimiteurs les plus fréquemment utilisées, y compris une virgule (`,`), un onglet (`\t`) et une barre verticale (`|`).
...
Sélectionnez ensuite le **[!UICONTROL Jeu de données de profil]** Activez votre jeu de données pour Real-time Customer Profile. Cela vous permet de créer une vue holistique des attributs et des comportements d’une entité. Les données de tous les jeux de données activés pour Profile seront incluses dans Profile et les modifications sont appliquées lorsque vous enregistrez votre flux de données.
...
En suivant ce tutoriel, vous avez créé un flux de données pour importer des données par lots de votre [!DNL Merkury] source à Experience Platform. Pour obtenir des ressources supplémentaires, consultez la documentation décrite ci-dessous.

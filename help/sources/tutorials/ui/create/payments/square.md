...
| Client secret | Le secret client associé à votre [!DNL Square] compte . |
...
En suivant ce tutoriel, vous avez authentifié et créé une connexion source entre vos [!DNL Square] compte et plateforme. Vous pouvez maintenant passer au tutoriel suivant et [créer un flux de données pour importer des données de paiements dans Platform ;](../../dataflow/payments.md).

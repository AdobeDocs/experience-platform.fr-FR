...
En suivant ce didacticiel, vous avez établi une connexion de base à votre [!DNL PayPal] compte. Vous pouvez maintenant passer au didacticiel suivant et [configurer un flux de données pour importer des données de gestion de la relation client dans la plate-forme](../../dataflow/payments.md).
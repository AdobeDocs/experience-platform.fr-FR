...
Pour diffuser des données à partir de [!DNL Kobie], sélectionnez la carte source **[!UICONTROL Kobie Streaming Events]** sous *[!UICONTROL Loyalty]*, puis sélectionnez **[!UICONTROL Add data]**.

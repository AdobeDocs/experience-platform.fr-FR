...
Pour diffuser des données à partir de [!DNL Kobie], sélectionnez la carte source **[!UICONTROL Événements de streaming mobiles]** sous *[!UICONTROL Fidélité]*, puis sélectionnez **[!UICONTROL Ajouter des données]**.
...
![Le catalogue de sources dans l’interface utilisateur avec la carte Événements de streaming Kobie sélectionnée.](../../../../images/tutorials/create/kobie/catalog.png)
...
![Étape de sélection des données du workflow des sources](../../../../images/tutorials/create/kobie/select-data.png)
...
![Interface des détails du flux de données](../../../../images/tutorials/create/kobie/dataflow-details.png)
...
![Étape de révision dans le workflow des sources.](../../../../images/tutorials/create/kobie/review.png)
...
![URL du point d’entrée de diffusion en continu.](../../../../images/tutorials/create/kobie/streaming-endpoint.png)

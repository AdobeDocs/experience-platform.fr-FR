...
Pour utiliser [!DNL Capillary], sélectionnez la carte source **[!UICONTROL Capillary Streaming Events]** sous *[!UICONTROL Loyalty]*, puis sélectionnez **[!UICONTROL Add data]**.

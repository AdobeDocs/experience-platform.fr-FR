---
title: Ingérer des données par lot de Kobie dans Experience Platform à l’aide de l’interface utilisateur
description: Découvrez comment ingérer des données par lot de Kobie dans Adobe Experience Platform à l’aide de l’interface utilisateur.
badge: Beta
hide: true
hidefromtoc: true
...
# Ingestion de données par lots de [!DNL Kobie] dans Experience Platform à l’aide de l’interface utilisateur

Lisez ce tutoriel pour savoir comment ingérer des données par lots de votre compte [!DNL Kobie] dans Adobe Experience Platform à l’aide de l’espace de travail des sources dans l’interface utilisateur.
...
Pour ingérer des données à partir de [!DNL Kobie], sélectionnez la carte source **[!UICONTROL Kobie Batch Source Connector]** sous *[!UICONTROL Loyalty]*, puis sélectionnez **[!UICONTROL Add data]**.
...
Pour créer un compte pour votre source de [!DNL Kobie], sélectionnez **[!UICONTROL New account]** et indiquez un nom et une description facultative pour votre compte. Indiquez ensuite votre domaine [!DNL Kobie] et votre [!UICONTROL Kobie Management API Key]. Lorsque vous avez terminé, sélectionnez **[!UICONTROL Connect to source]** et patientez quelques instants le temps d’établir la connexion.



### Utiliser un compte existant

Pour utiliser un compte existant, sélectionnez **[!UICONTROL Existing account]** et sélectionnez le compte [!DNL Kobie] à utiliser dans l’interface Comptes .
...
>[!IMPORTANT]
>
>Pour plus d’informations sur le mappage de vos données sources [!DNL Kobie], consultez la [présentation [!DNL Kobie]]

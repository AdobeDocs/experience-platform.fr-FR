...
Sous la catégorie *[!UICONTROL Bases de données]* , sélectionnez Enregistrement **[!UICONTROL de fichier]** Azure suivi de données **[!UICONTROL d&#39;]** Ajoute pour créer un nouveau connecteur d&#39;Enregistrement de fichier Azure.
...
En suivant ce didacticiel, vous avez établi une connexion à votre [!DNL Azure File Storage] compte. Vous pouvez maintenant passer au didacticiel suivant et [configurer un flux de données afin d’importer des données de votre enregistrement cloud dans la plate-forme](../../dataflow/batch/cloud-storage.md).
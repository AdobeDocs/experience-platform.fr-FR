...
# Création d’une connexion source [!DNL Azure File Storage] dans l’interface utilisateur

Les connecteurs source de Adobe Experience Platform permettent d’ingérer des données provenant de l’extérieur selon un calendrier précis. Ce tutoriel décrit les étapes d’authentification d’un connecteur source [!DNL Azure File Storage] à l’aide de l’interface utilisateur [!DNL Platform].
...
Dans la catégorie **[!UICONTROL Bases de données]**, sélectionnez **[!UICONTROL Stockage de fichier Azure]**. Si c’est la première fois que vous utilisez ce connecteur, sélectionnez **[!UICONTROL Configurer]**. Sinon, sélectionnez **[!UICONTROL Ajouter des données]** pour créer un nouveau connecteur [!DNL Azure File Storage].

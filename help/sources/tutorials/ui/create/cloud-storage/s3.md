...
# Création d’une connexion source [!DNL Amazon S3] dans l’interface utilisateur

Les connecteurs source de Adobe Experience Platform permettent d’ingérer des données provenant de l’extérieur selon un calendrier précis. Ce tutoriel décrit les étapes de création d’un connecteur source [!DNL Amazon S3] (ci-après appelé &quot;[!DNL S3]&quot;) à l’aide de l’interface utilisateur de Platform.
...
Dans la catégorie **[!UICONTROL Stockage dans le cloud]** , sélectionnez **[!UICONTROL Amazon S3]**, puis **[!UICONTROL Ajouter des données]**.
...
Si vous utilisez de nouvelles informations d’identification, sélectionnez **[!UICONTROL Nouveau compte]**. Dans le formulaire de saisie qui s’affiche, indiquez un nom, une description facultative et vos informations d’identification [!DNL S3]. Une fois que vous avez terminé, sélectionnez **[!UICONTROL Se connecter à la source]**, puis laissez un certain temps pour établir la nouvelle connexion.

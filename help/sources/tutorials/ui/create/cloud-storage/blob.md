...
Pour vous connecter à [!DNL Azure Blob Storage], accédez à la catégorie *[!UICONTROL Espace de stockage dans le cloud]*, sélectionnez la vignette source **[!UICONTROL Azure Blob Storage]**, puis sélectionnez **[!UICONTROL Configurer]**.

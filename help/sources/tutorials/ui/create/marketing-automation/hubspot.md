...
Les connecteurs source dans l’Adobe Experience Platform permettent d’importer des données provenant de l’extérieur sur une base planifiée. Ce didacticiel décrit les étapes à suivre pour créer un connecteur source HubSpot à l’aide de l’interface utilisateur de Platform.
...
Pour accéder à votre compte HubSpot sur Platform, vous devez fournir les valeurs suivantes :
...
Une fois que vous avez rassemblé les informations d’identification requises, vous pouvez suivre les étapes ci-dessous pour créer une nouvelle connexion de base entrante afin de lier votre compte HubSpot à Platform.
...
En suivant ce didacticiel, vous avez établi une connexion de base à votre compte HubSpot. Vous pouvez maintenant passer au didacticiel suivant et [configurer un flux de données pour importer les données du système d’automatisation marketing dans Platform](../../dataflow/marketing-automation.md).
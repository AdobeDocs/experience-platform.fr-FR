...
Sous la catégorie *[!UICONTROL Bases de données]* , sélectionnez **[!UICONTROL Salesforce]** , puis **[!UICONTROL Ajoutez les données]** pour créer un nouveau connecteur Salesforce.
...
En suivant ce didacticiel, vous avez établi une connexion à votre [!DNL Salesforce] compte. Vous pouvez maintenant passer au didacticiel suivant et [configurer un flux de données pour importer des données dans la plate-forme](../../dataflow/crm.md).
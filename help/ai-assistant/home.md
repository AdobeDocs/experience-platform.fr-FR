...
| Modèles De Données (Composition De L’Audience Fédérée) | <ul><li>Nombre de modèles de données</li><li>Recherche de nom</li><li>Modèle de données et relation de schéma</li><li>Propriétés du lien</li><li>État</li><li>Dates de création et de modification</li><li>Relation lien-modèle de données</li></ul> | |
...
| Bases De Données Fédérées (Composition D’Audiences Fédérées) | <ul><li>Nombre de bases de données</li><li>Nom de la base</li><li>Type de base</li><li>Dates de création/modification</li><li>État</li></ul> | |

...
* [Documentation du produit Assistant AI (hérité)](landing.md)
* [Présentation de l’assistant AI (hérité)](home.md)
* [Accès aux fonctionnalités](access.md)
* [Guide de questions pour l’assistant d’IA (hérité)](questions.md)
...
* [Clause de non-responsabilité](legal-disclaimer.md)
* Nouvelles fonctionnalités {#new-features}
   * [Fonctionnalités de l’assistant AI (héritées) dans Alpha et Beta](./new-features/alpha-beta.md)
   ...
   * {hide-from-toc}[découverte de champs XDM pour la création d’audiences](./new-features/xdm-field-discovery.md)
* Détails du modèle {#model-details}
   * {hide-from-toc}[Présentation des détails du modèle](./model-details/overview.md)

...
### Informations opérationnelles dans l’assistant d’IA

Regardez la vidéo suivante pour découvrir comment utiliser l’assistant AI pour récupérer vos informations opérationnelles et obtenir une vue d’ensemble complète de vos objets de données.

>[!VIDEO](https://video.tv.adobe.com/v/3444031?learn=on&enablevpops)

Pour plus d’informations, consultez la section [ Informations opérationnelles dans l’assistant AI ](home.md#operational-insights).
...
### Utiliser l’assistant AI pour valider les réponses

Regardez la vidéo suivante pour découvrir comment utiliser l’assistant AI pour vérifier et valider les réponses.

>[!VIDEO](https://video.tv.adobe.com/v/3441738/?learn=on)

Pour plus d’informations, consultez la documentation sur la [vérification des réponses de l’assistant AI](ui-guide.md#verify-operational-insights-responses).

### Utilisation de l’assistant AI pour l’analyse d’impact

Regardez la vidéo suivante pour découvrir comment utiliser l’assistant AI pour exécuter une analyse d’impact plus efficace avant que des modifications ne soient apportées à vos objets de données.

>[!VIDEO](https://video.tv.adobe.com/v/3441680/?learn=on)

### Utilisation de l’assistant AI pour le service clientèle

Regardez la vidéo suivante pour découvrir comment utiliser l’assistant AI pour le service clientèle afin de résoudre en toute simplicité les problèmes sans quitter vos workflows.

>[!VIDEO](https://video.tv.adobe.com/v/3443183?learn=on)

Pour plus d’informations, consultez la documentation sur l’[utilisation de l’assistant AI pour le service clientèle](./new-features/customer-support.md).

...
>[!NOTE] Ce jeu de données sera activé pour le Profil **client et** l&#39;identité **en temps** réel en définissant les balises appropriées.
...
Une fois le jeu de données et la connexion en flux continu en place, vous pouvez ingérer des enregistrements JSON au format XDM pour assimiler des données de séries chronologiques dans la plate-forme.
...
>[!NOTE] Vous devrez générer vos propres `xdmEntity._id` et `xdmEntity.timestamp`. Un bon moyen de générer un identifiant est d’utiliser un UUID. De plus, l&#39;appel d&#39;API suivant **ne nécessite aucun** en-tête d&#39;authentification.

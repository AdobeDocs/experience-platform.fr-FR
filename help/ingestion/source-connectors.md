...
description: Les connexions Source vous permettent d’authentifier vos systèmes de stockage et services CRM, de définir des heures d’ingestion et de gérer le débit d’ingestion des données.

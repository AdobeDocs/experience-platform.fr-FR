...
Basée sur Adobe Experience Platform, la plateforme de données client (CDP) en temps réel Adobe aide les entreprises à rassembler des données connues et inconnues pour activer les profils des clients avec une prise de décision intelligente tout au long du parcours client. La plateforme CDP en temps réel associe plusieurs sources de données d’entreprise pour créer des profils unifiés en temps réel qui peuvent être utilisés pour offrir des expériences client personnalisées et individuelles sur tous les canaux et périphériques.
...
Les rubriques de documentation suivantes sont recommandées lorsque vous commencez à travailler avec la plateforme de données client en temps réel Adobe :

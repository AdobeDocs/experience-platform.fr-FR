...
<table style="table-layout:fixed">
  <tr style="border: 0;">
    ...
    <div><strong>Prise en main</strong><br/>Obtenez un aperçu de Real-Time CDP pour découvrir comment ingérer, gérer et activer des données à grande échelle avec Real-Time CDP.</div>
    </td>
    <td>
    <a href="/help/rtcdp/overview.md#rtcdp-editions"><img src="assets/do-not-localize/start-campaign.jpeg"></a>
    <div><strong>Quelle édition Real-Time CDP convient à ma société</strong><br/>Comprenez les différences entre les différentes éditions de Real-Time CDP et déterminez celle qui convient le mieux à votre entreprise.</div>
    </td>
    <td>
    <a href="/help/landing/ui-guide.md"><img src="assets/do-not-localize/start-interface.jpeg"></a>
    <div><strong>Interface utilisateur</strong><br/>Découvrez les éléments de la page d’accueil de l’interface utilisateur de Real-Time CDP, comment naviguer et optimiser votre expérience intégrée au produit.</div>
    </td>
    <td>
    <a href="/help/landing/end-to-end-tutorial.md"><img src="assets/do-not-localize/start-journey.jpeg"></a>
    <div><strong>Exploration d’un workflow de bout en bout</strong><br/>Comprendre le flux de données allant de l’ingestion, en enrichissant les profils et en créant des audiences, à l’activation.
    </div>
    </td>
    <td>
    <a href="/help/rtcdp/use-case-guides/overview.md"><img src="assets/do-not-localize/start-use-cases.jpeg"></a>
    <div><strong>Exemples de cas d’utilisation Real-Time CDP</strong><br/>Découvrez les nombreuses façons dont Real-Time CDP peut aider votre entreprise à acquérir de nouveaux clients, à enrichir vos profils connus, etc.
    </div>
    </td>
  </tr>
  <tr style="border: 0;">
...
<tr>
  <td>
    ...
    <p>
    <em>Déterminer où Real-Time CDP se situe dans le Adobe Experience Cloud plus vaste</em>
    <p>
  </td>
  <td>
    ...
    <p>
    <em>Découvrez l’architecture de haut niveau de Adobe Experience Platform à partir d’une présentation guidée d’un diagramme de présentation</em>
    <p>
  </td>
  <td>
    ...
    <p>
    <em>Découvrez comment parcourir l’interface utilisateur de Real-Time CDP</em>
    <p>
  </td>
  </tr>
  </table>

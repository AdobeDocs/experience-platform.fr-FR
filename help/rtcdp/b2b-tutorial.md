...
source-git-commit: 46dae5d08c9eac0a94de0a19edbc09b71d7fbf86
workflow-type: tm+mt
...
>[!IMPORTANT]
>
>Après l’ingestion des données B2B, vous **devez** activer la segmentation par lots (segmentation planifiée) et créer au moins une audience de compte (audience relationnelle) pour activer la visibilité et la navigation des données B2B. Si ces étapes ne sont pas effectuées, aucune donnée de compte ou d’opportunité n’apparaîtra dans l’interface utilisateur.

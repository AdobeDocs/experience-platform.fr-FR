...
| Mécanisme de sécurisation | Limite | Type de limite | Description |
| --------- | ----- | ---------- | ----------- |
| Aucune relation héritée imbriquée | 0 | Protecteur des performances | Vous ne devez pas créer de relation entre deux schémas non-[!DNL XDM Individual Profile]. La création de relations est **not** recommandé pour les schémas qui ne font pas partie du schéma d’union [!DNL Profile]. |

...
* [Présentation de Real-Time CDP B2B Edition](b2b-overview.md)
* Prise en main {#intro}
...
* Destinations {#destinations}
   ...
   * [Destinations dans Real-Time CDP version B2B](destinations/b2b.md)
* Identités {#identity}
...
* Schémas {#schemas}
   ...
   * [Schémas dans Real-Time CDP version B2B](schemas/b2b.md)
* Segments {#segmentation}
   ...
   * [Segmentation dans Real-Time CDP B2B Edition](segmentation/b2b.md)
   * [IA dédiée aux clients](segmentation/customer-ai.md)
* Sources {#sources}
   * [Présentation des sources](sources/sources-overview.md)
   * [Sources dans Real-Time CDP version B2B](sources/b2b.md)

...
>[!IMPORTANT]
>
>Les profils de compte nécessitent une évaluation de segmentation par lots quotidienne activée pour afficher les données. Assurez-vous que la segmentation par lots est configurée et planifiée afin de conserver des informations de profil de compte précises. Pour plus d’informations, consultez le [guide de segmentation par lots](../../segmentation/methods/batch-segmentation.md).

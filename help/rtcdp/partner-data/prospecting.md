---
title: Interagissez et achetez de nouveaux clients sans dépendre de cookies tiers
...
# Interagissez et achetez de nouveaux clients sans dépendre de cookies tiers
...
Les marques sont simultanément confrontées à d’énormes défis liés à l’exécution responsable de cas d’utilisation d’acquisition de clients haut de gamme sans dépendre de cookies tiers, de budgets limités et d’une demande accrue de transparence et de retour sur dépenses publicitaires.
...
Par exemple, suivez les étapes décrites dans ce cas d’utilisation lorsque vous devez exécuter une campagne pour attirer des prospects désireux de devenir des utilisateurs ou des clients connus.
...
Regardez le tutoriel vidéo ci-dessous pour découvrir comment atteindre et impliquer les audiences de prospects :
...
* [Audiences de prospects](/help/segmentation/types/prospect-audiences.md)
...
* Un nouveau type d’identité **[!UICONTROL ID de partenaire]** pour les profils fournis par le partenaire
* Une nouvelle classe XDM **[!UICONTROL Profil de prospect individuel XDM]**
...
Commencez par créer un type d’identité pour les profils que vous recevrez du partenaire. Pour ce faire, dans la section Identité , vous devez créer un espace de noms d’identité de type **[!UICONTROL Identifiant du partenaire]**.
...
* Pour en savoir plus sur les espaces de noms Partner ID, consultez la [section consacrée aux types d’identité](/help/identity-service/features/namespaces.md).
...
#### Créez un schéma avec la classe **[!UICONTROL XDM Individual Prospect Profile]**

Ensuite, dans **[!UICONTROL Gestion des données]** > **[!UICONTROL Schémas]**, créez un schéma et attribuez-lui la classe **[!UICONTROL Profil de prospect individuel XDM]**.
...
3. Sélectionnez le libellé **[!UICONTROL Écosystème partenaire]** dans les catégories sur la gauche.
4. Sélectionnez le libellé appelé **[!UICONTROL Tiers]** et sélectionnez **[!UICONTROL Enregistrer]**.
...
Pour charger un fichier que vous avez reçu du partenaire dans le jeu de données, sélectionnez le jeu de données, faites défiler l’écran vers le bas dans le rail de droite, puis sélectionnez **[!UICONTROL Ajouter des données]**. Vous pouvez faire glisser et déposer votre fichier ou sélectionner **[!UICONTROL Choisir les fichiers]** pour accéder à l’emplacement du fichier et le sélectionner.
...
Notez que l’affichage des profils de prospects que vous venez de charger dans Real-Time CDP dans la vue **[!UICONTROL Parcourir]** de l’écran Profil du prospect peut prendre jusqu’à deux heures. Si la page affiche le message « Il n’y a pas de profil de prospect à parcourir pour le moment. », veuillez réessayer après un certain temps. Après une période d’attente, les profils des prospects doivent commencer à s’afficher dans la vue **[!UICONTROL Parcourir]**.
...
En savoir plus sur les [profils de prospects](/help/profile/ui/prospect-profile.md).
...
Pour commencer à créer des audiences composées de profils de prospects, accédez à **[!UICONTROL Prospects]** > **[!UICONTROL Audiences]**.
...
En savoir plus sur les [audiences de prospects](/help/segmentation/types/prospect-audiences.md).
...
[En savoir plus](/help/destinations/ui/activate-prospect-audiences.md) sur l’activation des prospects vers des destinations d’espace de stockage.

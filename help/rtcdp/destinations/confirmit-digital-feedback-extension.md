---
title: Confirmation de l’extension Commentaires numériques
seo-title: Confirmation de l’extension Commentaires numériques
description: L’extension Confirmer les commentaires numériques est une voix du client de destination dans la plateforme de données clientes Adobe en temps réel. Pour plus d’informations sur la fonctionnalité d’extension, voir la page de l’extension dans Adobe Exchange.
...
# Confirmation de l’extension de commentaires numériques

## Aperçu {#overview}

La solution de confirmation des commentaires numériques vous aide à transformer le trafic de votre site Web en informations en temps réel. Grâce à la fonction Confirmation, des  non intrusives et très ciblées peuvent être affichées en fonction de vos besoins, ce qui encourage les à fournir des commentaires, tels que :

* Commentaires sur le site Web
* Satisfaction des transactions
* Motif du mode de sortie
* Informations sur l&#39;abandon du panier
* Satisfaction globale des clients
* Et bien plus

Confirmer les commentaires numériques est une voix de l’extension du client dans la plateforme de données clientes Adobe en temps réel. Pour plus d’informations sur la fonctionnalité d’extension, voir la page d’extension d’ [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.103247.confirmit-digital-feedback-for-adobe-launch.html).
...
Pour installer l’extension Confirmer les commentaires numériques :
...
Pour plus d’informations sur les options de configuration de l’extension et la prise en charge de l’installation, voir la page [Confirmer les commentaires numériques sur Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.103247.confirmit-digital-feedback-for-adobe-launch.html).

...
seo-title: Extension DialogTech
description: L’extension DialogTech est une destination d’analyse dans la plateforme de données clientes en temps réel d’Adobe. Pour plus d’informations sur la fonctionnalité d’extension, voir la page de l’extension dans Adobe Exchange.
seo-description: L’extension DialogTech est une destination d’analyse dans la plateforme de données clientes en temps réel d’Adobe. Pour plus d’informations sur la fonctionnalité d’extension, voir la page de l’extension dans Adobe Exchange.
...
# Extension DialogTech {#dialogtech-extension}

## Aperçu {#overview}

Inclure le fragment de code javascript DialogTech SourceTrak dans Adobe Launch

DialogTech est une extension d’analyse de la plateforme de données clientes en temps réel d’Adobe. Pour plus d&#39;informations sur la fonctionnalité d&#39;extension, consultez le site Web [](https://www.dialogtech.com/)Dialogtech.
...
![Extension DialogTech](assets/dialogtech-extension.png)
...
Pour installer l’extension DialogTech :

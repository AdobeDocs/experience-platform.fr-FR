...
3. Dans l’étape **[!UICONTROL Configuration]** , saisissez un **[!UICONTROL Nom]** et une **[!UICONTROL Destination]** pour votre flux de  et insérez le chemin d’accès **[!UICONTROL Dossier dans votre destination de de cloud où les fichiers seront distribués.]** Sélectionnez **[!UICONTROL Créer une destination]** après avoir rempli les champs ci-dessus.

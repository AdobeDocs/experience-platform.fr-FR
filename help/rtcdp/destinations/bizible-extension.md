---
title: Extension visible
seo-title: Extension visible
description: L’extension Bizible est une destination de courrier électronique dans la plate-forme de données client en temps réel d’Adobe. Pour plus d’informations sur la fonctionnalité d’extension, voir la page d’extension dans Adobe Exchange.
seo-description: L’extension Bizible est une destination de courrier électronique dans la plate-forme de données client en temps réel d’Adobe. Pour plus d’informations sur la fonctionnalité d’extension, voir la page d’extension dans Adobe Exchange.
...
# Extension visible {#bizible-extension}

## Aperçu {#overview}

Bizible est la solution d&#39;attribution B2B de pointe qui vous offre une visibilité inégalée sur vos données, afin que vous puissiez prendre des décisions intelligentes qui stimulent la croissance.

Bizible est une extension de courrier électronique dans la plate-forme de données client en temps réel d’Adobe. Pour plus d’informations sur la fonctionnalité d’extension, voir la page d’extension d’ [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.101055.bizible-analytics.html).
...
![Extension visible](assets/bizible-extension.png)
...
Pour installer l&#39;extension Bizible :
...
Pour plus d’informations sur les options de configuration de l’extension et la prise en charge de l’installation, voir la page [visible dans Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.101055.bizible-analytics.html).

---
title: Extension de balise de site Web Twitter Universal
seo-title: Extension de balise de site Web Twitter Universal
description: L’extension de balise de site Web Twitter Universal est une destination publicitaire dans la plate-forme de données client en temps réel d’Adobe. Pour plus d’informations sur la fonctionnalité d’extension, voir la page d’extension dans Adobe Exchange.
seo-description: L’extension de balise de site Web Twitter Universal est une destination publicitaire dans la plate-forme de données client en temps réel d’Adobe. Pour plus d’informations sur la fonctionnalité d’extension, voir la page d’extension dans Adobe Exchange.
...
# Extension de balise de site Web Twitter Universal {#twitter-uwt-extension}

## Aperçu {#overview}

La balise de site Web Twitter Universal fournit des actions pour envoyer des balises à la balise Twitter UWT.

La balise de site Web Twitter Universal est une extension de publicité dans la plateforme de données client en temps réel d’Adobe. Pour plus d’informations sur la fonctionnalité d’extension, voir Suivi [](https://business.twitter.com/en/solutions/twitter-ads/website-clicks/advanced-conversion-tracking.html)avancé des conversions.
...
![Extension de balise de site Web Twitter Universal](assets/twitter-uwt-extension.png)
...
Pour installer l’extension de balise de site Web Twitter Universal, procédez comme suit :

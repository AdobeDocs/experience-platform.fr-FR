---
title: Extension de la balise de conversion d’Awin Advertiser
seo-title: Extension de la balise de conversion d’Awin Advertiser
description: L’extension de balise de conversion Awin Advertiser est une destination publicitaire dans la plate-forme de données client en temps réel d’Adobe. Pour plus d’informations sur la fonctionnalité d’extension, voir la page d’extension dans Adobe Exchange.
...
# Extension de la balise de conversion d’Awin Advertiser {#awin-conversiontag-extension}

---
title: Extension de la balise de conversion Awin Advertiser
seo-title: Extension de la balise de conversion Awin Advertiser
description: L’extension de balise de conversion Awin Advertiser est une destination publicitaire dans la plateforme de données clientes Adobe en temps réel. Pour plus d’informations sur la fonctionnalité d’extension, voir la page de l’extension dans Adobe Exchange.
...
# Extension de la balise de conversion Awin Advertiser {#awin-conversiontag-extension}

## Aperçu {#overview}

La balise de conversion est la déclaration de l’objet JavaScript AWIN.Tracking.Sale, qui est effectuée sur la page de confirmation pour indiquer au marqueur qu’une conversion a eu lieu. Il effectuera ensuite les demandes de suivi nécessaires.

La balise de conversion Awin Advertiser est une extension publicitaire dans la plateforme de données clientes Adobe en temps réel. Pour plus d’informations sur la fonctionnalité d’extension, voir la page d’extension d’ [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.103240.awin-conversion-tag.html).
...
![Extension Awin Advertiser Conversiontag dans l’interface utilisateur](/help/rtcdp/destinations/assets/awin-conversiontag-extension.png)
...
Pour installer l’extension de balise de conversion Awin Advertiser :
...
Pour plus d’informations sur les options de configuration de l’extension et la prise en charge de l’installation, voir la page Balise de conversion [Awin Advertiser sur Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.103240.awin-conversion-tag.html).

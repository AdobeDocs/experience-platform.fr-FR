---
title: Gestionnaire Gestionnaire de code DIL extension
seo-title: Gestionnaire Gestionnaire de code DIL extension
description: L’extension DIL  Gestionnaire de  de est une destination DMP (Platform) dans la plateforme de données clientes Adobe en temps réel. Pour plus d’informations sur la fonctionnalité d’extension, voir la page de l’extension dans Adobe Exchange.
seo-description: L’extension DIL  Gestionnaire de  de est une destination DMP (Platform) dans la plateforme de données clientes Adobe en temps réel. Pour plus d’informations sur la fonctionnalité d’extension, voir la page de l’extension dans Adobe Exchange.
...
# Gestionnaire Gestionnaire de code DIL extension {#aam-dil-extension}

## Aperçu {#overview}

Il s’agit de l’extension de la bibliothèque d’intégration des données d’Adobe  Manager (implémentation côté client). Remarque : Cette extension n’est pas destinée à être utilisée pour le transfert côté serveur (SSF) des données Adobe Analytics. Pour SSF, utilisez l’extension Adobe Analytics. Important : À partir de la version 8.0, le code DIL dépend fortement du service d’ID d’Experience Cloud, version 3.3 ou ultérieure. Mettez en oeuvre le service d’ID d’expérience Cloud et le code DIL pour des fonctionnalités complètes d’intégration des données de  Manager .

 Gestionnaire de  de est une extension DMP (Platform) de la plate-forme de données clientes Adobe en temps réel. Pour plus d’informations sur la fonctionnalité de l’extension, voir la page [d’extension  Manager](https://docs.adobe.com/content/help/en/launch/using/extensions-ref/adobe-extension/adobe-audience-manager-extension.html) dans la documentation relative au lancement de la plateforme d’expérience.
...
![Gestionnaire Gestionnaire de code DIL extension](/help/rtcdp/destinations/assets/aam-dil-extension.png)
...
Pour installer l’extension DIL  Gestionnaire de  :
...
Pour plus d’informations sur les options de configuration de l’extension, reportez-vous à la page [d’extension  Manager](https://docs.adobe.com/content/help/en/launch/using/extensions-ref/adobe-extension/adobe-audience-manager-extension.html) dans la documentation sur le lancement d’expérience.

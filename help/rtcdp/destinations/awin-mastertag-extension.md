---
title: Extension du mastertag publicitaire Awin
seo-title: Extension du mastertag publicitaire Awin
description: L’extension Mastertag Awin Advertiser est une destination publicitaire dans la plateforme de données clientes Adobe en temps réel. Pour plus d’informations sur la fonctionnalité d’extension, voir la page de l’extension dans Adobe Exchange.
...
# Extension du mastertag publicitaire Awin {#awin-mastertag-extension}

## Aperçu {#overview}

MasterTag est une bibliothèque JavaScript qui contient toutes les fonctions requises pour la solution de suivi Awin et doit être annexée inconditionnellement à chaque page du site, y compris la page de confirmation, mais à l’exclusion de toute page qui affiche ou traite des informations de paiement.

Awin Advertiser Mastertag est une extension publicitaire dans la plateforme de données clientes en temps réel d’Adobe. Pour plus d’informations sur la fonctionnalité d’extension, voir la page d’extension d’ [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.103176.awin-advertiser-mastertag.html).

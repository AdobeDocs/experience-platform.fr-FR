...
description: L’extension Google Universal Analytics est une destination d’analyse dans la plate-forme de données client en temps réel d’Adobe. Pour plus d’informations sur la fonctionnalité d’extension, voir la page d’extension dans Adobe Exchange.
seo-description: L’extension Google Universal Analytics est une destination d’analyse dans la plate-forme de données client en temps réel d’Adobe. Pour plus d’informations sur la fonctionnalité d’extension, voir la page d’extension dans Adobe Exchange.
...
Google Universal Analytics vous permet de mesurer le RSI de vos publicités, ainsi que d’effectuer un suivi sur vos sites et applications de réseaux sociaux, vidéo et Flash.

Google Universal Analytics est une extension d’analyse de la plate-forme de données client en temps réel d’Adobe. Pour plus d’informations sur la fonctionnalité d’extension, voir la page d’extension d’ [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.102829.google-universal-analytics.html).
...
Pour plus d’informations sur les options de configuration de l’extension, voir la page [de l’extension](https://exchange.adobe.com/experiencecloud.details.102829.google-universal-analytics.html) Google Universal Analytics dans Adobe Exchange.

---
title: Extension BSDK Nielsen
seo-title: Extension BSDK Nielsen
description: L’extension BSDK Nielsen est une destination d’analyse dans la plateforme de données clientes Adobe en temps réel. Pour plus d’informations sur la fonctionnalité d’extension, voir la page de l’extension dans Adobe Exchange.
seo-description: L’extension BSDK Nielsen est une destination d’analyse dans la plateforme de données clientes Adobe en temps réel. Pour plus d’informations sur la fonctionnalité d’extension, voir la page de l’extension dans Adobe Exchange.
...
# Extension BSDK Nielsen {#nielsen-bsdk-extension}

## Aperçu {#overview}

Nielsen Digital SDK launch extension   mesure des  par le biais des produits de mesure numérique suivants :

DCR : Une solution de mesure qui fournit une mesure quotidienne du contenu numérique non linéaire, y compris le contenu avec publicités, permettra un complet de contenu numérique  la consommation de  sur Bureau, Mobile, Tablette et Périphériques connectés.

DTVR : Cela tient compte de l’affichage linéaire de la télévision survenant sur les ordinateurs de bureau et les périphériques mobiles pour les sources de programmation participantes. Il s’agit de la première solution à recevoir l’accréditation du MRC pour sa contribution à la mesure des  de  de télévision pour la programmation visionnée sur des ordinateurs et des appareils mobiles.

Nielsen BSDK est une extension d’analyse de la plateforme de données clientes Adobe en temps réel. Pour plus d’informations sur la fonctionnalité d’extension, voir la page d’extension d’ [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.101361.html).
...
![Extension BSDK Nielsen](assets/nielsen-bsdk-extension.png)
...
Pour installer l’extension BSDK Nielsen :
...
Pour plus d’informations sur les options de configuration de l’extension et la prise en charge de l’installation, voir la page BSDK [Nielsen sur Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.101361.html).

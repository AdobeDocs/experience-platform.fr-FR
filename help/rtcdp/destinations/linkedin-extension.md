---
title: Extension de balise LinkedIn Insight
seo-title: Extension de balise LinkedIn Insight
description: L’extension de balise LinkedIn Insight est une destination publicitaire dans la plateforme de données clientes Adobe en temps réel. Pour plus d’informations sur la fonctionnalité d’extension, voir la page de l’extension dans Adobe Exchange.
seo-description: L’extension de balise LinkedIn Insight est une destination publicitaire dans la plateforme de données clientes Adobe en temps réel. Pour plus d’informations sur la fonctionnalité d’extension, voir la page de l’extension dans Adobe Exchange.
...
# Extension de balise LinkedIn Insight {#linkedin-insights-extension}

## Aperçu {#overview}

Installez la balise LinkedIn Insight pour utiliser les fonctionnalités de suivi de conversion, de reciblage et de démographie du site Web.

La balise LinkedIn Insight est une extension publicitaire dans la plateforme de données clientes Adobe en temps réel. Pour plus d’informations sur la fonctionnalité d’extension, voir Balise [LinkedIn Insight](https://business.linkedin.com/marketing-solutions/insight-tag).
...
![Extension de balise LinkedIn Insight](assets/linkedin-extension.png)
...
Pour installer l’extension de balise LinkedIn Insight :
...
Pour plus d’informations sur les options de configuration de l’extension et la prise en charge de l’installation, voir Balise [LinkedIn Insight](https://business.linkedin.com/marketing-solutions/insight-tag).

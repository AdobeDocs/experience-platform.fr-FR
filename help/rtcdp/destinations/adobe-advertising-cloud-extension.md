...
description: L’extension Adobe Advertising Cloud est une destination publicitaire dans la plate-forme de données clientes en temps réel d’Adobe. Pour plus d’informations sur la fonctionnalité d’extension, voir la page d’extension dans Adobe Exchange.
...
Il s’agit de l’extension Advertising Cloud permettant d’implémenter les balises de conversion et de segment Advertising Cloud pour le fournisseur de services de données et la recherche (DCO n’est pas actuellement pris en charge).

Adobe Advertising Cloud est une extension publicitaire de la plateforme de données clientes en temps réel d’Adobe.

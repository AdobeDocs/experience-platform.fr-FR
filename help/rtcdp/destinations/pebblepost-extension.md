...
description: L’extension PebblePost est une destination de courrier électronique dans la plateforme de données clientes en temps réel d’Adobe. Pour plus d’informations sur la fonctionnalité d’extension, voir la page d’extension dans Adobe Exchange.
seo-description: L’extension PebblePost est une destination de courrier électronique dans la plateforme de données clientes en temps réel d’Adobe. Pour plus d’informations sur la fonctionnalité d’extension, voir la page d’extension dans Adobe Exchange.
...
# Extension PebblePost {#pebblepost-extension}

## Aperçu {#overview}

La solution Programmatic Courrier® de PebblePost aide les spécialistes du marketing numérique à connecter l&#39;intérêt et l&#39;intention en ligne à des supports tangibles hors ligne qui convertissent. Les spécialistes du marketing peuvent exploiter les segments de données personnalisés qu’ils ont créés dans Adobe pour cible désormais les consommateurs avec une impression multimédia pertinente, plus durable et à domicile. Analyser les performances en temps réel en fonction de l’activité des chemins de réponse et des conversions sur site.

PebblePost est une extension de courrier électronique dans la plate-forme de données client en temps réel d’Adobe. Pour plus d’informations sur la fonctionnalité d’extension, voir la page d’extension d’ [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.100315.programmatic-direct-mail.html).
...
Pour installer l’extension PebblePost :
...
Pour plus d’informations sur les options de configuration de l’extension et la prise en charge de l’installation, voir la page [PebblePost dans Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.100315.programmatic-direct-mail.html).

---
title: Extension de pixels Facebook
seo-title: Extension de pixels Facebook
description: L’extension Pixel Facebook est une destination publicitaire dans la plateforme de données clientes en temps réel d’Adobe. Pour plus d’informations sur la fonctionnalité d’extension, voir la page d’extension dans Adobe Exchange.
...
# Extension de pixels Facebook {#facebook-pixel-extension}

## Aperçu {#overview}

Le pixel Facebook est un outil d’analyse qui vous permet de mesurer l’efficacité de votre publicité en comprenant les actions que les visiteurs font sur votre site Web.

Facebook Pixel est une extension de publicité dans la plate-forme de données client en temps réel d’Adobe. Pour plus d’informations sur la fonctionnalité d’extension, voir le site Web [Pixel de](https://developers.facebook.com/docs/facebook-pixel/)Facebook.
...
![Extension de pixels Facebook](assets/facebook-pixel-extension.png)
...
Pour installer l’extension Facebook Pixel :

...
description: L’extension Pixel Facebook est une destination publicitaire dans la plateforme de données clientes en temps réel d’Adobe. Pour plus d’informations sur la fonctionnalité d’extension, voir la page de l’extension dans Adobe Exchange.
...
# Extension Pixel Facebook {#facebook-pixel-extension}
...
Facebook Pixel est une extension de publicité dans la plateforme de données clientes en temps réel d’Adobe. Pour plus d’informations sur la fonctionnalité d’extension, voir le site Web [Pixel de](https://developers.facebook.com/docs/facebook-pixel/)Facebook.
...
Pour installer l’extension Pixel Facebook :

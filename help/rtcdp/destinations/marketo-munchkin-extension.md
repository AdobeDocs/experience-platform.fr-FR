...
description: L’extension Marketo Munchkin est une destination de personnalisation dans la plateforme de données clientes Adobe en temps réel. Pour plus d’informations sur la fonctionnalité d’extension, voir la page de l’extension dans Adobe Exchange.
seo-description: L’extension Marketo Munchkin est une destination de personnalisation dans la plateforme de données clientes Adobe en temps réel. Pour plus d’informations sur la fonctionnalité d’extension, voir la page de l’extension dans Adobe Exchange.
...
De la gestion des prospects au marketing basé sur les comptes, la plate-forme d’engagement marketing simplifie la planification, l’orchestration et la mesure de l’engagement avec les clients et les  à chaque étape de leur expérience.

Le code JavaScript Munchkin de Marketo permet d’effectuer le suivi des visites et des clics des utilisateurs finaux sur vos  Marketo et vos pages Web externes.

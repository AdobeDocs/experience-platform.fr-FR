...
description: L’extension Gainsight est une destination de personnalisation dans la plate-forme de données client en temps réel d’Adobe. Pour plus d’informations sur la fonctionnalité d’extension, voir la page d’extension dans Adobe Exchange.
seo-description: L’extension Gainsight est une destination de personnalisation dans la plate-forme de données client en temps réel d’Adobe. Pour plus d’informations sur la fonctionnalité d’extension, voir la page d’extension dans Adobe Exchange.
...
Gainsight permet aux propriétaires de produits de comprendre en profondeur le comportement des utilisateurs, de stimuler l’adoption des produits et de recueillir les commentaires des utilisateurs.

Gainsight est une extension de personnalisation de la plateforme de données clientes en temps réel d’Adobe. Pour plus d’informations sur la fonctionnalité d’extension, voir la page d’extension d’ [Adobe Exchange](https://www.adobeexchange.com/experiencecloud.details.103343.html).
...
Pour plus d&#39;informations sur les options de configuration de l&#39;extension et la prise en charge de l&#39;installation, consultez la page [Gainsight dans Adobe Exchange](https://www.adobeexchange.com/experiencecloud.details.103343.html).

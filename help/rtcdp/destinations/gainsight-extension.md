...
description: L’extension Gainsight est une destination de personnalisation dans la plateforme de données clientes en temps réel d’Adobe. Pour plus d’informations sur la fonctionnalité d’extension, voir la page de l’extension dans Adobe Exchange.
seo-description: L’extension Gainsight est une destination de personnalisation dans la plateforme de données clientes en temps réel d’Adobe. Pour plus d’informations sur la fonctionnalité d’extension, voir la page de l’extension dans Adobe Exchange.
...
# Extension Gainsight {#gainsight-extension}

## Aperçu {#overview}

Gainsight donne aux propriétaires de produits les outils nécessaires pour mieux comprendre le comportement des utilisateurs, favoriser l’adoption des produits et recueillir les commentaires des utilisateurs.

Gainsight est une extension de personnalisation dans la plateforme de données clientes en temps réel d’Adobe. Pour plus d’informations sur la fonctionnalité d’extension, voir la page d’extension d’ [Adobe Exchange](https://www.adobeexchange.com/experiencecloud.details.103343.html).
...
Pour installer l’extension Gainsight :
...
Pour plus d’informations sur les options de configuration de l’extension et la prise en charge de l’installation, consultez la page [Gainsight sur Adobe Exchange](https://www.adobeexchange.com/experiencecloud.details.103343.html).

...
description: L’extension Google Global Site Tag est une destination d’analyse dans la plateforme de données clientes en temps réel d’Adobe. Pour plus d’informations sur la fonctionnalité d’extension, voir la page de l’extension dans Adobe Exchange.
seo-description: L’extension Google Global Site Tag est une destination d’analyse dans la plateforme de données clientes en temps réel d’Adobe. Pour plus d’informations sur la fonctionnalité d’extension, voir la page de l’extension dans Adobe Exchange.
...
Envoyez des données à Google Analytics, à Google Ads et à Google Marketing Platform par l’intermédiaire de Google Global Site Tag ou de gtag.js. Plusieurs comptes par produit peuvent être configurés.

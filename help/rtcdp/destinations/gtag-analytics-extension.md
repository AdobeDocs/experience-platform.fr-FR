...
description: L’extension Google Global Site Tag est une destination d’analyse dans la plate-forme de données client en temps réel d’Adobe. Pour plus d’informations sur la fonctionnalité d’extension, voir la page d’extension dans Adobe Exchange.
seo-description: L’extension Google Global Site Tag est une destination d’analyse dans la plate-forme de données client en temps réel d’Adobe. Pour plus d’informations sur la fonctionnalité d’extension, voir la page d’extension dans Adobe Exchange.
...
# Extension de balise de site Google Global {#gtag-analytics-extension}

## Aperçu {#overview}

Envoyez des données à Google Analytics, à Google Ads et à la plateforme Google Marketing via la balise de site globale de Google ou gtag.js. Plusieurs comptes par produit peuvent être configurés.

Google Global Site Tag est une extension d’analyse de la plateforme de données clientes en temps réel d’Adobe. Pour plus d’informations sur la fonctionnalité d’extension, voir la page d’extension d’ [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.101437.google-global-site-tag-gtag.html).
...
![Extension Google Global Site Tag](/help/rtcdp/destinations/assets/gtag-analytics-extension.png)
...
Pour installer l&#39;extension Google Global Site Tag :
...
Pour plus d&#39;informations sur les options de configuration de l&#39;extension, consultez la page [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.101437.google-global-site-tag-gtag.html) de l&#39;extension.

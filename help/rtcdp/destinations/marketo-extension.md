...
description: L’extension Marketo est une destination de courrier électronique dans la plateforme de données clientes en temps réel d’Adobe. Pour plus d’informations sur la fonctionnalité d’extension, voir la page d’extension dans Adobe Exchange.
seo-description: L’extension Marketo est une destination de courrier électronique dans la plateforme de données clientes en temps réel d’Adobe. Pour plus d’informations sur la fonctionnalité d’extension, voir la page d’extension dans Adobe Exchange.
...
# Extension Marketo {#marketo-extension}

## Aperçu {#overview}

Le puissant logiciel d&#39;automatisation du marketing de Marketo aide les spécialistes du marketing à maîtriser l&#39;art et la science du marketing numérique pour attirer les clients et les prospects.

Marketo est une extension de courrier électronique dans la plate-forme de données client en temps réel d’Adobe. Pour plus d’informations sur la fonctionnalité d’extension, voir la page d’ [extension dans Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.101071.marketo-for-adobe-launch.html).
...
Pour installer l’extension Marketo :
...
Pour plus d’informations sur les options de configuration de l’extension et la prise en charge de l’installation, voir la page [Marketo dans Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.101071.marketo-for-adobe-launch.html).

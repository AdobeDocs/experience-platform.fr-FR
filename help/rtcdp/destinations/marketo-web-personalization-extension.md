---
title: Extension de personnalisation Web de Marketo
seo-title: Extension de personnalisation Web de Marketo
description: L’extension Personnalisation Web de Marketing Cloud est une destination de personnalisation dans la plate-forme de données client en temps réel d’Adobe. Pour plus d’informations sur la fonctionnalité d’extension, voir la page d’extension dans Adobe Exchange.
seo-description: L’extension Personnalisation Web de Marketing Cloud est une destination de personnalisation dans la plate-forme de données client en temps réel d’Adobe. Pour plus d’informations sur la fonctionnalité d’extension, voir la page d’extension dans Adobe Exchange.
...
# Extension de la personnalisation Web de Marketo {#marketo-web-personalization-extension}

## Aperçu {#overview}

Cette extension déploie le script pour la personnalisation Web et les applications ContentAI de Marketo. La personnalisation Web du marketing identifie et personnalise de manière unique le contenu en fonction des caractéristiques du visiteur Web, telles que les caractéristiques graphiques pour les visiteurs anonymes et un large éventail d’attributs comportementaux au sein de la plate-forme d’engagement marketing pour les visiteurs connus. Marketo ContentAI contient des fonctionnalités de recommandations et de personnalisation optimisées pour l’IA pour les campagnes Web et par courrier électronique, qui sont uniques pour les clients B2B.

La personnalisation Web de marketing est une extension de personnalisation dans la plateforme de données clientes en temps réel d’Adobe. Pour plus d’informations sur la fonctionnalité d’extension, voir la page d’extension d’ [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.101232.marketo-web-personalization.html).
...
![Extension de la personnalisation Web de Marketo](assets/marketo-web-personalization-extension.png)
...
Pour installer l’extension Personnalisation Web de Marketo :
...
Pour plus d&#39;informations sur les options de configuration de l&#39;extension et la prise en charge de l&#39;installation, consultez la page Personnalisation Web de [Marketo dans Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.101232.marketo-web-personalization.html).

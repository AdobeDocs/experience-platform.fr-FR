---
title: Extension  Intercept QuestionPro
seo-title: Extension  Intercept QuestionPro
description: L’extension de  Intercept QuestionPro est une destination de  dans la plateforme de données clientes Adobe en temps réel. Pour plus d’informations sur la fonctionnalité d’extension, voir la page de l’extension dans Adobe Exchange.
seo-description: L’extension de Intercept QuestionPro est une destination  dans la plateforme de données clientes Adobe en temps réel. Pour plus d’informations sur la fonctionnalité d’extension, voir la page de l’extension dans Adobe Exchange.
...
# Extension  Intercept QuestionPro {#questionpro-extension}

## Aperçu {#overview}

QuestionPro Intercept  est une plateforme permettant de déployer des  de et de collecter des données comportementales au point de transaction ou lorsque les utilisateurs entrent ou sortent de votre site Web.

QuestionPro Intercept  est une extension de de  dans la plateforme de données clientes Adobe en temps réel. Pour plus d’informations sur la fonctionnalité d’extension, voir la page d’extension d’ [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.90096.questionpro-surveys.html).
...
![Extension  Intercept QuestionPro](assets/web-intercept-surveys-extension.png)
...
Pour installer l&#39;extension  Intercept QuestionPro :
...
Pour plus d&#39;informations sur les options de configuration de l&#39;extension et la prise en charge de l&#39;installation, reportez-vous à la page  Intercept de [QuestionPro sur Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.90096.questionpro-surveys.html).

...
description: L’extension du service d’identification d’Experience Cloud est une destination de personnalisation dans la plate-forme de données client en temps réel d’Adobe. Pour plus d’informations sur la fonctionnalité d’extension, voir la page d’extension dans Adobe Exchange.
seo-description: L’extension du service d’identification d’Experience Cloud est une destination de personnalisation dans la plate-forme de données client en temps réel d’Adobe. Pour plus d’informations sur la fonctionnalité d’extension, voir la page d’extension dans Adobe Exchange.
...
Cette extension implémente le service d’identification d’Experience Cloud, qui identifie les visiteurs de toutes les solutions Experience Cloud.

Le service d’identification d’Experience Cloud est une extension de personnalisation de la plateforme de données clientes en temps réel d’Adobe. Pour plus d’informations sur la fonctionnalité d’extension, voir la page [d’extension du service d’ID](https://docs.adobe.com/content/help/fr-FR/launch/using/extensions-ref/adobe-extension/id-service-extension/overview.html) d’expérience dans la documentation relative au lancement de la plate-forme d’expérience.
...
Pour installer l’extension du service d’identification d’Experience Cloud :
...
Pour plus d’informations sur les options de configuration de l’extension et la prise en charge de l’installation, voir la page [Expérience Cloud ID Service extension (Service d’identification](https://docs.adobe.com/content/help/fr-FR/launch/using/extensions-ref/adobe-extension/id-service-extension/overview.html) Experience Cloud) dans la documentation relative au lancement d’expérience.

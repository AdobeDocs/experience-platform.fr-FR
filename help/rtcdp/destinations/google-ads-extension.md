...
Cette extension effectue le suivi des conversions des utilisateurs qui cliquent sur vos publicités Google. Vous devez également installer l’extension gtag.js et l’ajouter à votre bibliothèque, car les publicités Google en dépendent.

Google Ads est une extension publicitaire dans la plateforme de données clientes en temps réel d’Adobe. Pour plus d’informations sur la fonctionnalité d’extension, voir la page d’extension d’ [Adobe Exchange](https://www.adobeexchange.com/experiencecloud.details.101383.google-ads.html).

...
description: L’extension Adform est une destination d’analyse dans la plateforme de données clientes en temps réel d’Adobe. Pour plus d’informations sur la fonctionnalité d’extension, voir la page de l’extension dans Adobe Exchange.
seo-description: L’extension Adform est une destination d’analyse dans la plateforme de données clientes en temps réel d’Adobe. Pour plus d’informations sur la fonctionnalité d’extension, voir la page de l’extension dans Adobe Exchange.
...
L’extension Adform Website Tracking permet aux annonceurs de mettre en oeuvre les points de suivi Adform sans effort sur leurs sites à l’aide de la plate-forme de lancement d’expérience.

Adform est une extension d’analyse de la plateforme de données clientes en temps réel d’Adobe. Pour plus d’informations sur la fonctionnalité d’extension, reportez-vous à la page d’extension d’ [Adobe Exchange.](https://exchange.adobe.com/experiencecloud.details.103195.adform-website-tracking.html)

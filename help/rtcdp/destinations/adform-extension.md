---
title: Extension d’adform
seo-title: Extension d’adform
description: L’extension Adform est une destination d’analyse de la plate-forme de données client en temps réel d’Adobe. Pour plus d’informations sur la fonctionnalité d’extension, voir la page d’extension dans Adobe Exchange.
seo-description: L’extension Adform est une destination d’analyse de la plate-forme de données client en temps réel d’Adobe. Pour plus d’informations sur la fonctionnalité d’extension, voir la page d’extension dans Adobe Exchange.
...
# Extension d’adform {#adform-extension}

## Aperçu {#overview}

L’extension Adform Website Tracking permet aux annonceurs de mettre en oeuvre les points de suivi d’Adform sans effort sur leurs sites à l’aide de la plate-forme de lancement d’expérience.

Adform est une extension d’analyse de la plate-forme de données client en temps réel d’Adobe. Pour plus d’informations sur la fonctionnalité d’extension, voir la page d’extension d’ [Adobe Exchange.](https://exchange.adobe.com/experiencecloud.details.103195.adform-website-tracking.html)
...
![Extension d’adform](/help/rtcdp/destinations/assets/adform-extension.png)
...
Pour plus d’informations sur les options de configuration de l’extension et la prise en charge de l’installation, voir la page [Adform dans Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.103195.adform-website-tracking.html).

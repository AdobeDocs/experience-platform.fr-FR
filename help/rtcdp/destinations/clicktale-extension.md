...
description: L’extension Clicktale est une destination d’analyse dans la plateforme de données clientes en temps réel d’Adobe. Pour plus d’informations sur la fonctionnalité d’extension, voir la page de l’extension dans Adobe Exchange.
seo-description: L’extension Clicktale est une destination d’analyse dans la plateforme de données clientes en temps réel d’Adobe. Pour plus d’informations sur la fonctionnalité d’extension, voir la page de l’extension dans Adobe Exchange.
...
L’intégration de ClickTale au lancement de la plateforme d’expérience permet le déploiement du code ClickTale et la possibilité de mapper des éléments de données dans Launch, à l’aide de l’éditeur visuel de ClickTale.

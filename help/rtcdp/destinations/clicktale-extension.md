...
seo-title: Extension Clicktale
description: L’extension Clicktale est une destination d’analyse dans la plate-forme de données clientes en temps réel d’Adobe. Pour plus d’informations sur la fonctionnalité d’extension, voir la page d’extension dans Adobe Exchange.
seo-description: L’extension Clicktale est une destination d’analyse dans la plate-forme de données clientes en temps réel d’Adobe. Pour plus d’informations sur la fonctionnalité d’extension, voir la page d’extension dans Adobe Exchange.
...
# Extension Clicktale {#clicktale-extension}

## Aperçu {#overview}

L’intégration de ClickTale avec le lancement de la plate-forme d’expérience permet le déploiement du code ClickTale et la possibilité de mapper des éléments de données dans le lancement, à l’aide de l’éditeur visuel de ClickTale.

Clicktale est une extension d’analyse de la plateforme de données clientes en temps réel d’Adobe. Pour plus d’informations sur la fonctionnalité d’extension, voir la page d’extension d’ [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.100082.html).
...
![Extension Clicktale](assets/clicktale-extension.png)
...
Pour installer l&#39;extension Clicktale :
...
Pour plus d’informations sur les options de configuration de l’extension, voir la page [d’extension](https://exchange.adobe.com/experiencecloud.details.100082.html) Clicktale dans Adobe Exchange.

---
title: Extension du gestionnaire Nielsen IMA
seo-title: Extension du gestionnaire Nielsen IMA
description: L’extension Nielsen IMA Handler est une destination d’analyse dans la plateforme de données clientes Adobe en temps réel. Pour plus d’informations sur la fonctionnalité d’extension, voir la page de l’extension dans Adobe Exchange.
seo-description: L’extension Nielsen IMA Handler est une destination d’analyse dans la plateforme de données clientes Adobe en temps réel. Pour plus d’informations sur la fonctionnalité d’extension, voir la page de l’extension dans Adobe Exchange.
...
# Extension du gestionnaire IMA Nielsen {#nielsen-ima-extension}

## Aperçu {#overview}

Nielsen IMA Handler est une extension d’analyse de la plateforme de données clientes Adobe en temps réel.
...
![Extension du gestionnaire IMA Nielsen](assets/nielsen-ima-extension.png)
...
Pour installer l’extension Nielsen IMA Handler :

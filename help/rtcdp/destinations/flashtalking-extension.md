...
description: L’extension OneTag Flashspeak est une destination publicitaire dans la plate-forme de données clientes en temps réel. Pour plus d’informations sur les fonctionnalités de l’extension, consultez la page de l’extension dans Adobe Exchange.
seo-description: L’extension OneTag Flashspeak est une destination publicitaire dans la plate-forme de données clientes en temps réel. Pour plus d’informations sur les fonctionnalités de l’extension, consultez la page de l’extension dans Adobe Exchange.

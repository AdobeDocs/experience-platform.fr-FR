---
title: Extension OneTag Flash
seo-title: Extension OneTag Flash
description: L’extension OneTag Flash est une destination publicitaire dans la plateforme de données clientes Adobe en temps réel. Pour plus d’informations sur la fonctionnalité d’extension, voir la page de l’extension dans Adobe Exchange.
...
# Extension OneTag Flash {#flashtalking-extension}

## Aperçu {#overview}

L’extension OneTag Flash pour le lancement d’une plateforme d’expérience facilite l’attribution des actions du site pour l’affichage, la vidéo et les  de publicité mobiles . Déployez la balise OneTag Flash sur vos propriétés Web à l’aide de Launch.

Flashspeak OneTag est une extension publicitaire dans la plate-forme de données clientes Adobe en temps réel. Pour plus d’informations sur la fonctionnalité d’extension, voir la page d’extension d’ [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.101392.flashtalking-onetag.html).
...
![Extension clignotante](assets/flashtalking-extension.png)
...
Pour installer l’extension OneTag Flash :
...
Pour plus d’informations sur les options de configuration de l’extension et la prise en charge de l’installation, voir la page OneTag [Flash dans Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.101392.flashtalking-onetag.html).

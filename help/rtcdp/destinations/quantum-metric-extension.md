...
description: L’extension de mesure quantique est une destination d’analyse dans la plateforme de données clientes en temps réel d’Adobe. Pour plus d’informations sur la fonctionnalité d’extension, voir la page d’extension dans Adobe Exchange.
seo-description: L’extension de mesure quantique est une destination d’analyse dans la plate-forme de données clientes en temps réel d’Adobe. Pour plus d’informations sur la fonctionnalité d’extension, voir la page d’extension dans Adobe Exchange.
...
L’intégration de Quantum Metric à Adobe Launch facilite le déploiement sans code de la balise de collecte de données de Quantum Metric. En outre, cette extension offre la capacité de capturer les éléments de données de lancement contenant des informations utiles de l’API de mesure quantique.

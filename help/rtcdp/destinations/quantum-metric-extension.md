---
title: Extension de mesure quantique
seo-title: Extension de mesure quantique
description: L’extension de mesure quantique est une destination d’analyse dans la plateforme de données clientes en temps réel d’Adobe. Pour plus d’informations sur la fonctionnalité d’extension, voir la page de l’extension dans Adobe Exchange.
seo-description: L’extension de mesure quantique est une destination d’analyse dans la plateforme de données clientes Adobe en temps réel. Pour plus d’informations sur la fonctionnalité d’extension, voir la page de l’extension dans Adobe Exchange.
...
# Extension de mesure quantique {#quantum-metric-extension}

## Aperçu {#overview}

L’intégration de la mesure quantique à Adobe Launch facilite le déploiement sans aucune programmation de la balise de collecte de données de la mesure quantique. En outre, cette extension  la capacité de capturer des éléments de données de lancement contenant des informations utiles à partir de l’API de mesure quantique.

La mesure quantique est une extension d’analyse de la plateforme de données clientes en temps réel d’Adobe. Pour plus d’informations sur la fonctionnalité d’extension, voir la page d’extension d’ [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.101535.quantum-metric-extension-for-adobe-launch.html).
...
![Extension de mesure quantique](assets/quantum-metric-extension.png)
...
Pour installer l’extension de mesure quantique :
...
Pour plus d’informations sur les options de configuration de l’extension et la prise en charge de l’installation, voir la page Mesures [quantiques dans Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.101535.quantum-metric-extension-for-adobe-launch.html).

...
description: L’extension Adobe Cible v2 est une destination de personnalisation dans la plateforme de données clientes en temps réel d’Adobe. Pour plus d’informations sur la fonctionnalité d’extension, voir la page d’extension dans Adobe Exchange.
...
Adobe Cible v2 est une extension de personnalisation de la plateforme de données clientes en temps réel d’Adobe. Pour plus d’informations sur la fonctionnalité d’extension, voir la page d’extension d’ [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.102722.adobe-target-v2-launch-extension.html).
...
Pour installer l’extension Adobe Cible v2 :
...
Pour plus d’informations sur les options de configuration de l’extension, voir la page [de l’extension](https://docs.adobe.com/content/help/en/launch/using/extensions-ref/adobe-extension/targetv2-extension/adobe-target-extension-v2.html) Adobe Cible v2 dans la documentation d’Experience Launch.

---
title: Extension de boîte de réception de l’URL de conférence
seo-title: Boîte de réception de l’URL de conférence
description: L’extension de boîte de réception d’URL de conférence est une voix de la destination du client dans la plateforme de données clientes Adobe en temps réel. Pour plus d’informations sur la fonctionnalité d’extension, voir la page de l’extension dans Adobe Exchange.
seo-description: L’extension de boîte de réception d’URL de conférence est une voix de la destination du client dans la plateforme de données clientes Adobe en temps réel. Pour plus d’informations sur la fonctionnalité d’extension, voir la page de l’extension dans Adobe Exchange.
...
# Extension de boîte de réception d’URL de présentation {#talk-url-extension}

## Aperçu {#overview}

Recevez des messages vocaux des de votre page Web. Inclut l’interface utilisateur hébergée et l’apprentissage automatique en mode cloud pour transcrire instantanément vos messages vocaux en informations textuelles.

La boîte de réception d’URL de présentation est la voix de l’extension du client dans la plateforme de données clientes Adobe en temps réel. Pour plus d’informations sur la fonctionnalité d’extension, voir la page d’extension d’ [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.100583.html).
...
![Extension de boîte de réception de l’URL de conférence](assets/talkurl-extension.png)
...
Pour installer l’extension de boîte de réception d’URL de présentation :
...
Pour plus d’informations sur les options de configuration de l’extension et la prise en charge de l’installation, voir la page de boîte de réception URL [Talk dans Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.100583.html).

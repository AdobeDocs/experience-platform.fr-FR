---
title: Extension du gestionnaire du lecteur vidéoJS Nielsen
seo-title: Extension du gestionnaire du lecteur vidéoJS Nielsen
description: L’extension Nielsen VideoJS Player Handler est une destination d’analyse dans la plateforme de données clientes Adobe en temps réel. Pour plus d’informations sur la fonctionnalité d’extension, voir la page de l’extension dans Adobe Exchange.
seo-description: L’extension Nielsen VideoJS Player Handler est une destination d’analyse dans la plateforme de données clientes Adobe en temps réel. Pour plus d’informations sur la fonctionnalité d’extension, voir la page de l’extension dans Adobe Exchange.
...
# Extension du gestionnaire du lecteur vidéo JS Nielsen {#nielsen-vjs-extension}
...
Nielsen VideoJS Player Handler est une extension d’analyse de la plateforme de données clientes Adobe en temps réel. Pour plus d’informations sur la fonctionnalité d’extension, voir la page d’extension d’ [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.101361.nielsen-digital-sdk-extension.html).
...
![Extension du gestionnaire du lecteur vidéo JS Nielsen](assets/nielsen-videojs-extension.png)

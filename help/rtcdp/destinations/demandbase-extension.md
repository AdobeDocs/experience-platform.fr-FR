...
description: L’extension Demandbase est une destination d’analyse de la plateforme de données clientes en temps réel d’Adobe. Pour plus d’informations sur la fonctionnalité d’extension, voir la page d’extension dans Adobe Exchange.
seo-description: L’extension Demandbase est une destination d’analyse de la plateforme de données clientes en temps réel d’Adobe. Pour plus d’informations sur la fonctionnalité d’extension, voir la page d’extension dans Adobe Exchange.
...
Bénéficiez d’informations sur les comptes Demandbase B2B directement dans Adobe Analytics où vous pouvez segmenter le trafic et le comportement par secteur d’activité, recettes et comptes de cible. Cette vue basée sur le compte fournit des informations uniques sur l’engagement, la conversion et la source de vos visiteurs les plus précieux.
...
Pour plus d’informations sur les options de configuration de l’extension, voir la page [](https://exchange.adobe.com/experiencecloud.details.101605.html) Demandbase extension sur Adobe Exchange.

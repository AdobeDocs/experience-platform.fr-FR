...
seo-title: Extension Demandbase
description: L’extension Demandbase est une destination d’analyse dans la plateforme de données clientes en temps réel d’Adobe. Pour plus d’informations sur la fonctionnalité d’extension, voir la page de l’extension dans Adobe Exchange.
seo-description: L’extension Demandbase est une destination d’analyse dans la plateforme de données clientes en temps réel d’Adobe. Pour plus d’informations sur la fonctionnalité d’extension, voir la page de l’extension dans Adobe Exchange.
...
# Extension Demandbase {#demandbase-extension}

## Aperçu {#overview}

Obtenez des informations de base sur les comptes B2B Demandbase directement dans Adobe Analytics où vous pouvez segmenter le trafic et le comportement par industrie, par recettes et par vos comptes de . Ce basé sur le compte fournit des informations uniques sur l’engagement, la conversion et la source de vos les plus précieux.

Demandbase est une extension d’analyse de la plateforme de données clientes en temps réel d’Adobe. Pour plus d’informations sur la fonctionnalité d’extension, voir la page d’extension d’ [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.101605.html).
...
![Extension Demandbase](assets/demandbase-extension.png)
...
Pour installer l’extension Demandbase :
...
Pour plus d’informations sur les options de configuration de l’extension, voir la page [Demandbase Extension (extension](https://exchange.adobe.com/experiencecloud.details.101605.html) Demandbase) sur Adobe Exchange.

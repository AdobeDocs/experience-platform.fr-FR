...
description: L’extension BÊTA (JW Player Analytics) est une destination d’analyse dans la plateforme de données clientes Adobe en temps réel. Pour plus d’informations sur la fonctionnalité d’extension, voir la page de l’extension dans Adobe Exchange.
seo-description: L’extension BÊTA (JW Player Analytics) est une destination d’analyse dans la plateforme de données clientes Adobe en temps réel. Pour plus d’informations sur la fonctionnalité d’extension, voir la page de l’extension dans Adobe Exchange.
...
# Extension JW Player Analytics (BETA) {#jw-player-analytics-extension}

## Aperçu {#overview}

Cette extension installe l’adaptateur JW Player pour connecter le JW Player à Adobe Video Analytics. Exploitez la puissance d’Adobe Video Analytics pour obtenir des informations détaillées sur les habitudes de vos clients en matière d’affichage vidéo.

JW Player Analytics (BETA) est une extension d’analyse de la plateforme de données clientes en temps réel d’Adobe. Pour plus d’informations sur la fonctionnalité d’extension, voir la page d’extension d’ [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.101523.jw-player-analytics-launch-extension.html).
...
Pour installer l’extension JW Player Analytics (BETA) :
...
Pour plus d’informations sur les options de configuration de l’extension, voir la page [d’extension BÊTA (](https://exchange.adobe.com/experiencecloud.details.101523.jw-player-analytics-launch-extension.html) JW Player Analytics) dans Adobe Exchange.

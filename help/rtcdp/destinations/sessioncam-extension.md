---
title: Extension SessionCam
seo-title: Extension SessionCam
description: L’extension SessionCam est une destination d’analyse dans la plateforme de données clientes en temps réel d’Adobe. Pour plus d’informations sur la fonctionnalité d’extension, voir la page de l’extension dans Adobe Exchange.
seo-description: L’extension SessionCam est une destination d’analyse dans la plateforme de données clientes en temps réel d’Adobe. Pour plus d’informations sur la fonctionnalité d’extension, voir la page de l’extension dans Adobe Exchange.
...
# Extension SessionCam {#sessioncam-extension}

## Aperçu {#overview}

SessionCam fournit une suite essentielle d’outils qui révèlent le comportement des utilisateurs et vous montrent les problèmes les plus importants à résoudre.

SessionCam est une extension d’analyse de la plateforme de données clientes en temps réel d’Adobe. Pour plus d’informations sur la fonctionnalité d’extension, voir la page d’extension d’ [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.100517.html).
...
![Extension SessionCam](assets/sessioncam-extension.png)
...
Pour installer l’extension SessionCam :
...
Pour plus d’informations sur les options de configuration de l’extension et la prise en charge de l’installation, voir la page [SessionCam dans Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.100517.html).

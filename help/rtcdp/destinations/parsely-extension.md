---
title: Extension Analytics Parse.ly
seo-title: Extension Analytics Parse.ly
description: L’extension Parse.ly Analytics est une destination d’analyse dans la plateforme de données clientes Adobe en temps réel. Pour plus d’informations sur la fonctionnalité d’extension, voir la page de l’extension dans Adobe Exchange.
seo-description: L’extension Analytics Parse.ly est une destination d’analyse dans la plateforme de données clientes Adobe en temps réel. Pour plus d’informations sur la fonctionnalité d’extension, voir la page de l’extension dans Adobe Exchange.
...
# Extension Analytics Parse.ly {#parsely-analytics-extension}

## Aperçu {#overview}

Analytics d’Analytics aide plus de 2 500 à utiliser les données pour comprendre leur  de en ligne. Cette extension installe un extrait de code JavaScript, qui suit la manière dont les interagissent avec le contenu de votre site.

Parse.ly est une extension d’analyse de la plateforme de données clientes en temps réel d’Adobe. Pour plus d’informations sur la fonctionnalité d’extension, voir Analyses [Parse.ly](https://www.parse.ly/).
...
![Extension Analytics Parse.ly](assets/parsely-extension.png)
...
Pour installer l’extension Parse.ly :

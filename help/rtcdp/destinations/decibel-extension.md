...
seo-title: Extension Decibel
description: L’extension Decibel est une destination d’analyse de la plateforme de données clients en temps réel d’Adobe. Pour plus d’informations sur les fonctionnalités de l’extension, consultez la page de l’extension dans Adobe Exchange.
seo-description: L’extension Decibel est une destination d’analyse de la plateforme de données clients en temps réel d’Adobe. Pour plus d’informations sur les fonctionnalités de l’extension, consultez la page de l’extension dans Adobe Exchange.
...
Quickly and seamlessly deploy [!DNL Decibel] on your web properties. D’autres configurations avancées peuvent également être déployées à l’aide de règles grâce aux actions proposées par l’extension.

[!DNL Decibel] est une extension d’analyse de la plateforme de données clients en temps réel d’Adobe. Pour plus d’informations sur les fonctionnalités de l’extension, consultez la page de l’extension dans [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.100913.html).
...
![Extension Decibel](assets/decibel-extension.png)
...
Pour installer l’ [!DNL Decibel] extension :

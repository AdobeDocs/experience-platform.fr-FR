---
title: Extension décimale
seo-title: Extension décimale
description: L’extension decibel est une destination d’analyse dans la plateforme de données clientes en temps réel d’Adobe. Pour plus d’informations sur la fonctionnalité d’extension, voir la page de l’extension dans Adobe Exchange.
seo-description: L’extension decibel est une destination d’analyse dans la plateforme de données clientes en temps réel d’Adobe. Pour plus d’informations sur la fonctionnalité d’extension, voir la page de l’extension dans Adobe Exchange.
...
# Extension décimale {#decibel-extension}

## Aperçu {#overview}

Déployez rapidement et en toute simplicité Décibel sur vos propriétés Web. D’autres configurations avancées peuvent également être déployées avec des règles à l’aide d’actions rendues disponibles par l’extension.

Décibel est une extension d’analyse de la plateforme de données clientes en temps réel d’Adobe. Pour plus d’informations sur la fonctionnalité d’extension, voir la page d’extension d’ [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.100913.html).
...
![Extension décimale](assets/decibel-extension.png)
...
Pour installer l’extension de Decbel :
...
Pour plus d’informations sur les options de configuration de l’extension, voir la page [de l’extension](https://exchange.adobe.com/experiencecloud.details.100913.html) Décibel dans Adobe Exchange.

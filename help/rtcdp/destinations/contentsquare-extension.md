...
description: L’extension Contentsquare est une destination d’analyse dans la plate-forme de données client en temps réel d’Adobe. Pour plus d’informations sur la fonctionnalité d’extension, voir la page d’extension dans Adobe Exchange.
seo-description: L’extension Contentsquare est une destination d’analyse dans la plate-forme de données client en temps réel d’Adobe. Pour plus d’informations sur la fonctionnalité d’extension, voir la page d’extension dans Adobe Exchange.
...
Visualisez les comportements sur la page, voir POURQUOI les clients abandonnent et COMMENT vous pouvez améliorer. Attribuer les recettes aux éléments UX et de contenu pour chaque segment et test de Cible Analytics. Installez la balise Contentsquare, configurez les variables et les événements personnalisés. Début de collecte de données pour votre analyse UX en quelques clics.

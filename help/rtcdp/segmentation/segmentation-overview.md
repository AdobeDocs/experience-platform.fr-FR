...
title: Segmentation Service dans la plateforme de données clients en temps réel
...
Customer AI, inclus avec la plateforme de données clients en temps réel, vous permet de générer des prédictions client au niveau individuel avec des explications.

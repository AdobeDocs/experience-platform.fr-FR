...
Le jeu de données comprend les informations de compte correspondantes ainsi que le score de correspondance pour le jeu de données sélectionné. Le champ Source de relation ]**indique s’il provient du processus de correspondance entre le prospect et le compte.**[!UICONTROL 

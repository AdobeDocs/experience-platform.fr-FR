...
Ce parcours cible les produits qui ont été placés dans le panier mais qui n’ont pas été achetés à la fois sur le site web et dans l’application. Utilisé pour démarrer et arrêter les campagnes de médias payants
...
Ce parcours cible les achats de produits sur le site web et dans l’application.
...
### Configuration d’une conception de schéma et de groupes de champs

Il existe 4 conceptions de schéma utilisées pour les parcours de réengagement intelligent. Chaque schéma nécessite la configuration de champs spécifiques, ainsi que de champs fortement recommandés.

>[!BEGINTABS]

>[!TAB Attributs du client (schéma de profil)]

Les groupes de champs requis pour le schéma de profil sont les suivants :
...
![Un enregistrement du schéma des attributs du client présentant une liste de groupes de champs.](../intelligent-re-engagement/images/customer-attributes.gif)

>[!TAB Transactions numériques client]

Les groupes de champs requis pour le schéma d’événement d’expérience pour l’activité en ligne (et non pour Adobe Analytics Connector) sont les suivants :
...
![Un enregistrement du schéma des transactions numériques client présentant une liste de groupes de champs.](../intelligent-re-engagement/images/customer-digital-transactions.gif)

>[!TAB Transactions hors ligne du client]

Les groupes de champs requis pour le schéma d’événement d’expérience pour l’activité hors ligne sont les suivants :
...
![Un enregistrement du schéma des transactions hors ligne du client présentant une liste de groupes de champs.](../intelligent-re-engagement/images/customer-offline-transactions.gif)

>[!TAB Schéma du connecteur web Adobe]
...
![Un enregistrement du schéma Connecteur Web Adobe présentant une liste de groupes de champs.](../intelligent-re-engagement/images/adobe-web-connector.png)
...
Les événements suivants sont utilisés pour le parcours de réengagement où les profils ont consulté des produits en ligne et n’ont pas été ajoutés au panier au cours des 24 heures suivantes, suivis par aucun engagement de marque au cours des 3 jours suivants.

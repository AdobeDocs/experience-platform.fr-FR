...
>- La vue au niveau de l’audience est actuellement disponible pour les destinations par lots (basées sur des fichiers) et la destination de diffusion en continu [Google Customer Match DV 360](/help/destinations/catalog/advertising/google-customer-match-dv360.md) uniquement. Le déploiement est prévu pour d’autres destinations de diffusion en continu.

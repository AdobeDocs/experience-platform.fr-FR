...
| Diffusion en flux continu des Événements de décision dans [!DNL Data Lake] et [!DNL Query Service] | Le [!DNL Decisioning Service] système crée automatiquement des jeux de données pour diffuser automatiquement tous les Événements de décision XDM dans le [!DNL Data Lake]. Les jeux de données sont alors disponibles pour la création d’analyses et de rapports à l’aide de [!DNL Query Service]. |

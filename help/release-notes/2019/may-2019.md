...
| Création de politiques d’utilisation des données | Définissez et gérez des politiques d’utilisation des données en fonction de la présence de libellés et des actions marketing demandées. |

...
| [!DNL Schema Library] | Le [!DNL Schema Library] contient tous [!DNL Schema Registry] les ressources, y compris celles définies par une organisation individuelle et celles mises à la disposition de tous les utilisateurs par Adobe, [!DNL Experience Platform] partenaires et fournisseurs dont les applications sont intégrées à [!DNL Experience Platform]. |

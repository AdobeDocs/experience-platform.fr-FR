...
| [[!DNL Federated Audiences]](https://www.adobe.com/go/destinations-federated-audience-composition) exporter le fichier maintenant | L’option **[!UICONTROL Exporter le fichier maintenant]** est désormais prise en charge pour les destinations [!DNL Federated Audience Composition]. |

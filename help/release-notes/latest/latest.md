...
| Extension | Extension [!DNL Cloud connector for Google Analytics 4 (ga4)] | L’extension de transfert d’événement [[!DNL Cloud connector for Google Analytics 4 (ga4)]](https://partners.adobe.com/exchangeprogram/experiencecloud/exchange.details.109820.html) vous permet d’effectuer le suivi des analyses via le nouveau [!DNL Google Analytics 4 (ga4)] standard. |

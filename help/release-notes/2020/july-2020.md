...
| Fonctionnalité | Description |
| ------- | ----------- |
| Application des politiques d’utilisation des données | En [!DNL Real-Time Customer Data Platform], les violations de la politique d’utilisation des données sont automatiquement affichées lorsqu’une action en violation dans l’espace de travail [!UICONTROL Profile] est tentée. Pour plus d’informations sur l’application automatique des politiques[&#x200B; consultez les &#x200B;](#governance) notes de mise à jour relatives à la gouvernance des données . |
...
| Application des politiques d’utilisation des données | En [!DNL Real-Time Customer Data Platform], les violations de la politique d’utilisation des données sont automatiquement affichées lorsqu’une action en violation dans l’espace de travail [!UICONTROL Segments] est tentée. Pour plus d’informations sur l’application automatique des politiques[&#x200B; consultez les &#x200B;](#governance) notes de mise à jour relatives à la gouvernance des données . |

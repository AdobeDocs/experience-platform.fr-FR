---
title: Notes de mise à jour de Adobe Experience Platform - Mai 2020
...
La plateforme CDP en temps réel prend désormais en charge l’activation des données vers [!DNL Facebook], ce qui vous permet d’activer les profils pour votre [!DNL Facebook] des campagnes pour le ciblage, la personnalisation et la suppression des audiences en fonction d’emails hachés.
...
>[!NOTE]
>
>Le [!DNL Amazon Kinesis] et [!DNL Azure Event Hubs] Les destinations dans la plateforme de données clients en temps réel sont actuellement en version bêta. La documentation et les fonctionnalités peuvent changer.

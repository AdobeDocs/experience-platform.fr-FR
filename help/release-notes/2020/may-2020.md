...
## SDK Web Experience Platform et réseau Edge Experience Platform
...
| Mixin SDK Web AEP | Mélange à utiliser avec le SDK Web AEP qui englobe tous les champs pris en charge. |
| Contrôles du consentement du cours | Permet aux sociétés de contrôler l’inclusion et l’exclusion du SDK Web AEP |
| Prise en charge du débogage côté client dans la nouvelle extension de débogueur Experience Cloud | Voir les requêtes du SDK Web AEP ainsi que les traces de bord pour voir comment les données circulent dans le système. |
...
| XDM Object BUilder | Dans l’extension de lancement, vous pouvez désormais créer des objets XDM en tant qu’éléments de données. |
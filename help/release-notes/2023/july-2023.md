...
| [[!DNL Amazon S3] Mettre à jour](../../destinations/catalog/cloud-storage/amazon-s3.md#changelog) | Mis à jour | Avec cette mise à jour, la destination fournit une fonctionnalité d’exportation de fichiers améliorée et prend en charge les exportations de jeux de données [!BADGE Beta]{type=Informative}. |
| [[!DNL Azure Blob] Mettre à jour](../../destinations/catalog/cloud-storage/azure-blob.md#changelog) | Mis à jour | Avec cette mise à jour, la destination fournit une fonctionnalité d’exportation de fichiers améliorée et prend en charge les exportations de jeux de données [!BADGE Beta]{type=Informative}. |
| [[!DNL SFTP] Mettre à jour](../../destinations/catalog/cloud-storage/sftp.md#changelog) | Mis à jour | Avec cette mise à jour, la destination fournit une fonctionnalité d’exportation de fichiers améliorée et prend en charge les exportations de jeux de données [!BADGE Beta]{type=Informative}. |
...
- Vous pouvez désormais exporter des audiences sous la forme de [fichiers JSON ou Parquet](/help/destinations/ui/activate-batch-profile-destinations.md#supported-file-formats-export), en plus du format CSV déjà pris en charge.

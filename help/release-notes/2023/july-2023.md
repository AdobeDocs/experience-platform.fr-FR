...
| [[!DNL Amazon S3] Mettre à jour](../../destinations/catalog/cloud-storage/amazon-s3.md#changelog) | Mis à jour | Avec cette mise à jour, la destination offre une fonctionnalité d’exportation de fichiers améliorée et prend en charge les exportations de jeux de données {type=Informative}. |
| [[!DNL Azure Blob] Mettre à jour](../../destinations/catalog/cloud-storage/azure-blob.md#changelog) | Mis à jour | Avec cette mise à jour, la destination offre une fonctionnalité d’exportation de fichiers améliorée et prend en charge les exportations de jeux de données {type=Informative}. |
| [[!DNL SFTP] Mettre à jour](../../destinations/catalog/cloud-storage/sftp.md#changelog) | Mis à jour | Avec cette mise à jour, la destination offre une fonctionnalité d’exportation de fichiers améliorée et prend en charge les exportations de jeux de données {type=Informative}. |

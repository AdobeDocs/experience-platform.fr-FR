...
subfeature_v2: id: a230274e-7e6e-49eb-b817-514495a710acid: abc02dd6-664f-446a-9aaa-675bc0f2fe4aid: acc16deb-1d7f-4ec9-9ce3-6cdf355afde6id: ae2cba0e-54f2-464b-a3b3-ad371e8a886aid: aff8c1fa-1be7-48bd-92b8-4b12a668ca13id: b3ddd7c3-4e07-4269-8660-8dd1e8139d74id: b784da9a-7978-4766-bf1f-5ab2b23d894aid: ca3d6bf4-a4af-4944-936b-8de1eb09f149id: cbd4a8d8-97a6-4ac9-b8d6-b6c1f28d3342id: d1823595-9241-4128-8a33-e4ac3bf08773id: d1a87129-ba05-4f15-98b1-233618f1774aid: d9830f6f-ceb6-4faa-9744-f281fe4439f9id: dc6ebdf7-9a94-43eb-9184-759cfdd0cf1cid: de9975b2-c43a-4287-9698-4f4cad92b83fid: e8c2a8db-c24b-44d9-ab8e-a8bc03acf6b1id: f6ff4d13-7b5c-4533-8556-95e76673d4cbid: f9a2105e-7a47-4e85-9193-31a519a2cb83
role_v2: id: b69b2659-1057-424e-8fc5-ed9e016dc554id: c66ffd68-0f65-42bb-aa23-b4020f12e0bdid: f8a45b24-4be7-4f1b-909b-60d06b483a20id: ff6a42d2-313e-452e-93a6-792e4fad9ff8
topic_v2: id: a004cc84-67b9-4a33-a3a7-8ec7273ef4dcid: aa2f3246-cb95-4b30-8899-fdf7d73550ccid: bce87dde-a4ab-44c9-8a18-ad66e4ddb377id: c1579802-ddd4-4214-8a91-97b2066abe11id: c7d04a2c-412a-4c9d-9d7a-4456eaa5adebid: cc72dcf1-72e1-48cc-b434-e7c27d62d67cid: d3cdead0-685a-4489-9250-4bb709942f66id: e0eb8757-182f-49f3-94a4-1587d16f5094id: e1e0219c-f879-479f-8427-888ed2a6e9c2
...
- [Notes de mise à jour d’Adobe Experience Platform](#adobe-experience-platform-release-notes)
   - [{#catalog-service} du service de catalogue](#catalog-service-catalog-service)
   - [{#data-collection} de la collecte de données](#data-collection-data-collection)
   - [{#data-prep} de la préparation des données](#data-prep-data-prep)
   - [{#destinations} des destinations](#destinations-destinations)
   - [{#query-service} de Query Service](#query-service-query-service)
   - [{#segmentation} de Segmentation Service](#segmentation-service-segmentation)
   - [{#sources} des sources](#sources-sources)
   - [{#xdm} du modèle de données d’expérience (XDM)](#experience-data-model-xdm-xdm)
...
| [[!DNL Amazon S3] Mettre à jour](../../destinations/catalog/cloud-storage/amazon-s3.md#changelog) | Mis à jour | Avec cette mise à jour, la destination offre une fonctionnalité d’exportation de fichiers améliorée et prend en charge les exportations de jeux de données [!BADGE ]{type=Informative}. |
| [[!DNL Azure Blob] Mettre à jour](../../destinations/catalog/cloud-storage/azure-blob.md#changelog) | Mis à jour | Avec cette mise à jour, la destination offre une fonctionnalité d’exportation de fichiers améliorée et prend en charge les exportations de jeux de données [!BADGE ]{type=Informative}. |
| [[!DNL SFTP] Mettre à jour](../../destinations/catalog/cloud-storage/sftp.md#changelog) | Mis à jour | Avec cette mise à jour, la destination offre une fonctionnalité d’exportation de fichiers améliorée et prend en charge les exportations de jeux de données [!BADGE ]{type=Informative}. |
...
| Fonctionnalité | Description |
| --- | --- |
| Bouton (bascule) du requêteur amélioré | Le bouton (bascule) du requêteur amélioré offre une meilleure accessibilité et une prise en charge multi-thème. Les paramètres de l’Éditeur amélioré vous permettent d’activer les thèmes foncés ou clairs. Pour plus d’informations, consultez la [documentation](../../query-service/ui/user-guide.md#enhanced-editor-toggle). |
...
| Fonctionnalité | Description |
| ------- | ----------- |
| Audience Portal | Le portail d’audience offre une nouvelle expérience de navigation pour accéder aux audiences, les créer et les gérer dans Adobe Experience Platform. Dans Audience Portal, vous pouvez afficher les audiences générées par Experience Platform et en externe, améliorer l’efficacité de votre travail grâce au filtrage, aux dossiers et aux balises, créer des audiences générées par Experience Platform et importer des audiences générées en externe au moyen de fichiers CSV. Pour plus d’informations sur le portail des audiences, consultez la [vue d’ensemble du portail des audiences](../../segmentation/ui/audience-portal.md). |
| Composition d’audiences | La composition d’audiences offre un espace de travail intuitif permettant de créer et de modifier des audiences à l’aide de blocs qui constituent les différentes actions possibles. Pour plus d’informations sur la composition d’audiences, consultez le [Guide de l’UI de la composition d’audiences](../../segmentation/ui/audience-composition.md). |
...
| Groupe de champs | [[!UICONTROL Enriched Event Segment Details]](https://github.com/adobe/xdm/pull/1754/files) | Liste des audiences auxquelles le profil est admissible au moment de la collecte de l’événement. |
...
| --- | --- | --- |
| Groupe de champs | [[!UICONTROL MediaAnalytics Interaction Details]](https://github.com/adobe/xdm/pull/1756/files) | Le `meta:status` a été mis à jour d’expérimental à `stable`. |
| Groupe de champs | [[!UICONTROL Media Interaction Details]](https://github.com/adobe/xdm/pull/1756/files) | Le `meta:status` a été mis à jour de `stable` à `deprecated`. |
| Type de données | [[!UICONTROL Session details information]](https://github.com/adobe/xdm/pull/1756/files) | Le `meta:status` a été mis à jour de `experimental` à `stable`. |
| Type de données | [[!UICONTROL Qoe Data details information]](https://github.com/adobe/xdm/pull/1756/files) | Le `meta:status` a été mis à jour de `experimental` à `stable`. |
| Type de données | [[!UICONTROL Player state data information]](https://github.com/adobe/xdm/pull/1756/files) | Le `meta:status` a été mis à jour d’`experimental` à `stable`. |
| Type de données | [[!UICONTROL Media event information]](https://github.com/adobe/xdm/pull/1756/files) | Le `meta:status` a été mis à jour de `experimental` à `stable`. |
| Type de données | [[!UICONTROL Media details information]](https://github.com/adobe/xdm/pull/1756/files) | Le `meta:status` a été mis à jour de `experimental` à `stable`. |
| Type de données | [[!UICONTROL Error details information]](https://github.com/adobe/xdm/pull/1756/files) | Le `meta:status` a été mis à jour de `experimental` à `stable`. |
| Type de données | [[!UICONTROL Error details information]](https://github.com/adobe/xdm/pull/1756/files) | Le `meta:status` a été mis à jour de `stable` à `deprecated`. |
| Type de données | [[!UICONTROL Custom metadata details information]](https://github.com/adobe/xdm/pull/1756/files) | Le `meta:status` a été mis à jour de `experimental` à `stable`. |
| Type de données | [[!UICONTROL Chapter details information]](https://github.com/adobe/xdm/pull/1756/files) | Le `meta:status` a été mis à jour de `experimental` à `stable`. |
| Type de données | [[!UICONTROL Advertising Pod details information]](https://github.com/adobe/xdm/pull/1756/files) | Le `meta:status` a été mis à jour de `experimental` à `stable`. |
| Type de données | [[!UICONTROL Advertising details information]](https://github.com/adobe/xdm/pull/1756/files) | Le `meta:status` a été mis à jour d’`experimental` à `stable`. |
| Extension (gestion des parcours clients) | [[!UICONTROL Domain]](https://github.com/adobe/xdm/pull/1756/files) | `Domain` champ ajouté à [!UICONTROL Adobe CJM ExperienceEvent - Message Profile Details] pour enregistrer le domaine de l’adresse e-mail du destinataire. |
| Extension (gestion des parcours clients) | [[!UICONTROL Channel's variant Name]](https://github.com/adobe/xdm/pull/1753/files) | Ce champ a été ajouté à [!UICONTROL AJO Entity Fields] pour représenter le nom de la variante de canal. |
| Extension (Adobe Analytics) | [[!UICONTROL Context value]](https://github.com/adobe/xdm/pull/1761/files) | `Context value` a été ajoutée à [!UICONTROL `Adobe Analytics ExperienceEvent Full Extension`]. |

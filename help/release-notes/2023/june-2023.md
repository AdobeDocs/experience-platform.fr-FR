...
| Type de données | [[!UICONTROL Order]](https://github.com/adobe/xdm/pull/1730/files) | `discountAmount` a été ajouté à [!UICONTROL Order]. Ceci indique la différence entre le prix normal de la commande et le prix spécial. Il s’applique à l’ensemble de la commande plutôt qu’à des produits individuels. |

...
feature_v2: id: adf04a6a-050f-44bc-a52c-db79ccb22ebfid: c132d929-fa62-4271-803e-b823be07b914id: c20d46e7-1c7d-476c-a50e-3961d4dce35fid: e08599ea-8888-4294-ba74-3ba0a7762a46id: ed0d8d0e-04b9-4326-be72-a0fbca265377
subfeature_v2: id: a230274e-7e6e-49eb-b817-514495a710acid: a7150a74-b8a9-4042-b066-147c5f0ca505id: abc02dd6-664f-446a-9aaa-675bc0f2fe4aid: acc16deb-1d7f-4ec9-9ce3-6cdf355afde6id: ae2cba0e-54f2-464b-a3b3-ad371e8a886aid: b5eb20d5-4893-4245-8a24-ea6bf0e51fbbid: d1a87129-ba05-4f15-98b1-233618f1774aid: d2a6cbf4-df32-480f-909e-b42f66dcb9f0id: d9830f6f-ceb6-4faa-9744-f281fe4439f9id: dc6ebdf7-9a94-43eb-9184-759cfdd0cf1cid: de9975b2-c43a-4287-9698-4f4cad92b83f
role_v2: id: b69b2659-1057-424e-8fc5-ed9e016dc554id: c66ffd68-0f65-42bb-aa23-b4020f12e0bdid: f8a45b24-4be7-4f1b-909b-60d06b483a20id: ff6a42d2-313e-452e-93a6-792e4fad9ff8
topic_v2: id: aa2f3246-cb95-4b30-8899-fdf7d73550ccid: bce87dde-a4ab-44c9-8a18-ad66e4ddb377id: d3cdead0-685a-4489-9250-4bb709942f66id: e0eb8757-182f-49f3-94a4-1587d16f5094id: e1e0219c-f879-479f-8427-888ed2a6e9c2id: eddd9b14-83bd-4ff4-9072-54a4a484abb7
...
| --- | --- | --- |
| Extension (Prospect-Profile) | [[!UICONTROL Adobe Unified Profile Service Prospect-Profile Union Extension]](https://github.com/adobe/xdm/pull/1735/files) | Ajout des champs requis pour le schéma d’union Prospect-Profile. |
| Extension | [[!UICONTROL Decisioning Asset]](https://github.com/adobe/xdm/pull/1732/files) | Ajoutez un type de données pour représenter les ressources utilisées dans la prise de décision. [!UICONTROL Decisioning Asset] fournit une référence aux ressources utilisées pour effectuer le rendu du `decisionItems`. |
...
| Groupe de champs | [[!UICONTROL Profile Partner Enrichment(Sample)]](https://github.com/adobe/xdm/pull/1747/files) | Un exemple de schéma a été ajouté pour l’enrichissement du partenaire de profil. |
| Groupe de champs | [[!UICONTROL Partner Prospect Details(Sample)]](https://github.com/adobe/xdm/pull/1747/files) | Un exemple de schéma a été ajouté pour les extensions de Prospect Profile de fournisseur de données. |
| Type de données | [[!UICONTROL Commerce Scope]](https://github.com/adobe/xdm/pull/1747/files) | [!UICONTROL Commerce Scope] identifie l’endroit où un événement s’est produit. Par exemple, dans la vue de magasin, le magasin ou le site web, etc. |
| Type de données | [[!UICONTROL Billing]](https://github.com/adobe/xdm/pull/1734/files) | Des informations de facturation, pour un ou plusieurs paiements, ont été ajoutées au schéma [!UICONTROL Commerce]. |
...
| --- | --- | --- |
| Groupe de champs | [[!UICONTROL MediaAnalytics Interaction Details]](https://github.com/adobe/xdm/pull/1736/files) | `bitrateAverageBucket` modifié de 100 à « 800-899 ». |
| Type de données | [[!UICONTROL Qoe Data details information]](https://github.com/adobe/xdm/pull/1736/files) | Type de données `bitrateAverageBucket` modifié en chaîne. |
| Groupe de champs | [[!UICONTROL Segment Membership Details]](https://github.com/adobe/xdm/pull/1735/files) | Ajout à la classe Prospect Profile. |
| Schéma | [[!UICONTROL Computed Attributes System Schema]](https://github.com/adobe/xdm/pull/1735/files) | Mappage d’identités ajouté à la [!UICONTROL Computed Attributes System Schema]. |
| Type de données | [[!UICONTROL Content Delivery Network]](https://github.com/adobe/xdm/pull/1733/files) | Champ ajouté à [!UICONTROL Session details information] pour décrire le réseau de diffusion de contenu utilisé. |
| Extension | [[!UICONTROL Adobe Unified Profile Service Account Union Extension]](https://github.com/adobe/xdm/pull/1731/files) | Mappage d’identités ajouté à la [!UICONTROL Adobe Unified Profile Service Account Union Extension]. |
| Type de données | [[!UICONTROL Order]](https://github.com/adobe/xdm/pull/1730/files) | `discountAmount` a été ajoutée à [!UICONTROL Order]. Ceci indique la différence entre le prix normal de la commande et le prix spécial. Il s’applique à l’ensemble de la commande plutôt qu’à des produits individuels. |
| Schéma | [[!UICONTROL AEP Hygiene Operation Request]](https://github.com/adobe/xdm/pull/1728/files) | Le champ `targetServices` a été ajouté pour fournir les noms des services qui traitent les opérations de nettoyage des données. |
| Type de données | [[!UICONTROL Shipping]](https://github.com/adobe/xdm/pull/1727/files) | `currencyCode` a été ajouté aux informations d’expédition pour un ou plusieurs produits. Il s’agit d’un code de devise alphabétique ISO 4217 utilisé pour évaluer le prix du produit. |
...
| Extension | [[!UICONTROL AJO Entity Fields]](https://github.com/adobe/xdm/pull/1746/files) | [!UICONTROL AJO Timestamp Entity] a été ajouté pour indiquer l’heure de la dernière modification du message. |
...
| Mises à jour de l’interface utilisateur des requêtes planifiées | Gérez toutes vos requêtes planifiées à partir d’un emplacement dans l’interface utilisateur avec l’[[!UICONTROL Scheduled Queries tab]](../../query-service/ui/monitor-queries.md#inline-actions) . L’interface utilisateur de [!UICONTROL Scheduled Queries] a été améliorée avec l’ajout d’actions de requête intégrées et de la nouvelle colonne de statut de requête. Les ajouts récents incluent la possibilité d’activer, de désactiver et de supprimer un planning, ou de s’abonner à des alertes pour les exécutions de requête à venir directement depuis la vue [!UICONTROL Scheduled Queries]. <p>![Actions intégrées mises en surbrillance dans la vue [!UICONTROL Scheduled Queries].](../../query-service/images/ui/monitor-queries/inline-actions.png "Actions intégrées mises en surbrillance dans la vue [!UICONTROL Scheduled Queries]."){width="100" zoomable="yes"}</p> |
...
| Fonctionnalité | Description |
| --- | --- |
| Prise en charge de la suppression des flux de données source de classification Adobe Analytics | Vous pouvez désormais supprimer les flux de données source qui utilisent les classifications Adobe Analytics comme source. Sous **[!UICONTROL Sources]** > **[!UICONTROL Dataflows]**, sélectionnez le flux de données de votre choix, puis sélectionnez Supprimer. Pour plus d’informations, consultez le guide sur la [création d’une connexion source pour les données de classification Adobe Analytics](../../sources/tutorials/ui/create/adobe-applications/classifications.md). |

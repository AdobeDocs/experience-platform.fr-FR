...
| Groupe de champs | [[!UICONTROL Profil de prospect individuel XDM]](https://github.com/adobe/xdm/pull/1721/files) | L’option `partnerProspect` pour les balises de métadonnées a été ajoutée à la classe [!UICONTROL XDM Individual Prospect Profile]. |

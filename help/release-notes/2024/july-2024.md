...
Balises unifiées vous permet de classer et de gérer vos objets métier dans Adobe Experience Platform. Grâce à l’API Balises unifiées, vous pouvez créer des dossiers et des balises pour mieux organiser les objets Platform tels que les audiences ou les jeux de données.

...
topic_v2: id: a004cc84-67b9-4a33-a3a7-8ec7273ef4dcid: c1579802-ddd4-4214-8a91-97b2066abe11id: e1e0219c-f879-479f-8427-888ed2a6e9c2id: f4e6943a-c91a-4134-a2c7-f4f20cfff2f0
...
| Fonctionnalité | Description |
|--- | ---|
| Prise en charge de Privacy Service pour Adobe Journey Optimizer | Les fonctionnalités de Privacy Service sont désormais compatibles avec les protocoles Adobe Journey Optimizer pour le traitement des requêtes de suppression. Pour plus d’informations](https://experienceleague.adobe.com/en/docs/journey-optimizer/using/privacy/requests) consultez la documentation sur les [demandes d’accès à des informations personnelles de Adobe Journey Optimizer ou la documentation d’Experience Platform pour obtenir une liste des [applications Experience Cloud intégrées à Privacy Service](../../privacy-service/experience-cloud-apps.md). |

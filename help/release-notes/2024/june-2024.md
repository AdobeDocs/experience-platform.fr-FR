...
| Fonctionnalité | Description |
|--- | ---|
| Prise en charge de Privacy Service pour Adobe Journey Optimizer | Les fonctionnalités de Privacy Service sont désormais compatibles avec les protocoles Adobe Journey Optimizer pour le traitement des requêtes de suppression. Pour plus d’informations[&#128279;](https://experienceleague.adobe.com/fr/docs/journey-optimizer/using/privacy/requests) consultez la documentation sur les demandes d’accès à des informations personnelles de Adobe Journey Optimizer ou la documentation d’Experience Platform pour obtenir une liste des [applications Experience Cloud intégrées à Privacy Service](../../privacy-service/experience-cloud-apps.md). |

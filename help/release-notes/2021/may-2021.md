...
subfeature_v2: id: dcded644-509e-49c5-ae85-3862a2a08609
...
| Fonctionnalité | Description |
| ------- | ----------- |
| Amélioration de la surveillance (Beta) | Amélioration des fonctionnalités de surveillance des destinations, y compris des informations pour les destinations par lots et en flux continu |
...
| Fonctionnalité | Description |
| --- | --- |
| Groupes de champs de schéma | Le terme « mixin » a été remplacé par « groupe de champs ». Cette modification est reflétée dans lʼinterface utilisateur Adobe Experience Platform. En outre, l’API Schema Registry comporte un nouveau [point d’entrée de groupes de champs](../../xdm/api/field-groups.md), tandis que le point d’entrée mixins a été abandonné en tant que point d’entrée hérité. Pour plus d’informations, consultez la [documentation XDM](../../xdm/home.md). |
...
| Fonctionnalité | Description |
| ------- | ----------- |
| Sandbox de production multiples | Vous pouvez désormais créer et gérer plusieurs sandbox de production dans votre organisation et dédier des sandbox de production spécifiques à des secteurs d’activité, des marques, des projets ou des régions distincts. Pour plus dʼinformations, consultez les tutoriels sur la création dʼun sandbox de production [dans lʼinterface d’utilisation](../../sandboxes/ui/user-guide.md) ou [à lʼaide de lʼAPI](../../sandboxes/api/overview.md). |

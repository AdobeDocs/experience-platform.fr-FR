...
>[!IMPORTANT]
>
>Actuellement, seules les organisations qui ont acheté le module complémentaire Adobe Shield for Healthcare disposent des fonctionnalités d’hygiène des données.

**Nouvelles fonctionnalités**

| Fonctionnalité | Description |
| --- | --- |
| Durée de vie (TTL) des jeux de données | [Planifier des TTL](../../hygiene/ui/ttl.md) pour des jeux de données Platform. |

{style=&quot;table-layout:auto&quot;}

Pour plus d’informations sur les journaux d’audit dans Platform, consultez la [présentation de l’hygiène des données](../../hygiene/home.md).
...
| Fonctionnalité | Description |
| ------- | ----------- |
| Application de la stratégie de consentement (disponibilité limitée) | Si votre organisation a acheté le module complémentaire Adobe Shield for Healthcare, vous pouvez désormais [créer des stratégies de consentement](../../data-governance/policies/user-guide.md#consent-policy) afin d’[appliquer automatiquement les consentements et préférences des clients dans la participation aux segments](../../data-governance/enforcement/auto-enforcement.md#consent-policy-evaluation). |

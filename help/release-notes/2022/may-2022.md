...
| Groupe de champs | [[!UICONTROL Statut de l’enregistrement]](https://github.com/adobe/xdm/blob/master/components/fieldgroups/shared/record-status.schema.json) | Mise à jour du statut du groupe de champs de `experimental` à `stable`. |
| Groupe de champs | (Plusieurs) | Plusieurs groupes de champs B2B ont été mis à jour afin que certains champs d’identifiant soient abandonnés au profit de champs de type clé qui utilisent le type de données Source B2B]](../../xdm/data-types/b2b-source.md). [[!UICONTROL Les champs d’identifiant précédents seront abandonnés lors d’une prochaine mise à jour. Consultez la [requête de stratégie pull](https://github.com/adobe/xdm/pull/1533/files#diff-720c0bb1d1cbaf622f5656c2a4b62d35830c75f6563794da72a280a6a520fbc1) pour obtenir la liste complète des modifications apportées aux groupes de champs concernés. |

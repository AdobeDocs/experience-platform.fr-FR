...
| Surveillance des destinations par lot et mesures au niveau du segment | La fonctionnalité de surveillance des destinations est désormais étendue des destinations de diffusion en continu afin d’inclure également les destinations par lot et les mesures au niveau du segment pour vos flux de données d’activation. Pour plus d’informations, reportez-vous à la section [tableau de bord des destinations de surveillance](/help/dataflows/ui/monitor-destinations.md#monitoring-destinations-dashboard), [tableau de bord des tâches de segmentation](/help/dataflows/ui/monitor-destinations.md#monitoring-segment-jobs-dashboard), et [vue au niveau du segment](/help/dataflows/ui/monitor-destinations.md#segment-level-view). |

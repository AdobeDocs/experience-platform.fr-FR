...
Pour afficher le code SQL derrière vos informations personnalisées, sélectionnez l’option **[!UICONTROL View SQL]** . La boîte de dialogue est intitulée avec le nom de l’insight. Depuis cette vue, vous pouvez copier le code SQL dans le presse-papiers afin de l’utiliser comme base pour la création future de graphiques en mode query pro ou ouvrir le code SQL directement dans Query Editor. Sélectionnez **[!UICONTROL Run SQL]** pour ouvrir la requête dans l’éditeur de requêtes.

![Boîte de dialogue affichant le code SQL d’une insight avec l’option SQL et Exécuter SQL mise en surbrillance.](../images/sql-insights-query-pro-mode/view-sql.png)

Sélectionnez **[!UICONTROL Close]** pour fermer la boîte de dialogue.

![Boîte de dialogue affichant le code SQL d’une insight avec l’option Fermer mise en surbrillance.](../images/sql-insights-query-pro-mode/close-sql-dialog.png)

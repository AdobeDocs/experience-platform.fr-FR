...
Vous pouvez également lire et comprendre le code SQL qui génère des insights pour la variable [Profils](./profiles.md) et [Audiences](./audiences.md) tableaux de bord.

...
![Inventaire du tableau de bord avec des tableaux de bord dans le volet de navigation de gauche et &quot;Créer un tableau de bord&quot; en surbrillance.](./images/standard-dashboards/create-dashboard.png)
...
Les utilisateurs qui ont acheté le SKU de Data Distiller ont la possibilité d’utiliser des requêtes SQL personnalisées pour créer leurs informations. Pour obtenir des instructions sur ce processus, reportez-vous à la [présentation du mode pro de requête](./sql-insights-query-pro-mode/overview.md) .
...
![ Le nouveau tableau de bord vide avec l’ajout d’un nouveau widget surligné.](./images/standard-dashboards/add-new-widget.png)
...
![Espace de travail du compositeur de widgets.](./images/standard-dashboards/widget-composer.png)
...
![ La boîte de dialogue de sélection des données avec sélection mise en surbrillance.](./images/standard-dashboards/select-a-table.png)
...
![Widget renseigné avec des données dans le compositeur de widget.](./images/standard-dashboards/populated-widget-composer.png)
...
![Le compositeur de widget avec la liste déroulante des icônes supplémentaires mise en surbrillance.](./images/standard-dashboards/attributes-dropdown.png)
...
![Le compositeur de widget avec la liste déroulante Marques mise en surbrillance.](./images/standard-dashboards/marks-dropdown.png)
...
![ La boîte de dialogue de filtrage permettant de filtrer les valeurs de votre widget.](./images/standard-dashboards/filter-dialog.png)
...
![Boîte de dialogue [!UICONTROL Filtre : date_key] avec [!UICONTROL Date récente] et [!UICONTROL Appliquer] mise en surbrillance.](./images/standard-dashboards/recent-date.png)
...
![Boîte de dialogue [!UICONTROL Filtre : date_key] avec cases à cocher de jour individuelles cochées et non cochées.](./images/standard-dashboards/select-dates.png)
...
![Panneau Propriétés avec l’icône de propriétés et le champ Titre du widget surligné.](./images/standard-dashboards/properties-panel.png)
...
![Nouvelle confirmation d’enregistrement de widget.](./images/standard-dashboards/save-confirmation.png)
...
![Le tableau de bord défini par l’utilisateur avec un widget personnalisé et le bouton d’enregistrement mis en surbrillance.](./images/standard-dashboards/user-defined-dashboard.png)
...
![Un tableau de bord personnalisé avec l’icône en forme de crayon mise en surbrillance.](./images/standard-dashboards/edit-mode.png)
...
![Un widget dans un tableau de bord personnalisé avec les ellipses et le widget Dupliquer en surbrillance.](./images/standard-dashboards/duplicate.png)

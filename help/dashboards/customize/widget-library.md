...
Ce guide fournit des instructions détaillées pour accéder à la [!UICONTROL bibliothèque de widgets] d’Experience Platform, où vous pouvez sélectionner des widgets standard et créer des widgets personnalisés pour personnaliser les informations affichées dans vos tableaux de bord.
...
Depuis n’importe quel tableau de bord (le tableau de bord Profils, par exemple), sélectionnez **[!UICONTROL Ajouter un widget]** pour accéder directement à la bibliothèque de widgets dans laquelle vous pouvez [ajouter des widgets](#add-widgets) à votre tableau de bord.
...
Dans la [!UICONTROL Bibliothèque de widgets], sélectionnez n’importe quel widget dans la liste des widgets standard ou personnalisés disponibles. Une coche dans l’angle du widget indique votre sélection.

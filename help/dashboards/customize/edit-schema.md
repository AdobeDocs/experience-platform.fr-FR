...
Si votre organisation n’a sélectionné aucun attribut de profil, commencez par sélectionner **[!UICONTROL Configure]** au centre de l’écran.
...
Après la création d’au moins un attribut personnalisé, sélectionnez **[!UICONTROL Edit schema]** pour afficher les attributs sélectionnés et en ajouter d’autres.
...
Pour sélectionner un attribut dans la boîte de dialogue **[!UICONTROL Select union schema field]**, accédez à l’attribut dans le schéma d’union (ou utilisez la recherche) et cochez la case en regard de l’attribut. Si vous cochez la case, l’attribut est également ajouté à la liste **[!UICONTROL Selected Attributes]** située dans la partie droite de la boîte de dialogue.
...
Après avoir choisi les attributs que vous souhaitez ajouter, sélectionnez **[!UICONTROL Save]** pour enregistrer vos attributs et revenir à l’onglet des widgets personnalisés.

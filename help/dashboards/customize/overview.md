...
Pour créer un [widget personnalisé](#custom-widgets) pour vos tableaux de bord, vous devez d’abord identifier l’attribut du profil client en temps réel sur lequel le widget sera basé.

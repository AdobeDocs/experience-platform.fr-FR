...
![Boîte de dialogue [!UICONTROL Entrer SQL] avec les paramètres de date surlignés dans le SQL.](../../../images/sql-insights/sql-date-parameters.png)
...
![Le compositeur de widget avec les bascules Start_date et End_date mis en surbrillance.](../../../images/sql-insights/widget-composer-date-filter-toggles.png)

...
![Image illustrant le bouton [!UICONTROL Importer le mappage] sélectionné](assets/data-prep/import-mapping-button.png).
...
![Image illustrant un flux de données existant sélectionné](assets/data-prep/select-mapping-rules.png).
...
![Image illustrant les règles de mappage à importer](assets/data-prep/import-mapping-rules.png).

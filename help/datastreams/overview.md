...
Lorsque vous envoyez une requête à Edge Network, le `datastreamId` référence le flux de données où les données sont envoyées. Vous pouvez mettre à jour la configuration côté serveur sans modifier le code de votre site web.

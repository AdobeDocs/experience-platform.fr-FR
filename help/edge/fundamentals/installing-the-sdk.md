...
1. La méthode recommandée pour utiliser le SDK Web de Adobe Experience Platform est la suivante : [Adobe Experience Platform Launch](https://launch.adobe.com/).
...
Pour obtenir de la documentation sur l’extension Adobe Experience Platform Launch, consultez la [documentation de lancement](https://experienceleague.adobe.com/docs/launch/using/extensions-ref/adobe-extension/aep-extension/overview.html)
...
* Non minimisé : [https://cdn1.adoberesources.net/alloy/2.4.0/alloy.js](https://cdn1.adoberesources.net/alloy/2.4.0/alloy.js)
...
Ce SDK utilise des promesses, qui sont une méthode de communication de l’achèvement des tâches asynchrones. La mise en oeuvre de [Promise](https://developer.mozilla.org/fr-FR/docs/Web/JavaScript/Reference/Global_Objects/Promise) utilisée par le SDK est prise en charge en mode natif par tous les navigateurs cibles, à l’exception de [!DNL Internet Explorer]. Pour utiliser le SDK sur [!DNL Internet Explorer], vous devez disposer de la balise `window.Promise` [polyfillé](https://remysharp.com/2010/10/08/what-is-a-polyfill).
...
>[!NOTE]
>
>Le package NPM repose sur les modules CommonJS ; par conséquent, lors de l’utilisation d’un bundler, assurez-vous que le bundler prend en charge les modules CommonJS. Certains lots, tels que [Rollup](https://rollupjs.org), nécessitent un [module externe](https://www.npmjs.com/package/@rollup/plugin-commonjs) qui fournit la prise en charge de CommonJS.
...
Le SDK Adobe Experience Platform utilise des promesses, qui sont une méthode de communication de l’achèvement des tâches asynchrones. La mise en oeuvre de [Promise](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Promise) utilisée par le SDK est prise en charge en mode natif par tous les navigateurs cibles, à l’exception de [!DNL Internet Explorer]. Pour utiliser le SDK sur [!DNL Internet Explorer], vous devez disposer de la balise `window.Promise` [polyfillé](https://remysharp.com/2010/10/08/what-is-a-polyfill).

Une bibliothèque que vous pouvez utiliser pour polyfiller la promesse est promesse-polyfill. Pour plus d’informations sur l’installation avec NPM, consultez la [documentation prometteuse-polyfill](https://www.npmjs.com/package/promise-polyfill) .

...
* **[!DNL Adobe Experience Platform Web SDK]:** SDK JavaScript et extension de balise pour simplifier considérablement le déploiement des  [!DNL Adobe] technologies

...
Si vous ne souhaitez pas utiliser de balises, reportez-vous au guide sur l’[utilisation de IAB TCF 2.0 sans balises](./without-launch.md).
...
Pour plus d’informations sur la configuration du consentement par défaut, reportez-vous à la [section concernant le consentement par défaut](../../fundamentals/configuring-the-sdk.md#default-consent) du guide de configuration du SDK.

## Mise à jour du profil avec les informations de consentement {#consent-code-1}

Pour appeler l’action `setConsent` lorsque les préférences de consentement de vos clients ont changé, vous devez créer une nouvelle règle de balise. Commencez par ajouter un nouvel événement et sélectionnez le type d’événement &quot;Code personnalisé&quot; de l’extension Core.

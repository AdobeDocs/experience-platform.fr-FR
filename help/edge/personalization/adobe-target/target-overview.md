...
mboxTrace et mboxDebug ont été abandonnés. Utilisation [[!DNL Web SDK] débogage](https://experienceleague.adobe.com/docs/experience-platform/edge/fundamentals/debugging.html).

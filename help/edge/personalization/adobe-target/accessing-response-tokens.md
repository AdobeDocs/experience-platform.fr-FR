...
Dans cet exemple, `result.propositions`, s’il existe, est un tableau contenant les propositions de personnalisation liées à l’événement. Voir [Rendu du contenu de personnalisation](../rendering-personalization-content.md) pour plus d’informations sur le contenu de `result.propositions`.

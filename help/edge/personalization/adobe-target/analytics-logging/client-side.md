...
* [Configuration du SDK Web](../../../fundamentals/configuring-the-sdk.md)
* [Envoi d’événements](../../../fundamentals/tracking-events.md)
...
Pour que cette méthode de création de rapports fonctionne correctement, vous devez envoyer la variable [!DNL A4T] données associées extraites du [`sendEvent`](../../../fundamentals/tracking-events.md) dans l’accès Analytics.

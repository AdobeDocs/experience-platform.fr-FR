...
**Simplicité :**  la combinaison de XDM, de SDK web, de balises, d’Experience Edge, de solutions Adobe Experience Cloud et de Adobe Experience Platform crée un récit de collecte de données facile à comprendre et simple à suivre.
...
* **Le** SDK Web Adobe Experience Platform est le nom officiel du nouveau code qui sera déployé par des balises pour les cas d’utilisation d’Adobe. C&#39;est aussi gratuit et puissant.
...
Pour plus d’informations sur un CNAME, consultez la [documentation de l’Adobe](https://experienceleague.adobe.com/docs/id-service/using/reference/analytics-reference/cname.html?lang=fr)

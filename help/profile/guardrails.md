...
| Nombre d’événements d’expérience par enregistrement de profil | 5000 | Mécanisme de sécurisation des performances | **Le nombre maximal d’événements d’expérience par enregistrement de profil est de 5 000.** profils avec plus de 5 000 événements d’expérience ne seront **pas** pris en compte pour la segmentation. |
...
| Audiences de diffusion en continu par sandbox | 500 | Mécanisme de sécurisation des performances | Une organisation peut avoir plus de 500 audiences de diffusion en continu au total, à condition qu’il y en ait moins de 500 dans chaque sandbox individuel. Cela inclut les audiences en flux continu et Edge. Toute tentative de création d’audiences de diffusion en continu supplémentaires peut affecter les performances du système. En savoir plus sur les [ audiences de diffusion en continu ](/help/segmentation/ui/streaming-segmentation.md). |

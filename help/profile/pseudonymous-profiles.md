...
L’expiration des données de profils pseudonymes ne peut pas être configurée via l’interface utilisateur ou les API Experience Platform. Pour activer cette fonctionnalité, contactez l’assistance clientèle. Lorsque vous contactez l’assistance, incluez les informations suivantes :

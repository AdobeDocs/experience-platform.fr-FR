...
TQID: https://experienceleague.adobe.com/FFjPTCiHsP78aXkfxRd9VfzGCAaobMsRFAHELHggBDY
product_v2:
...
* [Implémentation de balises sur une application iOS Objective-C](https://experienceleague.adobe.com/docs/platform-learn/implement-in-mobile-ios-objective-c-apps/overview.html?lang=fr)
* [Implémentation de balises sur une application iOS Swift](https://experienceleague.adobe.com/docs/platform-learn/implement-in-mobile-ios-swift-apps/overview.html?lang=fr)
* [Implémenter le transfert d’événement (anciennement Adobe Experience Platform Launch côté serveur)](https://experienceleague.adobe.com/docs/platform-learn/data-collection/event-forwarding/overview.html?lang=fr)

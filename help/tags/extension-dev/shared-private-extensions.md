...
La section **[!UICONTROL Shared with this org]** répertorie les extensions partagées, y compris celles **en attente d’approbation**. Sélectionnez l’extension à approuver, puis sélectionnez **[!UICONTROL Approve]**.

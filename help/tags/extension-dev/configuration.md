...
description: Découvrez comment configurer une extension de balise pour recueillir les paramètres globaux dʼun utilisateur dans lʼinterface utilisateur de la collecte de données dʼAdobe Experience Platform.

...
* **Arrêt des modules d’extension :** les développeurs d’extensions peuvent désormais arrêter leurs modules. Un package d’extension arrêté n’est plus disponible pour les nouvelles installations du catalogue de balises. Les installations existantes continuent de fonctionner comme prévu. Pour plus d’informations, reportez-vous à la section [Arrêt d’un module d’extension](https://developer.adobelaunch.com/api/reference/1.0/extension_packages/discontinue/) dans la documentation pour les développeurs.

## 9 mai 2020

### Correctifs

* Lors de l’utilisation de Safari &lt;= v12, les utilisateurs ne pouvaient pas accéder à l’interface utilisateur de collecte de données en raison d’un en-tête `X-FRAME-OPTIONS` mal défini.
...
* La fonction de republication de la bibliothèque ne purge parfois pas correctement la ressource de balises sur Akamai et la bibliothèque d’origine est toujours desservie.

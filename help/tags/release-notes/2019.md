...
* Copie de la propriété : vous pouvez maintenant faire une copie d’une propriété et de tout ce qu’elle contient. Dans la page de liste Propriétés , choisissez simplement une propriété et sélectionnez **[!UICONTROL Copier]** dans la barre d’outils.
...
* L’écran Modifier la bibliothèque comporte désormais un bouton pour [!UICONTROL Supprimer toutes les ressources].
* La taille de la cible de clic a augmenté pour supprimer des ressources individuelles d’une bibliothèque.

### Correctifs

* Correction d’un bug dans [!DNL Safari] en raison duquel les boutons [!UICONTROL Ajouter une ressource] de la page Modification de la bibliothèque s’affichaient au mauvais endroit.
...
* Les boutons [!UICONTROL Ajouter une ressource] de la page Modification de la bibliothèque flottent désormais à mesure que vous faites défiler la page vers le haut et vers le bas, de sorte qu’ils soient toujours visibles.

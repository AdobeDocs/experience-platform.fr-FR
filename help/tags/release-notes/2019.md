...
* Republication de bibliothèque : un utilisateur disposant des autorisations `Publish` appropriées peut désormais republier une bibliothèque précédemment publiée. Seules les 5 dernières bibliothèques sont éligibles à la republication.  Pour plus d’informations, consultez la section [Republication de bibliothèque](../ui/publishing/republish.md).

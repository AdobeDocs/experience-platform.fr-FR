...
description: Notes de mise à jour de 2018 pour les balises dans Adobe Experience Platform.
...
Les balises sont désormais mobiles !
...
La création dʼune propriété mobile dans lʼinterface utilisateur de collecte de données vous permet dʼeffectuer les opérations suivantes :
...
Les utilisateurs dʼAdobe Experience Platform sont désormais avertis lorsque de nouvelles versions dʼextensions sont disponibles et ils peuvent les installer eux-mêmes. En savoir plus [ici](../ui/managing-resources/extensions/extension-upgrade.md).
...
Il sʼagit de la première publication de balises dans Adobe Experience Platform.
...
Une extension est un module de code (JavaScript, HTML et CSS) qui étend lʼinterface utilisateur de collecte de données et les fonctionnalités du client.Créez, gérez et mettez à jour vos intégrations à l’aide d’une interface en libre-service ou presque. Une balise peut être considérée comme un système dʼexploitation, et les extensions comme les applications utilisées pour exécuter vos tâches.

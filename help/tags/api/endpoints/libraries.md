...
| Paramètre | Description |
| --- | --- |
| `LIBRARY_ID` | `id` de la bibliothèque que vous souhaitez rechercher. |
...
| Paramètre | Description |
| --- | --- |
| `PROPERTY_ID` | `id` de la [propriété](./properties.md) sous laquelle vous définissez la bibliothèque. |
...
Une réponse réussie renvoie les détails des relations ajoutées. L’exécution d’une [requête de recherche](#lookup) pour la bibliothèque affiche les relations ajoutées sous la propriété `relationships`.
...
Une réponse réussie renvoie les détails des relations mises à jour. L’exécution d’une [requête de recherche](#lookup) pour la bibliothèque affiche les relations sous la propriété `relationships`.
...
La requête suivante supprime une règle d’une bibliothèque. Les règles existantes qui ne sont pas incluses dans le tableau `data` ne sont pas supprimées.
...
Une réponse réussie renvoie les détails des relations mises à jour pour le type de ressource. S’il n’existe aucune relation pour ce type de ressource, la propriété `data` est renvoyée sous la forme d’un tableau vide. L’exécution d’une [requête de recherche](#lookup) pour la bibliothèque affiche les relations sous la propriété `relationships`.
...
Une réponse réussie renvoie les détails de la relation. L’exécution d’une [requête de recherche](#lookup) pour la bibliothèque affiche la relation ajoutée sous la propriété `relationships`.
...
| Paramètre | Description |
| --- | --- |
| `LIBRARY_ID` | `id` de la bibliothèque dont vous souhaitez effectuer la transition. |
...
>[!NOTE]
>
>Seules les bibliothèques approuvées peuvent être publiées en production.
...
| Paramètre | Description |
| --- | --- |
| `LIBRARY_ID` | `id` de la bibliothèque que vous souhaitez publier. |
...
| Paramètre | Description |
| --- | --- |
| `{LIBRARY_ID}` | `id` de la bibliothèque dont vous souhaitez répertorier les éléments de données. |
...
| Paramètre | Description |
| --- | --- |
| `{LIBRARY_ID}` | `id` de la bibliothèque dont vous souhaitez répertorier les extensions. |
...
| Paramètre | Description |
| --- | --- |
| `{LIBRARY_ID}` | `id` de la bibliothèque dont vous souhaitez répertorier les règles. |
...
| Paramètre | Description |
| --- | --- |
| `{LIBRARY_ID}` | `id` de la bibliothèque dont vous souhaitez rechercher l’environnement. |
...
| Paramètre | Description |
| --- | --- |
| `{LIBRARY_ID}` | `id` de la bibliothèque dont vous souhaitez rechercher la propriété. |
...
| Paramètre | Description |
| --- | --- |
| `{LIBRARY_ID}` | `id` de la bibliothèque dont vous souhaitez rechercher la bibliothèque en amont. |

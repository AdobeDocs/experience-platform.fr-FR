...
Pour les propriétés, les règles et les éléments de données, sélectionnez simplement la ressource à copier, puis sélectionnez **[!UICONTROL Copier]** dans le menu d’actions.
...
Une fois que vous avez configuré le comportement souhaité, sélectionnez **[!UICONTROL Copier]**.
...
* La copie d’une propriété peut prendre un certain temps.  Cette action s’effectue en arrière-plan.  Vous pouvez surveiller l’état d’avancement de la copie ou poursuivre d’autres tâches pendant qu’elle est en cours.

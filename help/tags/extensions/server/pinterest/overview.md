...
Prenons l’exemple d’une équipe marketing au sein d’une organisation. L’équipe capture les données d’événement d’interaction de l’utilisateur à partir de son site web et les charge dans [!DNL Pinterest] en utilisant cette extension de transfert d’événement.
...
Pour plus d’informations sur les cas d’utilisation spécifiques à [!DNL Pinterest], reportez-vous au [[!DNL Pinterest] cas d’utilisation](https://business.pinterest.com/en/success-stories) la documentation.
...
Vous aurez également besoin d’une [!DNL Pinterest] , qui doit être associé à votre [!DNL Pinterest] compte professionnel. Pour associer votre compte développeur à votre compte professionnel, reportez-vous à la section [[!DNL Pinterest ] compte développeur](https://developers.pinterest.com/account-setup/).
...
Dans le volet de navigation de gauche, sélectionnez **[!UICONTROL Extensions]**. Sélectionner **[!UICONTROL Installer]** sur la carte de la variable [!DNL Pinterest] dans le **[!UICONTROL Catalogue]** .
...
Dans le volet de navigation de gauche, sélectionnez **[!UICONTROL Extensions]**. Sélectionner **[!UICONTROL Configurer]** sur la carte de la variable [!DNL Pinterest] dans le [!UICONTROL Installé]Onglet **.
...
![La variable [!DNL Pinterest] [!UICONTROL Configurer] mise en surbrillance de l’écran [!UICONTROL Identifiant de compte Ads] et [!UICONTROL Jeton d’accès à la conversion] champs de saisie.](../../../images/extensions/server/pinterest/input.png)
...
Créer [règle](../../../ui/managing-resources/rules.md) dans la propriété de transfert d’événement. Sous **[!UICONTROL Actions]**, ajoutez une nouvelle action et définissez l’extension sur **[!UICONTROL Pinterest]**. Pour envoyer des événements Edge Network à [!DNL Pinterest], définissez la variable **[!UICONTROL Type d’action]** to **[!UICONTROL Envoyer un événement].**

![La variable [!DNL Pinterest] [!UICONTROL Envoyer un événement] création de règles.](../../../images/extensions/server/pinterest/rule.png)
...
![La variable [!DNL Pinterest] [!UICONTROL Données d’événement] surligné dans l’action de règle.](../../../images/extensions/server/pinterest/event-data.png)
...
![La variable [!DNL Pinterest] [!UICONTROL Données utilisateur] surligné dans l’action de règle.](../../../images/extensions/server/pinterest/user-data.png)
...
| ID de commande | ID de commande. Envoi `order_id` will help [!DNL Pinterest] dédupliquez les événements si nécessaire. |
...
![La variable [!DNL Pinterest] [!UICONTROL Données personnalisées] surligné dans l’action de règle.](../../../images/extensions/server/pinterest/custom-data.png)

## Validation des données dans [!DNL Pinterest]

Une fois la règle de transfert d’événement créée et exécutée, vérifiez si l’événement envoyé à la variable [!DNL Pinterest] L’API s’affiche comme prévu dans [!DNL Pinterest] Interface utilisateur.
...
![La variable [!DNL Pinterest] gestionnaire d&#39;événements](../../../images/extensions/server/pinterest/event-history.png)

Vous pouvez approfondir l’analyse et afficher les [!DNL Pinterest] distribution des données d’événement.

![La variable [!DNL Pinterest] répartition des données](../../../images/extensions/server/pinterest/event-history-distribution.png)

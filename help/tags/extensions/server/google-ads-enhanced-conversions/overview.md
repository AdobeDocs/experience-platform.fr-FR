...
| ID de conversion ou libellé de conversion | Valeurs de tracking obtenues depuis [!DNL Google Ads] lors de la configuration du tracking des conversions. Les valeurs commencent par `AW-`.<br><br>Pour plus d’informations sur la façon de trouver ces valeurs, reportez-vous à la [[!DNL Google Ads] documentation](https://support.google.com/tagmanager/answer/6105160?hl=en). |

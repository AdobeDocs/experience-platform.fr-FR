...
* **Rendre les décisions de personnalisation visuelle :** une case à cocher qui, lorsqu’elle est activée, vous permet de rendre du contenu personnalisé sur la page. Voir [&#x200B; Rendu de contenu personnalisé &#x200B;](/help/collection/use-cases/personalization/rendering-personalization-content.md#automatically-rendering-content) pour plus d’informations.

...
product_v2: id: a829a185-511f-4bf8-8dcf-9e684f8011cfid: d0a3eab4-7b10-4d96-a71e-6c0f8e7b7c87id: dc5cf79d-43c4-4731-bffa-1df5d7549cb1id: df80eeb1-8d72-467e-b0df-9d51c7d3a0a1id: e55547f1-a1ff-40c6-8978-026e40ab7fa4id: eadea719-cf89-469b-a6fd-a236a7138047id: edbd1a0e-46c8-49da-8c10-dba9ec80bba9
feature_v2: id: a8b0238e-1d43-4679-a3b4-5ba1bad83baaid: b89b323a-1e91-40b1-8d20-96b5b726d55aid: c814092e-2730-45e8-a12d-e084529f52cbid: dac87252-6066-4d6e-a9d2-f6d84c323de7id: daec7ead-f475-492a-a3b3-02ae08565d6fid: e08599ea-8888-4294-ba74-3ba0a7762a46id: fd307ce7-56f5-4ee3-af68-a7833ff6e85e
...
* Ajout d’une nouvelle fonctionnalité permettant aux utilisateurs et utilisatrices d’afficher et de modifier une version JSON de l’[action Définir les variables](https://experienceleague.adobe.com/fr/docs/experience-platform/tags/extensions/client/analytics/overview#set-variables). L’extension SDK web d’Adobe comprend également une action permettant de [renseigner une variable d’analyse](https://experienceleague.adobe.com/fr/docs/experience-platform/tags/extensions/client/web-sdk/data-element-types) en fournissant du code JSON. En copiant les données JSON de l’extension AA vers l’extension SDK web, les clientes et clients effectuant une migration peuvent facilement transférer plusieurs paramètres à la fois au lieu d’ajouter manuellement chaque variable.
...
* Mise à jour de lʼargument linkName Fallback pour refléter la logique Activity Map au lieu dʼutiliser innerHTML.
...
* Restauration de l’extension après la détection d’un bogue dans appMeasurement 2.13.0. appMeasurement 2.13.0 provoquait un problème qui n’envoyait pas l’ECID. Par conséquent, si vous avez installé 1.7.3, nous vous recommandons de mettre à niveau vers la version 1.7.4 pour éviter ce problème. Notez que le clearVars continuera jusqu’à ce qu’une version mise à jour d’AppMeasurement soit publiée

## samedi 12 avril 2019
...
* Séparation du champ « Serialize from value » (Sérialiser à partir de la valeur) en deux champs, « Event ID » (ID d’événement) et « Event Value » (Valeur d’événement). Cela corrige le problème qui affectait une valeur plutôt que de sérialiser un événement
   * Notez que si vous utilisez le champ actuel pour ajouter un ID à l’aide d’une chaîne (p. ex. Event7=3:abc123) vous devrez mettre à jour votre entrée pour refléter l’identifiant dans le champ « Identifiant de l’événement »

**Correctifs de bugs** :

* Correction d’un bogue qui empêchait le remplissage correct du code de devise

## vendredi 11 octobre 2018

---
audience: user
user-guide-title: Playbooks de cas d’utilisation d’Adobe Experience Platform
breadcrumb-title: Playbooks de cas d’utilisation d’Adobe Experience Platform
...
# Playbooks de cas d’utilisation d’Adobe Experience Platform {#use-case-playbooks}

* Playbooks {#playbooks}
   * [Vue d’ensemble](/help/use-case-playbooks/playbooks/overview.md)
   * [Tirez parti des cas d’utilisation de l’expérience client pour atteindre les objectifs commerciaux.](/help/use-case-playbooks/playbooks/business-use-case-framework.md)
   * [Accéder aux playbooks de cas d’utilisation](/help/use-case-playbooks/playbooks/navigate.md)
   ...
   * [Créer et partager vos propres playbooks](/help/use-case-playbooks/playbooks/author.md)

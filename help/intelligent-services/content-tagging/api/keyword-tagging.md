...
title: Balisage de mots-clés dans l’API de balisage de contenu AI
...
Le tableau suivant répertorie les entités nommées qui [!DNL Content Tagging AI] a identifié :

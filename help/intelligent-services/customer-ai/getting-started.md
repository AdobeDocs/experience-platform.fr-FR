...
Une fois que vous avez suivi les étapes décrites dans le document ci-dessus, consultez la documentation [Input and Output](./data-requirements.md). Ce document présente brièvement les types de données utilisés et produits dans Customer AI.

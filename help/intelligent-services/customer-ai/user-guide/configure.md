...
* Le type de propension détermine l’intention de score et de polarité des mesures. You can either choose **[!UICONTROL Churn]** or **[!UICONTROL Conversion]**. Pour plus d&#39;informations sur l&#39;impact du type de propension sur votre instance, consultez la note sous le résumé [de](./discover-insights.md#scoring-summary) notation dans le d&#39;informations sur la découverte des .

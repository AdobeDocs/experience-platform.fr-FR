...
-**[!UICONTROL Type de propension] :** le type de propension détermine le but du score et la polarité des mesures. Vous pouvez choisir entre **[!UICONTROL Perte de clientèle]** ou **[!UICONTROL Conversion]**. Pour plus d’informations sur l’impact du type de propension sur votre instance, consultez la note située sous [résumé de notation](./discover-insights.md#scoring-summary) dans le document d’informations sur les découvertes.
...
![Écran de sélection du jeu de données affichant la barre de recherche et les informations du jeu de données.](../images/user-guide/dataset-info.png)
...
![Exhaustivité du jeu de données présentant un aperçu du jeu de données avec le pourcentage d’exhaustivité en surbrillance.](../images/user-guide/dataset-info-2.png)
...
![Écran de sélection du mappage d’identités affichant le même espace de noms sélectionné pour plusieurs jeux de données.](../images/user-guide/cai-identity-map.png)
...
![Écran de sélection du mappage d’identités affichant le même espace de noms sélectionné pour plusieurs jeux de données.](../images/user-guide/cai-identity-namespace.png)
...
![Exemple montrant une clé de jeu de données non sélectionnée dans l’écran de sélection du mappage d’identités.](../images/user-guide/select-identity.png)
...
![Exemple illustrant la configuration d’un objectif où n’importe quelle condition peut être remplie.](../images/user-guide/any-of.png)
...
![Exemple illustrant la configuration d’une population éligible dans l’IA dédiée aux clients.](../images/user-guide/eligible-population.png)
...
![Exemple montrant les opérateurs disponibles pour la configuration d’un événement personnalisé dans l’IA dédiée aux clients.](../images/user-guide/custom-operator.png)
...
![Exemple illustrant la configuration d’un attribut de profil personnalisé dans IA dédiée aux clients.](../images/user-guide/profile-attributes.png)
...
![Exemple illustrant la configuration d’un événement personnalisé avec un nom défini par l’utilisateur dans l’IA dédiée aux clients.](../images/user-guide/custom-event-name.png)

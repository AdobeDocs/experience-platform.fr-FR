...
| `timestamp` | Heure à laquelle le événement ou l&#39;observation s&#39;est produit. Toutes les valeurs datetime doivent être fournies au format [RFC 3339](https://tools.ietf.org/html/rfc3339) . |

...
# [!UICONTROL Compte commercial XDM] class
...
[!UICONTROL Compte commercial XDM] est une classe XDM (Experience Data Model) standard qui capture les propriétés minimales requises d’un compte d’entreprise.

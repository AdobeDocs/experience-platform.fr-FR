...
* [[!UICONTROL Composants de personne active XDM]](../field-groups/profile/business-person-components.md)\*
* [[!UICONTROL Informations détaillées sur les personnes commerciales XDM]](../field-groups/profile/business-person-details.md)\*

*\*Ce groupe de champs est disponible uniquement pour les organisations ayant accès à l’édition B2B d’Adobe Real-time Customer Data Platform.*

Pour obtenir la liste complète de tous les groupes de champs compatibles avec [!DNL XDM Individual Profile], reportez-vous au [Référentiel XDM GitHub](https://github.com/adobe/xdm/tree/master/components/fieldgroups/profile).

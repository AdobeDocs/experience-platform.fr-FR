...
# [!UICONTROL Type de données de ] champ de préférence Personnalisation générique

[!UICONTROL Préférence de personnalisation générique ] Les champs de données XDM standard décrivent la sélection d’un client pour une préférence de personnalisation particulière.
...
| --- | --- | --- |
| `val` | Chaîne | Choix de préférence fourni par le client pour ce cas d’utilisation de la personnalisation. Consultez le tableau ci-dessous pour connaître les valeurs et les définitions acceptées. |

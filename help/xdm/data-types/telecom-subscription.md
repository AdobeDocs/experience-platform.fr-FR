...
>[!NOTE]
>
>Ce document décrit le type de données. Pour le groupe de champs du même nom, reportez-vous au [[!UICONTROL Abonnement aux télécommunications] guide de référence des groupes de champs](../field-groups/profile/telecom-subscription.md).
>
...
| --- | --- | --- |
| `devices` | Tableau d’objets | Décrit une liste des appareils et/ou accessoires associés au plan. Voir [section](#devices) pour plus d’informations sur la structure attendue de chaque élément de tableau. |

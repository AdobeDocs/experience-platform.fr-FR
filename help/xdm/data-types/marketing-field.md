...
>
>Si vous avez besoin d’une `subscriptions` pour un champ de préférence marketing particulier, vous devez utiliser la variable [champ marketing avec type de données d&#39;abonnements](./marketing-field-subscriptions.md) au lieu de .

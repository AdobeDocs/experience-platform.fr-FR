...
# Type de données [!UICONTROL Generic Marketing Preference Field]

[!UICONTROL Generic Marketing Preference Field] est un type de données XDM standard qui décrit la sélection d’un client pour une préférence marketing spécifique.
...
>
>Si vous avez besoin d’un mappage `subscriptions` pour un champ de préférence marketing particulier, vous devez utiliser le [champ marketing avec type de données d’abonnements](./marketing-field-subscriptions.md) à la place.

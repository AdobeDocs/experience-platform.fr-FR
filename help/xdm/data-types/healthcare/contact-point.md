...
![Structure de type de données de point de contact](../../images/data-types/healthcare/contact-point.png)

| Nom d’affichage | Propriété | Type de données | Description |
| --- | --- | --- | --- |
| [!UICONTROL Période] | `period` | [[!UICONTROL Période]](../healthcare/period.md) | Période pendant laquelle le point de contact a été/est en cours d’utilisation. |

...
| `subscriptions` | Carte | Carte des préférences marketing client pour des abonnements spécifiques. Voir la section sur [subscriptions](#subscriptions) pour plus d’informations. |
...
| --- | --- |
| `val` | La variable [valeur de consentement](#val) pour l’abonnement. |

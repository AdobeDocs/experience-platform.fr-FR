...
description: Découvrez le type de données Commerce Experience Data Model (XDM).
...
[!UICONTROL Commerce] est un type de données XDM (Experience Data Model) standard qui décrit les enregistrements liés à l’achat et à la vente.

![Un diagramme de [!UICONTROL Commerce] type de données.](../images/data-types/commerce.png)
...
| [!UICONTROL Listes de produits (panier) ouvertes] | `productListOpens` | [[!UICONTROL Mesure]](./measure.md) | Initialisations d’une nouvelle liste de produits, par exemple un panier en cours de création. |
...
| [!UICONTROL Panier] | `cart` | [[!UICONTROL panier]](./cart.md) | Propriétés du panier contenant un ou plusieurs produits. |
| [!UICONTROL Expédition] | `shipping` | [[!UICONTROL shipping]](./shipping.md) | Informations sur l’expédition d’un ou de plusieurs produits. |
| [!UICONTROL Facturation] | `billing` | [[!UICONTROL facturation]](#billing) | Informations de facturation pour un ou plusieurs paiements. |
...
| [!UICONTROL La liste des demandes s’ouvre] | `requisitionListOpens` | [[!UICONTROL Mesure]](./measure.md) | Indique l’initialisation d’une nouvelle liste de demandes d’achat. |
| [!UICONTROL Suppression de la liste des demandes] | `requisitionListDeletes` | [[!UICONTROL Mesure]](./measure.md) | Indique la suppression de la liste des demandes d’achat. |
| [!UICONTROL Ajout de la liste de demandes] | `requisitionListAdds` | [[!UICONTROL Mesure]](./measure.md) | Indique l’ajout d’un ou de plusieurs produits à une liste de demandes d’achat. |
| [!UICONTROL Retraits de la liste des demandes] | `requisitionListRemovals` | [[!UICONTROL Mesure]](./measure.md) | Indique la suppression d’un ou de plusieurs produits d’une liste de produits de demande d’achat. |
...
| [!UICONTROL Portée] | `commerceScope` | [[!UICONTROL commercescope]](./commerce-scope.md) | Identifiants d’étendue de commerce de l’endroit où un événement s’est produit (affichage en magasin, magasin, site web, etc.). |

{style="table-layout:auto"}

## [!UICONTROL facturation] type de données {#billing}

[!UICONTROL facturation] est un type de données XDM (Experience Data Model) standard qui contient des informations sur les détails de facturation. Plus précisément, il se concentre sur l’adresse de facturation.
...
Pour plus d’informations sur la variable [!UICONTROL Commerce] type de données, reportez-vous au référentiel XDM public :

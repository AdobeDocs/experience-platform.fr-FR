...
>title="Modification d’un schéma utilisé"
>abstract="Ce schéma est déjà utilisé par les jeux de données ou les workflows d’ingestion. Les modifications apportées aux champs ou aux identités existants peuvent entraîner des échecs d’ingestion si les flux de données sont en cours d’exécution ou planifiés. Une fois l’ingestion commencée, seules des modifications de schéma supplémentaires sont prises en charge."

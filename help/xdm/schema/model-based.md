...
Pour obtenir des conseils d’implémentation, voir [Suppression d’enregistrements des jeux de données basés sur des modèles](../../hygiene/ui/record-delete.md#model-based-record-delete).

...
# [!UICONTROL Organisation] groupe de champs de schéma
...
| [!UICONTROL Identifiant] | `identifier` | Tableau d’[[!UICONTROL identifiant]](../data-types/identifier.md) | Identifiant attribué à cette qualification pour cette organisation. |
| [!UICONTROL Émetteur] | `issuer` | [[!UICONTROL Référence]](../data-types/reference.md) | Organisation qui réglemente et émet la qualification. |
| [!UICONTROL Période] | `period` | [[!UICONTROL Période]](../data-types/period.md) | Période de validité de la qualification. |

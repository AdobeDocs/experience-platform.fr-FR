...
| Source d’informations][!UICONTROL  | `informationSource` | [[!UICONTROL Référence codable]](../data-types/codeable-reference.md) | Indique la source de l’enregistrement signalé. |

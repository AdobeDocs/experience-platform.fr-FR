...
# [!UICONTROL Codage] type de données

[!UICONTROL Codage] est un type de données standard des modèles de données d’expérience (XDM) qui décrit une référence à un code défini par un système terminologique. Ce type de données est créé conformément aux spécifications HL7 FHIR Release 5.
...
| [!UICONTROL Est Sélectionné Par L’Utilisateur] | `userSelected` | Booléen | Indicateur indiquant si ce codage a été choisi par l’utilisateur. La valeur par défaut est false. |

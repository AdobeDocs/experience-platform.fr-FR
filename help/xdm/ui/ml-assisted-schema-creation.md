...
Dans le volet de navigation de gauche de l’interface utilisateur d’Experience Platform, sélectionnez l’espace de travail **[!UICONTROL Schemas]**. L’espace de travail **[!UICONTROL Schemas]** s’affiche. Sélectionnez **[!UICONTROL Create schema]** pour ajouter un nouveau schéma afin de démarrer un workflow de création de schéma.
...
La boîte de dialogue [!UICONTROL Create a schema] s’affiche. Sélectionnez l’option de création de schéma **[assistée par ML]**, puis **[!UICONTROL Select]** pour confirmer votre choix.

![Boîte de dialogue [!UICONTROL Create a schema] avec [!UICONTROL ML- Assisted] mise en surbrillance.](../images/ui/ml-schema-creation/use-sample-csv.png)

### Sélectionner une classe de base {#select-base-class}

Le workflow [!UICONTROL Create schema] s’affiche. Sélectionnez une classe de base pour votre schéma, suivie de **[!UICONTROL Next]**.
...
L’étape **[!UICONTROL Select data]** du workflow de création s’affiche. Dans la section **[!UICONTROL Upload files]** , sélectionnez **[!UICONTROL Choose files]** ou la section **[!UICONTROL Drag and Drop files]** . Sélectionnez un fichier .csv sur votre ordinateur pour générer un schéma.
...
La section [!UICONTROL Upload file] affiche le nom du fichier CSV importé et la section **[!UICONTROL Preview]** affiche des lignes de données d’exemple du fichier chargé. Sélectionnez **[!UICONTROL Next]** pour continuer le workflow.
...
L’étape **[!UICONTROL Review and edit]** du workflow de création s’affiche maintenant, affichant le **[!UICONTROL Schema recommendation]** assisté par machine learning dans une vue tabulée. À ce stade, vous pouvez modifier, ajouter ou supprimer des champs du schéma recommandé généré par le modèle de machine learning. Le tableau contient les champs suivants :

| Nom du champ | Description |
|------------------|---------------------------------------------------------|
| [!UICONTROL Data table] | Jeu de données ou base de données d’où provient le champ. |
| [!UICONTROL Source Field] | Nom du champ d’origine du système source. |
| [!UICONTROL Target Field] | Nom du champ dans le système cible où les données seront mappées. |
| [!UICONTROL Display Name] | Nom utilisé pour afficher le champ dans l’interface utilisateur. Ce nom doit être plus convivial ou descriptif. |
| [!UICONTROL Data Type] | Type de données stocké dans le champ (par exemple, `String`, `Date`). |
| [!UICONTROL Field Group] | Catégorisation du champ en fonction de son utilisation ou de son contexte (par exemple, [!UICONTROL Demographic Details], [!UICONTROL Commerce Details]). |
...
Pour ajouter un champ au schéma, sélectionnez **[!UICONTROL Add new field]**.
...
Pour modifier un champ, sélectionnez l’icône en forme de crayon de la ligne à modifier. Un panneau de détails s’affiche à droite, où vous pouvez modifier le mappage des champs personnalisés. Le panneau des détails contient les [!UICONTROL Target field], [!UICONTROL Display Name], [!UICONTROL Data Type] et [!UICONTROL Field Group]. Apportez les modifications nécessaires et sélectionnez **[!UICONTROL Apply]** pour confirmer. Sélectionnez à nouveau l’icône en forme de crayon pour fermer le panneau des détails.
...
Pour approuver le schéma recommandé et poursuivre le workflow de **[!UICONTROL Create schema]**, sélectionnez **[Suivant]**.
...
L’étape **[!UICONTROL Name and save]** du workflow de création s’affiche. Saisissez un **[nom d’affichage du schéma]** et une description facultative. La section **[Schéma généré]** fournit un diagramme du schéma généré par ML. Sélectionnez **[Terminer]** pour terminer le workflow de création de schéma.
...
L’éditeur de schémas s’affiche avec le schéma que vous venez de créer dans la zone de travail. Sélectionnez **[!UICONTROL Save]** pour revenir à l’espace de travail [!UICONTROL Schemas].

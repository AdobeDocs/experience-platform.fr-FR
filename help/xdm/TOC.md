...
* Schémas {#schema}
   ...
   * Modèle De Données Des Soins De Santé V2 {#healthcare}
      * {hide-from-toc}[Santé V2](./schema/healthcare/healthcare-v2.md)
      * Classes {#classes}
         * {hide-from-toc}[Emplacement](./schema/healthcare/classes/location.md)
      * Groupes de champs {#field-groups}
         * {hide-from-toc}[Compte](./schema/healthcare/field-groups/account.md)
         * {hide-from-toc}[Rendez-vous](./schema/healthcare/field-groups/appointment.md)
         * {hide-from-toc}[Plan de soins](./schema/healthcare/field-groups/care-plan.md)
         * {hide-from-toc}[Couverture](./schema/healthcare/field-groups/coverage.md)
         * {hide-from-toc}[Objectif](./schema/healthcare/field-groups/goal.md)
         * {hide-from-toc}[Immunisation](./schema/healthcare/field-groups/immunization.md)
         * {hide-from-toc}[Emplacement](./schema/healthcare/field-groups/location.md)
         * {hide-from-toc}[Médicaments](./schema/healthcare/field-groups/medication.md)
         * {hide-from-toc}[Distribution de médicaments](./schema/healthcare/field-groups/medication-dispense.md)
         * {hide-from-toc}[Demande de médicaments](./schema/healthcare/field-groups/medication-request.md)
         * {hide-from-toc}[Organisation](./schema/healthcare/field-groups/organization.md)
         * {hide-from-toc}[Patient](./schema/healthcare/field-groups/patient.md)
         * {hide-from-toc}[Praticien](./schema/healthcare/field-groups/practioner.md)
         * {hide-from-toc}[Planning](./schema/healthcare/field-groups/schedule.md)
      * Types de données {#data-types}
         * {hide-from-toc}[Adresse](./schema/healthcare/data-types/address.md)
         * {hide-from-toc}[Annotation](./schema/healthcare/data-types/annotation.md)
         * {hide-from-toc}[Disponibilité](./schema/healthcare/data-types/availability.md)
         ...
         * {hide-from-toc}[Nom Humain](./schema/healthcare/data-types/human-name.md)
         ...
         * {hide-from-toc}[Référence](./schema/healthcare/data-types/reference.md)
         * {hide-from-toc}[Répéter](./schema/healthcare/data-types/repeat.md)
         * {hide-from-toc}[Quantité simple](./schema/healthcare/data-types/simple-quantity.md)
         * {hide-from-toc}[Timing](./schema/healthcare/data-types/timing.md)
         * {hide-from-toc}[Service virtuel](./schema/healthcare/data-types/virtual-service-detail.md)

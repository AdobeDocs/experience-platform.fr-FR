...
description: Vous pouvez vue une liste de toutes les ressources de registre de Schéma d'un certain type (classes, mixins, schémas, types de données ou descripteurs) au sein d'un conteneur en exécutant une seule demande de GET.

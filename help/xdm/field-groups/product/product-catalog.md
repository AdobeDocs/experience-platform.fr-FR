...
[!UICONTROL Catalogue de produits] est un groupe de champs de schéma standard pour la classe [[!UICONTROL Product]](../../classes/product.md) qui capture les propriétés liées à un catalogue de produits.

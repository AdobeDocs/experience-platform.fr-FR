...
# [!UICONTROL Healthcare Provider] groupe de champs de schéma

[!UICONTROL Healthcare Provider] est un groupe de champs de schéma standard pour la classe [[!UICONTROL Provider]](../../classes/provider.md). Il fournit un `healthcareProvider` de champ de type objet unique qui capture les propriétés liées à un professionnel de santé individuel ou à un organisme d’établissement de santé autorisé à fournir des diagnostics et des traitements médicaux.

![](../../images/field-groups/healthcare-provider.png)

| Propriété | Type de données | Description |
| --- | --- | --- |
| `addressDetails` | Tableau d’objets | Répertorie les détails de l’adresse du fournisseur. Chaque objet comprend les propriétés suivantes : <ul><li>`address` : ([[!UICONTROL Postal address]](../../data-types/postal-address.md)) : adresse postale du fournisseur.</li><li>`addressType` : (chaîne). Type d’adresse, indiquant où le fournisseur fournit des services.</li></ul> |
| `emailAddress` | [[!UICONTROL Email address]](../../data-types/email-address.md) | Adresse e-mail du fournisseur. |
| `fax` | [[!UICONTROL Phone number]](../../data-types/phone-number.md) | Numéro de fax du fournisseur. |
| `phoneNumber` | [[!UICONTROL Phone number]](../../data-types/phone-number.md) | Numéro de téléphone du fournisseur. |
| `qualifications` | Tableau d’objets | Répertorie les certifications, les licences ou les formations relatives à la prestation de soins. Chaque objet comprend les propriétés suivantes : <ul><li>`issuer` : ([[!UICONTROL Account details]](../../data-types/account-details.md)) : organisation qui réglemente et délivre la qualification.</li><li>`activePeriod` : (entier). Année jusqu’à laquelle la qualification est valide.</li><li>`code` : (chaîne). Représentation codée de la qualification.</li></ul> |

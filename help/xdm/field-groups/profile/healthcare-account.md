...
![Structure de groupe de champs](../../images/field-groups/healthcare-account/account.png)
...
| [!UICONTROL État de facturation] | `billingStatus` | [[!UICONTROL Concept codeable]](../../data-types/healthcare/codeable-concept.md) | Cela suit le cycle de vie du compte tout au long du processus de facturation. Elle indique comment les transactions sont traitées lorsqu’elles sont affectées au compte. |
...
| [!UICONTROL Devise] | `currency` | [[!UICONTROL Concept codeable]](../../data-types/healthcare/codeable-concept.md) | Devise par défaut du compte. |
...
| [!UICONTROL Identifiant] | `identifier` | Tableau de [[!UICONTROL Identifiant]](../../data-types/healthcare/identifier.md) | Identifiant unique utilisé pour référencer le compte. Il peut ou non être destiné à un usage humain (par exemple, numéro de carte de crédit). |
| [!UICONTROL Propriétaire] | `owner` | [[!UICONTROL Référence]](../../data-types/healthcare/reference.md) | Indique la zone de service, l’hôpital, le service, etc. avec la responsabilité de la gestion du compte. |
...
| [!UICONTROL Période de service] | `servicePeriod` | [[!UICONTROL Période]](../../data-types/healthcare/period.md) | La période des services associés à ce compte. |
...
![structure de couverture](../../images/field-groups/healthcare-account/coverage.png)

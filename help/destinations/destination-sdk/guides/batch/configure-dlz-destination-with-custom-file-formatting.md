---
description: Découvrez comment utiliser Destination SDK pour configurer une destination Data Landing Zone (DLZ) avec des options de formatage de fichiers personnalisées et une configuration des noms de fichiers personnalisée.
...
# Configurer une destination [!DNL Data Landing Zone (DLZ)] avec des options de formatage de fichier et une configuration de nom de fichier personnalisés

## Vue d’ensemble {#overview}

Cette page décrit comment utiliser Destination SDK pour configurer une destination [!DNL Data Landing Zone] avec des [options de formatage de fichier](configure-file-formatting-options.md) et une [configuration de nom de fichier](../../functionality/destination-configuration/batch-configuration.md#file-name-configuration) personnalisées.

Cette page présente toutes les options de configuration disponibles pour les destinations [!DNL Data Landing Zone]. Vous pouvez modifier les configurations présentées dans les étapes ci-dessous ou supprimer certaines parties des configurations, si nécessaire.

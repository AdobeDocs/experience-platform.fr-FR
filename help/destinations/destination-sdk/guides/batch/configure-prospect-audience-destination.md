...
title: Configurer une destination basée sur des fichiers pour exporter des audiences de prospects vers un emplacement de stockage
...
![options de planification de l’exportation](../../assets/guides/batch/ui-view-scheduling-prospect-destination.png)
...
Vous savez désormais comment utiliser Destination SDK pour créer une destination de [!DNL Amazon S3] personnalisée afin d’exporter des audiences de prospects.

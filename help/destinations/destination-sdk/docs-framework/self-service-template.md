...
topic_v2: id: a004cc84-67b9-4a33-a3a7-8ec7273ef4dcid: c13ff12d-60f1-49cd-833a-d43359628223id: c7d04a2c-412a-4c9d-9d7a-4456eaa5adebid: e0eb8757-182f-49f3-94a4-1587d16f5094
...
>[!IMPORTANT]
>
>Ce connecteur de destination et cette page de documentation sont créés et gérés par l’équipe *YourDestination*. Pour toute demande ou information, contactez directement l’équipe d’Amazon Ads à l’adresse *Insérez un lien ou une adresse e-mail où vous pourrez être contacté pour les mises à jour, par exemple `support@YourDestination.com`.*

## Cas d’utilisation {#use-cases}

Pour mieux comprendre quand et comment utiliser la destination *YourDestination*, consultez les exemples de cas d’utilisation ci-dessous que [!DNL Adobe Experience Platform] clients peuvent résoudre.
...
*Ajoutez des informations dans cette section sur les audiences prises en charge par la destination. Nous avons prérempli les tableaux avec des valeurs standard. Utilisez `Yes` et `No` pour indiquer si votre type d’audience est pris en charge par cette destination.*
...
| [Audiences de prospects ](/help/segmentation/types/prospect-audiences.md) | Oui | Ciblez les individus qui ne sont pas encore clients, mais qui partagent des caractéristiques avec votre audience cible. | Prospection à l’aide de données tierces |
...
| Élément | Type | Notes |
|---------|----------|---------|
| Type d’exportation | **[!UICONTROL Audience export]** | Vous exportez tous les membres d’une audience avec les identifiants (nom, numéro de téléphone ou autres) utilisés dans la destination *YourDestination*. |
...
| Type d’exportation | **[!UICONTROL Dataset export]** | Vous exportez des jeux de données bruts, qui ne sont pas regroupés ou structurés par intérêt ou qualification d’audience. |
...
* **[!UICONTROL Account ID]** : identifiant de votre compte *YourDestination*.

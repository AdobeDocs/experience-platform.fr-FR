...
Cette page décrit les règles à suivre au moment de la [création de la page de documentation de destination](./documentation-instructions.md) pour vous assurer qu’elle respecte les normes de qualité de la documentation [!DNL Adobe Experience Platform].
...
* AEP n’est pas un terme approuvé pour le public. Utilisez [!DNL Adobe Experience Platform] lors de la première utilisation, puis Experience Platform et enfin Experience Platform.
   ...
   * **Utiliser** : avant d’exporter des données de [!DNL Adobe Experience Platform] vers YourDestination, veillez à lire et à remplir ces conditions préalables.

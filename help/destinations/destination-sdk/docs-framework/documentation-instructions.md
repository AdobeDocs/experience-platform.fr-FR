---
title: Document de votre destination dans Adobe Experience Platform
seo-title: Document your destination in Adobe Experience Platform
description: Cette section contient des instructions détaillées sur la création d’une documentation pour votre destination dans Adobe Experience Platform.
...
# Document de votre destination dans Adobe Experience Platform
...
* [Instructions spécifiques pour la saveur Markdown de l’Adobe](https://experienceleague.adobe.com/docs/contributor/contributor-guide/writing-essentials/markdown.html?lang=en#custom-markdown-extensions)  (la saveur Markdown de l’Adobe est très similaire à Markdown standard).
...
Pour vous aider à créer votre page de documentation, Adobe a prérempli pour vous un [modèle de documentation](./self-service-template.md). Vous trouverez ci-dessous des instructions pour modifier le modèle et ouvrir une requête d’extraction. L’équipe de documentation de l’Adobe examinera et publiera la documentation relative à votre nouvelle destination.

[Téléchargez le modèle ](assets/yourdestination-template.zip) ici et décompressez le fichier pour extraire le  `yourdestination.md` fichier.
...
* [Utilisation de l’interface web GitHub pour créer une page de documentation de destination](./use-github-interface-to-create-documentation.md)
* [Utilisation d’un éditeur de texte dans votre environnement local pour créer une page de documentation de destination](./work-in-local-environment.md)

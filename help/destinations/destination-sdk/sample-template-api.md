...
title: Opérations dʼAPI pour lʼobtention du modèle
...
# Opérations dʼAPI pour lʼobtention du modèle {#get=sample-template-api-operations}

>[!IMPORTANT]
>
>**Point d’entrée de l’API** : `https://platform.adobe.io/data/core/activation/authoring/testing/template/sample`

Cette page répertorie et décrit toutes les opérations d’API que vous pouvez effectuer à l’aide du `/authoring/testing/template/sample` point d’entrée d’API, pour générer un [modèle de transformation des messages](./message-format.md#using-templating) pour votre destination. Pour une description des fonctionnalités prises en charge par ce point d’entrée, consultez la section [Créer un modèle](./create-template.md).

...
Utilisez les macros de configuration des noms de fichiers pour définir les noms de fichiers exportés à inclure. Les macros du tableau ci-dessous décrivent les éléments figurant dans l’interface utilisateur de l’écran [configuration du nom du fichier](../../../ui/activate-batch-profile-destinations.md#configure-file-names).
...
### Exemple de configuration de nom de fichier {#file-name-configuration-example}

...
| `httpTemplate.httpMethod` | Chaîne | *Obligatoire.* Méthode qu’Adobe utilisera dans les appels à votre serveur. Les options sont les suivantes : `GET`, `PUT`, `PUT`, `DELETE` ou `PATCH`. |

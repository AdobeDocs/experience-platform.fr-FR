...
# Surveillance des flux de données
 ...
 La destination vous permet d’activer vos données de Adobe Experience Platform vers d’innombrables partenaires externes.
...
Pour en savoir plus sur la surveillance des flux de données pour les destinations, consultez le [tutoriel Surveillance des flux de données pour les destinations dans l’interface utilisateur](../../dataflows/ui/monitor-destinations.md) .

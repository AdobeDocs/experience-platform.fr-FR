...
>[!NOTE]
>
>La fonctionnalité **[Exporter le fichier maintenant](/help/destinations/ui/export-file-now.md)** n’est pas disponible pour [!DNL The Trade Desk] destination CRM. Pour exporter des audiences, utilisez l’[exportation par lots quotidienne planifiée](#activate).

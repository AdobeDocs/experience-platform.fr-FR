...
Voir **Étapes suivantes** dans la section [obtention de vos données dans LiveRamp](https://docs.liveramp.com/connect/en/getting-your-data-into-liveramp.html) documentation pour plus d’informations.

...
[!DNL Facebook Pixel] est une extension publicitaire à Adobe Experience Platform. Pour plus d’informations sur la fonctionnalité de l’extension, voir le [site web Pixel Facebook](https://developers.facebook.com/docs/facebook-pixel/).

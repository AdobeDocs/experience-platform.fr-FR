...
>[!IMPORTANT]
>
>L’extension Google gtag décrite ici a été abandonnée et remplacée par l’extension [[!DNL Google Global Site Tag (gtag)]](https://exchange.adobe.com/apps/ec/101437/google-global-site-tag-gtag) développée par [!DNL Acronym]. Vous trouverez l’extension [!DNL Google Global Site Tag (gtag)] dans l’espace de travail [[!UICONTROL Tags]](../../../tags/home.md) dans l’interface utilisateur de la collecte de données ou dans l’interface utilisateur d’Experience Platform.

## Vue d’ensemble {#overview}

Chargez `gtag.js` de Google dans votre site pour envoyer des données d’événement vers [!DNL Google Analytics], Google Ads et [!DNL Google Marketing Platform]. Cette extension ajoute uniquement le code gtag à votre site. D’autres extensions Google sont nécessaires pour ajouter des événements et des actions qui utiliseront gtag.

Google gtag est une extension publicitaire en [!DNL Adobe Experience Platform]. Pour plus d’informations sur les fonctionnalités de l’extension, consultez la page de l’extension dans [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.102805.google-gtag.html).

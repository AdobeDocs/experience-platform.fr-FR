...
Chargez la balise `gtag.js` de Google dans votre site pour envoyer des données d’événement à [!DNL Google Analytics], Google Ads et [!DNL Google Marketing Platform]. Cette extension ajoute uniquement le code gtag à votre site. D’autres extensions Google sont nécessaires pour ajouter des événements et des actions qui utiliseront gtag.

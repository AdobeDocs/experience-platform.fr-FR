...
source-git-commit: c86a3cb911fef2b56600f312c4ae558810c8579d
workflow-type: tm+mt
...
Pour mieux comprendre comment utiliser la destination [!DNL Criteo], voici quelques objectifs que [!DNL Adobe Experience Platform] clients peuvent atteindre avec [!DNL Criteo] :

### Cas d’utilisation 1 : obtenir le trafic {#use-case-1}
...
### Cas d’utilisation 2 : augmentation des conversions de sites web {#use-case-2}
...
### Authentification au critère {#authenticate}

Les étapes de connexion sont les suivantes :

1. Connectez-vous à [!DNL Adobe Experience Platform] et connectez-vous à la destination Criteo.
...
| Identifiant annonceur | Criteo ID publicitaire de votre organisation. Contactez votre gestionnaire de compte Criteo pour obtenir ces informations. | Oui |

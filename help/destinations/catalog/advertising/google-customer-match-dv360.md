...
Les informations de surveillance pour la connexion [!DNL Google Customer Match + Display & Video 360] incluent des informations au niveau de l’audience liées aux identités activées, exclues et ayant échoué dans chaque flux de données et exécution de flux de données. [En savoir plus](/help/dataflows/ui/monitor-destinations.md#segment-level-view) sur la fonctionnalité.

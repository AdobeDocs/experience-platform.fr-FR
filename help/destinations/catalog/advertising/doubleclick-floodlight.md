...
Cette extension permet le déploiement rapide et facile des balises [!DNL DoubleClick Floodlight] à l’aide du format de lumière d’inondation traditionnel (et non de la balise de site globale). Remarque : cette extension est actuellement en version bêta.

[!DNL DoubleClick Floodlight] (Version bêta) est une extension publicitaire dans Adobe Experience Platform. Pour plus d’informations sur la fonctionnalité de l’extension, consultez la [!DNL Google] documentation de prise en charge de [DoubleClick Floodlight](https://support.google.com/dcm/answer/2823388?hl=fr).

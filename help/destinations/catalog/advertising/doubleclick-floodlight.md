...
Cette extension permet un déploiement rapide et facile des balises [!DNL DoubleClick Floodlight] à l’aide du format de projecteur traditionnel (et non de la balise de site globale). Remarque : cette extension est actuellement en version bêta.

...
Utilisez cette destination pour envoyer des audiences de [!DNL Adobe Experience Platform] à [!DNL FreeWheel]. Les audiences sont diffusées sous forme de fichiers par lots quotidiens et sont disponibles pour le ciblage dans les offres et les campagnes [!DNL FreeWheel].

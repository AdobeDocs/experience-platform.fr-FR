---
keywords: twitter ; Twitter ; balise de site Web Twitter universel ; balise de site Web Twitter universel ; balise de Twitter UWT ; Twitter uwt ; twitter uwt
title: Extension Twitter Universal Website Tag
seo-title: Extension Twitter Universal Website Tag
description: L’extension Twitter Universal Website Tag est une destination publicitaire à Adobe Experience Platform. Pour plus d’informations sur les fonctionnalités de l’extension, consultez la page de l’extension dans Adobe Exchange.
seo-description: L’extension Twitter Universal Website Tag est une destination publicitaire à Adobe Experience Platform. Pour plus d’informations sur les fonctionnalités de l’extension, consultez la page de l’extension dans Adobe Exchange.
...
[!DNL Twitter Universal Website Tag] est une extension publicitaire à Adobe Experience Platform. Pour plus d’informations sur la fonctionnalité de l’extension, voir [Advanced Conversion Tracking](https://business.twitter.com/en/solutions/twitter-ads/website-clicks/advanced-conversion-tracking.html).
...
Pour installer l&#39;extension [!DNL Twitter Universal Website Tag] :

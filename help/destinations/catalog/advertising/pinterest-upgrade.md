...
Oui, avant le 18 janvier 2024, vous devez vous authentifier auprès de la nouvelle destination Pinterest avec votre compte d’annonceur Pinterest en [!DNL Real-Time CDP]. Voir les instructions détaillées ci-dessous.
...
**Après le 18 janvier 2024** : <span class="preview">Pinterest a désactivé l’accès à l’API de l’annonceur V4. Tous les clients [!DNL Real-Time CDP] qui n’ont pas effectué la mise à niveau vers la nouvelle destination verront désormais leurs flux de données vers la destination Pinterest échouer. [Authentifiez-vous à nouveau sur Pinterest](#reauthenticate) et [activez les flux de données](#disable-old-enable-new-flows) vers la destination mise à niveau pour reprendre vos campagnes sur Pinterest.</span>

...
>[!IMPORTANT]
>
>Ce connecteur de destination et cette page de documentation sont créés et gérés par l’équipe [!DNL DataX] de [!DNL Verizon Media/Yahoo]. Pour toute question ou demande de mise à jour, contactez-les directement à l’adresse [](mailto:dataoperations@yahooinc.com)
...
| Élément | Type | Notes |
|---------|----------|---------|
| Type d’exportation | **[!UICONTROL Exportation de l’audience]** | Vous exportez tous les membres d’une audience avec les identifiants (e-mail, GAID, IDFA) utilisés dans la destination Verizon Media. |

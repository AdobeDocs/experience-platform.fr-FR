---
keywords: LinkedIn;linkedin;Linkedin;Balise Insight LinkedIn;balise insight;balise Insight
title: Extension LinkedIn Insight Tag
description: L’extension de balise LinkedIn Insight est une destination publicitaire dans Adobe Experience Platform. Pour plus d’informations sur les fonctionnalités de l’extension, consultez la page de l’extension dans Adobe Exchange.
...
Installez le [!DNL LinkedIn Insight Tag] pour utiliser les fonctionnalités de suivi des conversions, de reciblage et de démographie du site web.

[!DNL LinkedIn Insight Tag] est une extension publicitaire en [!DNL Adobe Experience Platform]. Pour plus d’informations sur la fonctionnalité de l’extension, voir [LinkedIn Insight Tag](https://business.linkedin.com/fr-fr/marketing-solutions/insight-tag).
...
Pour installer l’extension [!DNL LinkedIn Insight Tag], procédez comme suit :
...
Pour plus d’informations sur les options de configuration de l’extension et la prise en charge de l’installation, voir [LinkedIn Insight Tag](https://business.linkedin.com/fr-fr/marketing-solutions/insight-tag).

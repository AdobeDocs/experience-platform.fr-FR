---
keywords: Extension mastertag Awin Advertiser;balise maître;Awin;awin;AWIN
...
Le [!DNL MasterTag] est une bibliothèque JavaScript contenant toutes les fonctions requises pour la solution de tracking Awin et doit être ajouté de manière inconditionnelle à chaque page du site, y compris la page de confirmation, mais à l’exclusion de toute page qui affiche ou traite des informations de paiement.

[!DNL Awin Advertiser Mastertag] est une extension publicitaire en [!DNL Adobe Experience Platform]. Pour plus d’informations sur les fonctionnalités de l’extension, consultez la page de l’extension dans [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.103176.awin-advertiser-mastertag.html).
...
Pour installer l’extension [!DNL Awin Advertiser Mastertag], procédez comme suit :

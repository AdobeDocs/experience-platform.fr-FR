...
Le [!DNL MasterTag] est une bibliothèque JavaScript contenant toutes les fonctions requises pour la solution de suivi Awin et qui doit être annexée inconditionnellement à chaque page du site, y compris la page de confirmation, mais à l’exclusion de toute page qui affiche ou traite des informations de paiement.
...
Pour installer le [!DNL Awin Advertiser Mastertag] extension :

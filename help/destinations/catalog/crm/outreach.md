...
En tant que spécialiste marketing, vous pouvez proposer des expériences personnalisées à vos prospects, en fonction des attributs de leurs profils [!DNL Adobe Experience Platform]. Vous pouvez créer des audiences à partir de vos données hors ligne et envoyer ces audiences à [!DNL Outreach], pour les afficher dans les flux des prospects dès que les audiences et les profils sont mis à jour dans [!DNL Adobe Experience Platform].
...
Notez les conditions préalables suivantes dans [!DNL Outreach], pour exporter des données d’Experience Platform vers votre compte [!DNL Outreach] :

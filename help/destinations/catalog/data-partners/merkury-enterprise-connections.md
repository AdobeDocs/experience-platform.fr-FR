...
Suivez les étapes de cette page de documentation pour créer une connexion de destination [!DNL Merkury Connections] et activer des audiences à l’aide de l’interface utilisateur [!DNL Adobe Experience Platform].

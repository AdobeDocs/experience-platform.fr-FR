...
topic_v2: id: b4dd41a7-ccf8-4e9d-918e-acaab534a307id: c7d04a2c-412a-4c9d-9d7a-4456eaa5adebid: e0eb8757-182f-49f3-94a4-1587d16f5094id: e1e0219c-f879-479f-8427-888ed2a6e9c2id: ebef6e6f-6552-40b6-b842-0c5256698a4eid: fd2e3797-f2ea-4b36-a9af-52acf5e90513
...
>[!NOTE]
>
>Le connecteur de destination et la page de documentation sont créés et gérés par l’équipe [!DNL Merkury]. Pour toute demande ou mise à jour, contactez votre représentant de compte [!DNL Merkury].
...
Suivez les étapes de cette page de documentation pour créer une connexion de destination [!DNL Merkury Identity] et activer les audiences pour identification et enrichissement à l’aide de l’interface utilisateur [!DNL Adobe Experience Platform].
...
## Valider l’exportation des données {#validate-data-export}
...
Vous avez créé un flux de données pour exporter les données de profil d’Experience Platform vers votre emplacement S3 géré par [!DNL Merkury]. Ensuite, vous devez contacter votre représentant [!DNL Merkury] avec le nom du compte, les noms de fichier et le chemin d’accès au compartiment afin que le traitement puisse s’installer.

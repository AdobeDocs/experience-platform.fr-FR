---
keywords: extension de base de demande ; base de demande ; destination de base de demande
title: Extension Demandbase
seo-title: Extension Demandbase
description: L’extension Demandbase est une destination d’analyse à Adobe Experience Platform. Pour plus d’informations sur les fonctionnalités de l’extension, consultez la page de l’extension dans Adobe Exchange.
seo-description: L’extension Demandbase est une destination d’analyse à Adobe Experience Platform. Pour plus d’informations sur les fonctionnalités de l’extension, consultez la page de l’extension dans Adobe Exchange.
...
Bénéficiez de [!DNL Demandbase] statistiques de compte B2B directement en Adobe Analytics où vous pouvez segmenter le trafic et le comportement par industrie, recettes et comptes de cible. Cette présentation à partir du compte fournit des informations uniques sur l’engagement, la conversion et la provenance des visiteurs qui vous rapportent le plus.
...
Pour installer l&#39;extension [!DNL Demandbase] :

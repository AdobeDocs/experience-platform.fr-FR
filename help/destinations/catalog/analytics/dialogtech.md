...
description: L’extension DialogTech est une destination d’analyse à Adobe Experience Platform. Pour plus d’informations sur les fonctionnalités de l’extension, consultez la page de l’extension dans Adobe Exchange.
seo-description: L’extension DialogTech est une destination d’analyse à Adobe Experience Platform. Pour plus d’informations sur les fonctionnalités de l’extension, consultez la page de l’extension dans Adobe Exchange.
...
Inclure le fragment de code javascript [!DNL DialogTech SourceTrak] dans le lancement d’Adobe
...
Pour installer l&#39;extension [!DNL DialogTech] :

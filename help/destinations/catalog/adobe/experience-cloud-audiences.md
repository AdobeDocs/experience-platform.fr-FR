...
Pour sélectionner les audiences à exporter vers Audience Manager et au-delà, utilisez la nouvelle intégration de partage d’audiences en libre-service via la destination Audiences d’Experience Cloud .  Vous pouvez ainsi déterminer les audiences que vous souhaitez partager avec d’autres solutions Experience Cloud et celles que vous souhaitez conserver en [!DNL Real-Time CDP] exclusivement.

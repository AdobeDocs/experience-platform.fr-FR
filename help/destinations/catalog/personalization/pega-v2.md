...
| Élément | Type | Notes |
|---------|----------|---------|
| Type d’exportation | **[!UICONTROL Profile-based]** | Exporter tous les membres d&#39;une audience avec un identifiant (*CustomerID*), des attributs (nom, prénom, emplacement, etc.) et les données sur l’appartenance à une audience. |
...
* **[!UICONTROL Application alias]** : alias de l’application que vous avez configuré pour votre compte Customer Decision Hub. Pour plus d’informations, voir [Ajout d’un alias d’URL d’application](https://docs.pega.com/bundle/platform/page/platform/user-experience/adding-application-url-alias.html) dans votre instance [!DNL Pega Customer Decision Hub].
...
À l’étape [!UICONTROL Mapping], sélectionnez un identifiant unique dans votre schéma d’union et tout autre champ XDM que vous souhaitez exporter vers la destination.

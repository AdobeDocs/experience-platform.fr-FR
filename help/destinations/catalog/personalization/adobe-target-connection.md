...
>Si vous mappez des audiences Edge qui utilisent une politique de fusion différente à des destinations [!DNL Adobe Target], ces audiences ne seront pas évaluées pour les cas d’utilisation en temps réel et de la page suivante.
...
Si l’audience n’est pas utilisée dans une activité, accédez à **[!UICONTROL Destinations]** > **[!UICONTROL Browse]** > **[!UICONTROL Select destination dataflow]** > **[!UICONTROL Activation data]**, sélectionnez les audiences à supprimer, puis sélectionnez **[!UICONTROL Remove audiences]**.

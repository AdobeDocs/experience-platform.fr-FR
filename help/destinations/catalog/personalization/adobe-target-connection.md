...
Lors de la configuration de la connexion à Adobe Target pour [utiliser un flux de données](#parameters), le [SDK Web Adobe Experience Platform](/help/web-sdk/home.md) doit être implémenté.

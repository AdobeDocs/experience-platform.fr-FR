...
topic_v2: id: aa2f3246-cb95-4b30-8899-fdf7d73550ccid: c7d04a2c-412a-4c9d-9d7a-4456eaa5adebid: e0eb8757-182f-49f3-94a4-1587d16f5094id: eb30f47f-d87a-400f-8f78-63ce7979ff56id: ebde5b41-29c9-4f5e-9ef6-1197e85409e3id: fd2e3797-f2ea-4b36-a9af-52acf5e90513
...
* **MERGE_POLICY_ID** : ID de la [politique de fusion](../../../profile/merge-policies/overview.md) à laquelle appartient l’audience activée
* **AUDIENCE_ID** : identifiant de l’audience
* **AUDIENCE_NAME** : nom de l’audience tel que configuré dans Experience Platform
* **AUDIENCE_ORIGIN** : [origine](../../../segmentation/ui/audience-portal.md) de l’audience (par exemple, `Segmentation Service` ou `Custom upload`)
* **AUDIENCE_STATUS** : statut d’appartenance du profil dans l’audience (par exemple, `active` ou `realized`).
* **Attributs de mappage** : chaque attribut de mappage sélectionné pendant le workflow d’activation est représenté sous forme de colonne
...
>[!NOTE]
>
>La structure de tableau décrite ci-dessus s’applique aux connexions de destination créées après la version d’Experience Platform de mars 2026. Pendant la période de transition, les nouveaux connecteurs utilisent les deux structures de tableau, la nouvelle structure comportant le préfixe `V2` (par exemple, `V2_<table-name>`). Les connexions existantes continuent d’utiliser la structure précédente, où chaque audience est représentée sous la forme d’une colonne distincte (par exemple, `ups_<audience-id>` = `active`). La structure précédente sera abandonnée fin juin 2026.

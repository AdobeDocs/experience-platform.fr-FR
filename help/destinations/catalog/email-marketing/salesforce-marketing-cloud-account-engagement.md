...
Ceci [!DNL Adobe Experience Platform] [destination](/help/destinations/home.md) tire parti de la fonction [[!DNL Salesforce Account Engagement API > Prospect Upsert by Email]](https://developer.salesforce.com/docs/marketing/pardot/guide/prospect-v5.html#prospect-upsert-by-email) point de terminaison, à **ajouter ou mettre à jour vos pistes ;** après les avoir activés dans une nouvelle [!DNL Marketing Cloud Account Engagement] segment.
...
Contacter pour [[!DNL Salesforce] Assistance](https://www.salesforce.com/company/contact-us/?d=cta-glob-footer-10) ou votre [!DNL Salesforce] administrateur de compte si vous ne disposez pas d’un compte ou si le compte manque la variable [!DNL Marketing Cloud Account Engagement] de l’ [!DNL Account Engagement Administrator role].
...
Voir [!DNL Marketing Cloud Account Engagement] [limites de taux](https://developer.salesforce.com/docs/marketing/pardot/guide/overview.html#rate-limits) qui détaille les limites imposées par votre plan et s&#39;appliquerait également aux exécutions Experience Platform.
...
1. Accédez à l’une des audiences que vous avez sélectionnées. Sélectionnez la variable **[!DNL Activation data]** . La variable **[!UICONTROL ID de mappage]** affiche le nom du champ personnalisé généré dans la variable [!DNL Marketing Cloud Account Engagement Prospects] page.

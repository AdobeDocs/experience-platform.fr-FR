...
Experience Platform fournit deux types de destinations Snowflake : [Diffusion en continu Snowflake](snowflake.md) et [Lot Snowflake](../cloud-storage/snowflake-batch.md).
...
|  | Choisissez [Snowflake Batch](../cloud-storage/snowflake-batch.md) lorsque vous en avez besoin | Choisissez [Snowflake Streaming](snowflake.md) lorsque vous en avez besoin |
|--------|-------------------|----------------------|
...
Pour plus d’informations sur le partage de données par lots, consultez la documentation sur la connexion par lots de [Snowflake](../cloud-storage/snowflake-batch.md) .

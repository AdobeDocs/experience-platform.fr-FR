...
>[!IMPORTANT]
>
>Ce connecteur de destination est en version bêta et disponible uniquement pour les clients Real-Time CDP Ultimate. Les fonctionnalités et la documentation peuvent changer.
...
Experience Platform fournit deux types de destinations Snowflake : [Diffusion en continu Snowflake](/help/destinations/catalog/cloud-storage/snowflake.md) et [Lot Snowflake](snowflake-batch.md).
...
|  | Choisissez [Snowflake Batch](snowflake-batch.md) lorsque vous en avez besoin | Choisissez [Snowflake Streaming](/help/destinations/catalog/cloud-storage/snowflake.md) lorsque vous en avez besoin |
|--------|-------------------|----------------------|
...
Pour plus d’informations sur le partage de données en flux continu, consultez la documentation Connexion en flux continu Snowflake [&#128279;](../cloud-storage/snowflake.md).
...
Les audiences avec plusieurs politiques de fusion ne sont pas prises en charge dans un seul flux de données. Différentes politiques de fusion produisent des instantanés différents. En pratique, les données liées à une audience sont remplacées par les données de l’autre audience, au lieu d’être exportées des deux comme prévu.

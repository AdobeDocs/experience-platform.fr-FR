...
1. Dans l’ [interface de Platform](http://platform.adobe.com/), accédez à **[!UICONTROL Destinations]** > **[!UICONTROL Catalogue]**.
...
5. Le workflow vous permet de réaliser l’installation par Platform launch.

...
Grâce au connecteur de plateforme marketing Zeta disponible dans [!DNL Adobe Experience Platform], vous pouvez synchroniser facilement vos audiences d’Experience Platform vers ZMP.

>[!IMPORTANT]
>
>Le connecteur de destination et la page de documentation sont créés et gérés par l’équipe *Zeta Global*. Pour toute demande ou information, contactez l’équipe à l’adresse [Nous contacter](https://zetaglobal.com/about/contact-us/).
...
* Sélectionnez un espace de noms d’identité source (personnalisé ou standard, tel que `Email`) qui identifie de manière unique un profil dans [!DNL Adobe Experience Platform] et [!DNL Zeta Marketing Platform].

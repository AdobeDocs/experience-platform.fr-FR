...
* Catalogue des destinations {#catalog}
   ...
   * Destinations publicitaires {#advertising}
      ...
      * [Connexion Google Customer Match](./catalog/advertising/google-customer-match.md)
   ...
   * Destinations de stockage dans le cloud {#cloud-storage}
      ...
      * [LISTE AUTORISÉE d&#39;adresse IP](./catalog/cloud-storage/ip-address-allow-list.md)

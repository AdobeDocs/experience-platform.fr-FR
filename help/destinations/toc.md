...
* Catalogue des destinations {#catalog}
   ...
   * Destinations publicitaires{#advertising}
      ...
      * [Extension Adobe Advertising](./catalog/advertising/adobe-advertising-cloud.md)
   ...
   * Destinations de stockage dans le cloud {#cloud-storage}
      ...
      * [Lien privé pour les destinations Azure](./catalog/cloud-storage/azure-private-link.md)

...
Vous pouvez gérer les étiquettes de gouvernance des données pour un jeu de données en sélectionnant les options intégrées de l’onglet [!UICONTROL Parcourir]. Sélectionnez les points de suspension (...) en regard du nom du jeu de données que vous souhaitez gérer, suivi de **[!UICONTROL Gérer les données et les libellés d’accès]** dans le menu déroulant.
...
La boîte de dialogue [!UICONTROL Gérer les balises] s’affiche. Saisissez une brève description pour créer une balise personnalisée ou choisissez à partir d’une balise préexistante pour étiqueter votre jeu de données. Sélectionnez **[!UICONTROL Enregistrer]** pour confirmer les paramètres.
...
Vous pouvez placer des jeux de données dans des dossiers pour une meilleure gestion des jeux de données. Pour déplacer un jeu de données dans un dossier, sélectionnez les points de suspension (...) à côté du nom du jeu de données que vous souhaitez gérer, suivi de **[!UICONTROL Déplacer vers le dossier]** dans le menu déroulant.
...
L’étape **[!UICONTROL Sélectionner un schéma]** s’affiche. Parcourez la liste des schémas et sélectionnez le schéma auquel le jeu de données se conformera avant de sélectionner **[!UICONTROL Suivant]**.
...
L’étape **[!UICONTROL Configurer le jeu de données]** s’affiche. Attribuez un nom et une description facultative au jeu de données, puis sélectionnez **[!UICONTROL Terminer]** pour créer le jeu de données.
...
L’étape **[!UICONTROL Configurer]** s’affiche. Attribuez un nom et une description facultative au jeu de données, puis sélectionnez **[!UICONTROL Suivant]**.

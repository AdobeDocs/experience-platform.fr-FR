...
* Interface utilisateur du cycle de vie des données {#ui}
   ...
   * [Demandes de suppression d’enregistrements](./ui/record-delete.md)
...
* API Data Hygiene {#api}
   ...
   * [Expirations des jeux de données (point d’entrée ttl)](./api/dataset-expiration.md)
   * {hide-from-toc}[Suppressions d’enregistrements](./api/jobs.md)
   * [Demandes de suppression d’enregistrements (point d’entrée de l’ordre de travail)](./api/workorder.md)
   * [Quota](./api/quota.md)

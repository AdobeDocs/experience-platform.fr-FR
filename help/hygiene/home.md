...
Grâce aux fonctionnalités d’hygiène des données de Platform, vous pouvez effectuer la gestion de vos données client stockées, et ce par le biais de suppressions programmées de jeux de données.

## Espace de travail de l’interface utilisateur [!UICONTROL Hygiène des données]
